...
export class GetSelectedDataOfTheParticularProductOfferAction {
  ...
  static Fetch$ = async (
    ...
    return fetchx<
      GetSelectedDataOfTheParticularProductOfferActionRes,
      unknown,
      unknown
    >(
      overrideUrl ??
        GetSelectedDataOfTheParticularProductOfferAction.NewUrl(qs),
      {
  ...
  static Fetch = async (
    init?: TypedRequestInit<unknown, unknown>,
    {
      ...
      creatorFn: (item) =>
        new GetSelectedDataOfTheParticularProductOfferActionRes(item),
    },
  ) => {
    creatorFn =
      creatorFn ||
      ((item) => new GetSelectedDataOfTheParticularProductOfferActionRes(item));
...
export class GetSelectedDataOfTheParticularProductOfferActionRes {
   ...
   **/
  #stock!: InstanceType<
    typeof GetSelectedDataOfTheParticularProductOfferActionRes.Stock
  >;
  /**
   *
  ...
  set stock(
    ...
    if (
      value instanceof GetSelectedDataOfTheParticularProductOfferActionRes.Stock
    ) {
      this.#stock = value;
    } else {
      this.#stock =
        new GetSelectedDataOfTheParticularProductOfferActionRes.Stock(value);
    }
  }
  setStock(
    value: InstanceType<
  ...
  #sellingMode!: InstanceType<
    typeof GetSelectedDataOfTheParticularProductOfferActionRes.SellingMode
  >;
  /**
   *
  ...
  set sellingMode(
    ...
    if (
      value instanceof
      GetSelectedDataOfTheParticularProductOfferActionRes.SellingMode
    ) {
      this.#sellingMode = value;
    } else {
      this.#sellingMode =
        new GetSelectedDataOfTheParticularProductOfferActionRes.SellingMode(
          value,
        );
    }
  }
  ...
  #additionalMarketplaces!: InstanceType<
    typeof GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces
  >;
  /**
   * Marketplace-specific price information
  ...
  set additionalMarketplaces(
    ...
    if (
      value instanceof
      GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces
    ) {
      this.#additionalMarketplaces = value;
    } else {
      this.#additionalMarketplaces =
        new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces(
          value,
        );
    }
  }
  ...
  static Stock = class Stock {
     ...
     **/
    static from(
      possibleDtoObject: GetSelectedDataOfTheParticularProductOfferActionResType.StockType,
    ) {
      return new GetSelectedDataOfTheParticularProductOfferActionRes.Stock(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.StockType>,
    ) {
      return new GetSelectedDataOfTheParticularProductOfferActionRes.Stock(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.StockType>,
    ): InstanceType<
      typeof GetSelectedDataOfTheParticularProductOfferActionRes.Stock
    > {
      return new GetSelectedDataOfTheParticularProductOfferActionRes.Stock({
  ...
  static SellingMode = class SellingMode {
     ...
     **/
    #price!: InstanceType<
      typeof GetSelectedDataOfTheParticularProductOfferActionRes.SellingMode.Price
    >;
    /**
     *
    ...
    set price(
      ...
      if (
        value instanceof
        GetSelectedDataOfTheParticularProductOfferActionRes.SellingMode.Price
      ) {
        this.#price = value;
      } else {
        this.#price =
          new GetSelectedDataOfTheParticularProductOfferActionRes.SellingMode.Price(
            value,
          );
      }
    }
    ...
    static Price = class Price {
       ...
       **/
      static from(
        possibleDtoObject: GetSelectedDataOfTheParticularProductOfferActionResType.SellingModeType.PriceType,
      ) {
        return new GetSelectedDataOfTheParticularProductOfferActionRes.SellingMode.Price(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.SellingModeType.PriceType>,
      ) {
        return new GetSelectedDataOfTheParticularProductOfferActionRes.SellingMode.Price(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.SellingModeType.PriceType>,
      ): InstanceType<
        typeof GetSelectedDataOfTheParticularProductOfferActionRes.SellingMode.Price
      > {
        return new GetSelectedDataOfTheParticularProductOfferActionRes.SellingMode.Price(
     ...
     **/
    static from(
      possibleDtoObject: GetSelectedDataOfTheParticularProductOfferActionResType.SellingModeType,
    ) {
      return new GetSelectedDataOfTheParticularProductOfferActionRes.SellingMode(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.SellingModeType>,
    ) {
      return new GetSelectedDataOfTheParticularProductOfferActionRes.SellingMode(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.SellingModeType>,
    ): InstanceType<
      typeof GetSelectedDataOfTheParticularProductOfferActionRes.SellingMode
    > {
      return new GetSelectedDataOfTheParticularProductOfferActionRes.SellingMode(
  ...
  static AdditionalMarketplaces = class AdditionalMarketplaces {
     ...
     **/
    #marketplaceId1!: InstanceType<
      typeof GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId1
    >;
    /**
     *
    ...
    set marketplaceId1(
      ...
      if (
        ...
        this.#marketplaceId1 =
          new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId1(
            value,
          );
      }
    }
     ...
     **/
    #marketplaceId2!: InstanceType<
      typeof GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId2
    >;
    /**
     *
    ...
    set marketplaceId2(
      ...
      if (
        ...
        this.#marketplaceId2 =
          new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId2(
            value,
          );
      }
    }
    ...
    static MarketplaceId1 = class MarketplaceId1 {
       ...
       **/
      #sellingMode!: InstanceType<
        typeof GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId1.SellingMode
      >;
      /**
       *
      ...
      set sellingMode(
        ...
        if (
          ...
          this.#sellingMode =
            new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId1.SellingMode(
              value,
            );
        }
      }
      ...
      static SellingMode = class SellingMode {
         ...
         **/
        #price!: InstanceType<
          typeof GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId1.SellingMode.Price
        >;
        /**
         *
        ...
        set price(
          ...
          if (
            ...
            this.#price =
              new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId1.SellingMode.Price(
                value,
              );
          }
        }
        ...
        static Price = class Price {
           ...
           **/
          static from(
            possibleDtoObject: GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType.MarketplaceId1Type.SellingModeType.PriceType,
          ) {
            return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId1.SellingMode.Price(
              possibleDtoObject,
            );
          }
          /**
           ...
           **/
          static with(
            partialDtoObject: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType.MarketplaceId1Type.SellingModeType.PriceType>,
          ) {
            return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId1.SellingMode.Price(
              partialDtoObject,
            );
          ...
          copyWith(
            partial: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType.MarketplaceId1Type.SellingModeType.PriceType>,
          ): InstanceType<
            typeof GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId1.SellingMode.Price
          > {
            return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId1.SellingMode.Price(
         ...
         **/
        static from(
          possibleDtoObject: GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType.MarketplaceId1Type.SellingModeType,
        ) {
          return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId1.SellingMode(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType.MarketplaceId1Type.SellingModeType>,
        ) {
          return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId1.SellingMode(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType.MarketplaceId1Type.SellingModeType>,
        ): InstanceType<
          typeof GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId1.SellingMode
        > {
          return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId1.SellingMode(
        ...
        return {
          ...
          get sellingMode() {
            return withPrefix(
              "additionalMarketplaces.marketplaceId1.sellingMode",
              GetSelectedDataOfTheParticularProductOfferActionRes
                .AdditionalMarketplaces.MarketplaceId1.SellingMode.Fields,
            );
          },
        };
      }
       ...
       **/
      static from(
        possibleDtoObject: GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType.MarketplaceId1Type,
      ) {
        return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId1(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType.MarketplaceId1Type>,
      ) {
        return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId1(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType.MarketplaceId1Type>,
      ): InstanceType<
        typeof GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId1
      > {
        return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId1(
    ...
    static MarketplaceId2 = class MarketplaceId2 {
       ...
       **/
      #sellingMode!: InstanceType<
        typeof GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId2.SellingMode
      >;
      /**
       *
      ...
      set sellingMode(
        ...
        if (
          ...
          this.#sellingMode =
            new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId2.SellingMode(
              value,
            );
        }
      }
      ...
      static SellingMode = class SellingMode {
         ...
         **/
        #price!: InstanceType<
          typeof GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId2.SellingMode.Price
        >;
        /**
         *
        ...
        set price(
          ...
          if (
            ...
            this.#price =
              new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId2.SellingMode.Price(
                value,
              );
          }
        }
        ...
        static Price = class Price {
           ...
           **/
          static from(
            possibleDtoObject: GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType.MarketplaceId2Type.SellingModeType.PriceType,
          ) {
            return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId2.SellingMode.Price(
              possibleDtoObject,
            );
          }
          /**
           ...
           **/
          static with(
            partialDtoObject: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType.MarketplaceId2Type.SellingModeType.PriceType>,
          ) {
            return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId2.SellingMode.Price(
              partialDtoObject,
            );
          ...
          copyWith(
            partial: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType.MarketplaceId2Type.SellingModeType.PriceType>,
          ): InstanceType<
            typeof GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId2.SellingMode.Price
          > {
            return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId2.SellingMode.Price(
         ...
         **/
        static from(
          possibleDtoObject: GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType.MarketplaceId2Type.SellingModeType,
        ) {
          return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId2.SellingMode(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType.MarketplaceId2Type.SellingModeType>,
        ) {
          return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId2.SellingMode(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType.MarketplaceId2Type.SellingModeType>,
        ): InstanceType<
          typeof GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId2.SellingMode
        > {
          return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId2.SellingMode(
        ...
        return {
          ...
          get sellingMode() {
            return withPrefix(
              "additionalMarketplaces.marketplaceId2.sellingMode",
              GetSelectedDataOfTheParticularProductOfferActionRes
                .AdditionalMarketplaces.MarketplaceId2.SellingMode.Fields,
            );
          },
        };
      }
       ...
       **/
      static from(
        possibleDtoObject: GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType.MarketplaceId2Type,
      ) {
        return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId2(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType.MarketplaceId2Type>,
      ) {
        return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId2(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType.MarketplaceId2Type>,
      ): InstanceType<
        typeof GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId2
      > {
        return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces.MarketplaceId2(
    ...
    applyFromObject(data = {}) {
      ...
      if (d.marketplaceId1 !== undefined) {
        this.marketplaceId1 = d.marketplaceId1;
      }
      if (d.marketplaceId2 !== undefined) {
        this.marketplaceId2 = d.marketplaceId2;
      }
      this.#lateInitFields(data);
    }
    /**
      ...
      return {
        ...
        get marketplaceId1() {
          return withPrefix(
            "additionalMarketplaces.marketplaceId1",
            GetSelectedDataOfTheParticularProductOfferActionRes
              .AdditionalMarketplaces.MarketplaceId1.Fields,
          );
        },
        ...
        get marketplaceId2() {
          return withPrefix(
            "additionalMarketplaces.marketplaceId2",
            GetSelectedDataOfTheParticularProductOfferActionRes
              .AdditionalMarketplaces.MarketplaceId2.Fields,
          );
        },
      };
    }
     ...
     **/
    static from(
      possibleDtoObject: GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType,
    ) {
      return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType>,
    ) {
      return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType.AdditionalMarketplacesType>,
    ): InstanceType<
      typeof GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces
    > {
      return new GetSelectedDataOfTheParticularProductOfferActionRes.AdditionalMarketplaces(
  ...
  applyFromObject(data = {}) {
    const d =
      data as Partial<GetSelectedDataOfTheParticularProductOfferActionRes>;
    if (d.id !== undefined) {
      this.id = d.id;
    }
  ...
  #lateInitFields(data = {}) {
    ...
    if (
      !(
        d.stock instanceof
        GetSelectedDataOfTheParticularProductOfferActionRes.Stock
      )
    ) {
      this.stock =
        new GetSelectedDataOfTheParticularProductOfferActionRes.Stock(
          d.stock || {},
        );
    }
    if (
   ...
   **/
  static from(
    possibleDtoObject: GetSelectedDataOfTheParticularProductOfferActionResType,
  ) {
    return new GetSelectedDataOfTheParticularProductOfferActionRes(
      possibleDtoObject,
    );
  }
  /**
   ...
   **/
  static with(
    partialDtoObject: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType>,
  ) {
    return new GetSelectedDataOfTheParticularProductOfferActionRes(
      partialDtoObject,
    );
  ...
  copyWith(
    partial: PartialDeep<GetSelectedDataOfTheParticularProductOfferActionResType>,
  ): InstanceType<typeof GetSelectedDataOfTheParticularProductOfferActionRes> {
    return new GetSelectedDataOfTheParticularProductOfferActionRes({
      ...this.toJSON(),
      ...partial,
    });
  ...
  clone(): InstanceType<
    typeof GetSelectedDataOfTheParticularProductOfferActionRes
  > {
    return new GetSelectedDataOfTheParticularProductOfferActionRes(
      this.toJSON(),
    );
