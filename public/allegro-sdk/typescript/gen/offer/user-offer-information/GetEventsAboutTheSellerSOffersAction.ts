...
export class GetEventsAboutTheSellerSOffersAction {
  ...
  static NewUrl = (qs?: URLSearchParams) =>
    buildUrl(GetEventsAboutTheSellerSOffersAction.URL, undefined, qs);
  static Method = "get";
  static Fetch$ = async (
    qs?: URLSearchParams,
    ctx?: FetchxContext,
    ...
    return fetchx<GetEventsAboutTheSellerSOffersActionRes, unknown, unknown>(
      overrideUrl ?? GetEventsAboutTheSellerSOffersAction.NewUrl(qs),
      {
  ...
  static Fetch = async (
    init?: TypedRequestInit<unknown, unknown>,
    {
      ...
      creatorFn?:
        | ((item: unknown) => GetEventsAboutTheSellerSOffersActionRes)
        | undefined;
      qs?: URLSearchParams;
      ctx?: FetchxContext;
    ...
    creatorFn =
      creatorFn ||
      ((item) => new GetEventsAboutTheSellerSOffersActionRes(item));
...
export class GetEventsAboutTheSellerSOffersActionRes {
  ...
  static OfferEvents = class OfferEvents {
     ...
     **/
    #offer!: InstanceType<
      typeof GetEventsAboutTheSellerSOffersActionRes.OfferEvents.Offer
    >;
    /**
     * Basic offer information for which event occurred
    ...
    set offer(
      ...
      if (
        value instanceof
        GetEventsAboutTheSellerSOffersActionRes.OfferEvents.Offer
      ) {
        this.#offer = value;
      } else {
        this.#offer =
          new GetEventsAboutTheSellerSOffersActionRes.OfferEvents.Offer(value);
      }
    }
    setOffer(
      value: InstanceType<
    ...
    static Offer = class Offer {
      ...
      #external!: InstanceType<
        typeof GetEventsAboutTheSellerSOffersActionRes.OfferEvents.Offer.External
      >;
      /**
       *
      ...
      set external(
        ...
        if (
          value instanceof
          GetEventsAboutTheSellerSOffersActionRes.OfferEvents.Offer.External
        ) {
          this.#external = value;
        } else {
          this.#external =
            new GetEventsAboutTheSellerSOffersActionRes.OfferEvents.Offer.External(
              value,
            );
        }
      }
      ...
      static External = class External {
         ...
         **/
        static from(
          possibleDtoObject: GetEventsAboutTheSellerSOffersActionResType.OfferEventsType.OfferType.ExternalType,
        ) {
          return new GetEventsAboutTheSellerSOffersActionRes.OfferEvents.Offer.External(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetEventsAboutTheSellerSOffersActionResType.OfferEventsType.OfferType.ExternalType>,
        ) {
          return new GetEventsAboutTheSellerSOffersActionRes.OfferEvents.Offer.External(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetEventsAboutTheSellerSOffersActionResType.OfferEventsType.OfferType.ExternalType>,
        ): InstanceType<
          typeof GetEventsAboutTheSellerSOffersActionRes.OfferEvents.Offer.External
        > {
          return new GetEventsAboutTheSellerSOffersActionRes.OfferEvents.Offer.External(
       ...
       **/
      static from(
        possibleDtoObject: GetEventsAboutTheSellerSOffersActionResType.OfferEventsType.OfferType,
      ) {
        return new GetEventsAboutTheSellerSOffersActionRes.OfferEvents.Offer(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetEventsAboutTheSellerSOffersActionResType.OfferEventsType.OfferType>,
      ) {
        return new GetEventsAboutTheSellerSOffersActionRes.OfferEvents.Offer(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetEventsAboutTheSellerSOffersActionResType.OfferEventsType.OfferType>,
      ): InstanceType<
        typeof GetEventsAboutTheSellerSOffersActionRes.OfferEvents.Offer
      > {
        return new GetEventsAboutTheSellerSOffersActionRes.OfferEvents.Offer({
    ...
    #lateInitFields(data = {}) {
      ...
      if (
        ...
        this.offer =
          new GetEventsAboutTheSellerSOffersActionRes.OfferEvents.Offer(
            d.offer || {},
          );
      }
    }
     ...
     **/
    static from(
      possibleDtoObject: GetEventsAboutTheSellerSOffersActionResType.OfferEventsType,
    ) {
      return new GetEventsAboutTheSellerSOffersActionRes.OfferEvents(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetEventsAboutTheSellerSOffersActionResType.OfferEventsType>,
    ) {
      return new GetEventsAboutTheSellerSOffersActionRes.OfferEvents(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetEventsAboutTheSellerSOffersActionResType.OfferEventsType>,
    ): InstanceType<
      typeof GetEventsAboutTheSellerSOffersActionRes.OfferEvents
    > {
      return new GetEventsAboutTheSellerSOffersActionRes.OfferEvents({
  ...
  applyFromObject(data = {}) {
    ...
    if (d.offerEvents !== undefined) {
      this.offerEvents = d.offerEvents;
    }
  }
  /**
   *	Special toJSON override, since the field are private,
   ...
   **/
  static with(
    partialDtoObject: PartialDeep<GetEventsAboutTheSellerSOffersActionResType>,
  ) {
    return new GetEventsAboutTheSellerSOffersActionRes(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<GetEventsAboutTheSellerSOffersActionResType>,
  ): InstanceType<typeof GetEventsAboutTheSellerSOffersActionRes> {
    return new GetEventsAboutTheSellerSOffersActionRes({
      ...this.toJSON(),
      ...partial,
    });
  }
