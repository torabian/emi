...
export class GetSellersOffersAction {
  ...
  static NewUrl = (qs?: URLSearchParams) =>
    buildUrl(GetSellersOffersAction.URL, undefined, qs);
  static Method = "get";
  static Fetch$ = async (
    qs?: URLSearchParams,
    ctx?: FetchxContext,
    ...
    return fetchx<GetSellersOffersActionRes, unknown, unknown>(
      overrideUrl ?? GetSellersOffersAction.NewUrl(qs),
      {
  ...
  static Fetch = async (
    ...
    const res = await GetSellersOffersAction.Fetch$(qs, ctx, init, overrideUrl);
...
export class GetSellersOffersActionRes {
  ...
  static Offers = class Offers {
     ...
     **/
    set category(
      value: InstanceType<typeof GetSellersOffersActionRes.Offers.Category>,
    ) {
     ...
     **/
    #primaryImage!: InstanceType<
      typeof GetSellersOffersActionRes.Offers.PrimaryImage
    >;
    /**
     *
     ...
     **/
    set primaryImage(
      value: InstanceType<typeof GetSellersOffersActionRes.Offers.PrimaryImage>,
    ) {
      // For objects, the sub type needs to always be instance of the sub class.
      if (value instanceof GetSellersOffersActionRes.Offers.PrimaryImage) {
        this.#primaryImage = value;
      } else {
        this.#primaryImage = new GetSellersOffersActionRes.Offers.PrimaryImage(
          value,
        );
      }
    }
    ...
    #sellingMode!: InstanceType<
      typeof GetSellersOffersActionRes.Offers.SellingMode
    >;
    /**
     *
     ...
     **/
    set sellingMode(
      value: InstanceType<typeof GetSellersOffersActionRes.Offers.SellingMode>,
    ) {
      // For objects, the sub type needs to always be instance of the sub class.
      if (value instanceof GetSellersOffersActionRes.Offers.SellingMode) {
        this.#sellingMode = value;
      } else {
        this.#sellingMode = new GetSellersOffersActionRes.Offers.SellingMode(
          value,
        );
      }
    }
     ...
     **/
    set saleInfo(
      value: InstanceType<typeof GetSellersOffersActionRes.Offers.SaleInfo>,
    ) {
      // For objects, the sub type needs to always be instance of the sub class.
     ...
     **/
    set stock(
      value: InstanceType<typeof GetSellersOffersActionRes.Offers.Stock>,
    ) {
      // For objects, the sub type needs to always be instance of the sub class.
     ...
     **/
    set stats(
      value: InstanceType<typeof GetSellersOffersActionRes.Offers.Stats>,
    ) {
      // For objects, the sub type needs to always be instance of the sub class.
    ...
    #publication!: InstanceType<
      typeof GetSellersOffersActionRes.Offers.Publication
    >;
    /**
     *
     ...
     **/
    set publication(
      value: InstanceType<typeof GetSellersOffersActionRes.Offers.Publication>,
    ) {
      // For objects, the sub type needs to always be instance of the sub class.
      if (value instanceof GetSellersOffersActionRes.Offers.Publication) {
        this.#publication = value;
      } else {
        this.#publication = new GetSellersOffersActionRes.Offers.Publication(
          value,
        );
      }
    }
    ...
    #afterSalesServices!: InstanceType<
      typeof GetSellersOffersActionRes.Offers.AfterSalesServices
    >;
    /**
     *
    ...
    set afterSalesServices(
      ...
      // For objects, the sub type needs to always be instance of the sub class.
      if (
        value instanceof GetSellersOffersActionRes.Offers.AfterSalesServices
      ) {
        this.#afterSalesServices = value;
      } else {
        this.#afterSalesServices =
          new GetSellersOffersActionRes.Offers.AfterSalesServices(value);
      }
    }
    ...
    #additionalServices!: InstanceType<
      typeof GetSellersOffersActionRes.Offers.AdditionalServices
    >;
    /**
     *
    ...
    set additionalServices(
      ...
      // For objects, the sub type needs to always be instance of the sub class.
      if (
        value instanceof GetSellersOffersActionRes.Offers.AdditionalServices
      ) {
        this.#additionalServices = value;
      } else {
        this.#additionalServices =
          new GetSellersOffersActionRes.Offers.AdditionalServices(value);
      }
    }
     ...
     **/
    set external(
      value: InstanceType<typeof GetSellersOffersActionRes.Offers.External>,
    ) {
      // For objects, the sub type needs to always be instance of the sub class.
     ...
     **/
    set delivery(
      value: InstanceType<typeof GetSellersOffersActionRes.Offers.Delivery>,
    ) {
      // For objects, the sub type needs to always be instance of the sub class.
    ...
    #fundraisingCampaign!: InstanceType<
      typeof GetSellersOffersActionRes.Offers.FundraisingCampaign
    >;
    /**
     *
    ...
    set fundraisingCampaign(
      ...
      // For objects, the sub type needs to always be instance of the sub class.
      if (
        value instanceof GetSellersOffersActionRes.Offers.FundraisingCampaign
      ) {
        this.#fundraisingCampaign = value;
      } else {
        this.#fundraisingCampaign =
          new GetSellersOffersActionRes.Offers.FundraisingCampaign(value);
      }
    }
    ...
    static Category = class Category {
       ...
       **/
      static from(
        possibleDtoObject: GetSellersOffersActionResType.OffersType.CategoryType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.CategoryType>,
      ) {
        return new GetSellersOffersActionRes.Offers.Category(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<GetSellersOffersActionResType.OffersType.CategoryType>,
      ): InstanceType<typeof GetSellersOffersActionRes.Offers.Category> {
        return new GetSellersOffersActionRes.Offers.Category({
          ...this.toJSON(),
          ...partial,
        });
      }
    ...
    static PrimaryImage = class PrimaryImage {
       ...
       **/
      static from(
        possibleDtoObject: GetSellersOffersActionResType.OffersType.PrimaryImageType,
      ) {
        return new GetSellersOffersActionRes.Offers.PrimaryImage(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.PrimaryImageType>,
      ) {
        return new GetSellersOffersActionRes.Offers.PrimaryImage(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetSellersOffersActionResType.OffersType.PrimaryImageType>,
      ): InstanceType<typeof GetSellersOffersActionRes.Offers.PrimaryImage> {
        return new GetSellersOffersActionRes.Offers.PrimaryImage({
          ...this.toJSON(),
          ...partial,
        });
    ...
    static SellingMode = class SellingMode {
       ...
       **/
      #price!: InstanceType<
        typeof GetSellersOffersActionRes.Offers.SellingMode.Price
      >;
      /**
       *
      ...
      set price(
        ...
        // For objects, the sub type needs to always be instance of the sub class.
        if (
          value instanceof GetSellersOffersActionRes.Offers.SellingMode.Price
        ) {
          this.#price = value;
        } else {
          this.#price = new GetSellersOffersActionRes.Offers.SellingMode.Price(
            value,
          );
        }
      }
       ...
       **/
      #priceAutomation!: InstanceType<
        typeof GetSellersOffersActionRes.Offers.SellingMode.PriceAutomation
      >;
      /**
       *
      ...
      set priceAutomation(
        ...
        if (
          value instanceof
          GetSellersOffersActionRes.Offers.SellingMode.PriceAutomation
        ) {
          this.#priceAutomation = value;
        } else {
          this.#priceAutomation =
            new GetSellersOffersActionRes.Offers.SellingMode.PriceAutomation(
              value,
            );
        }
      }
      ...
      #minimalPrice!: InstanceType<
        typeof GetSellersOffersActionRes.Offers.SellingMode.MinimalPrice
      >;
      /**
       *
      ...
      set minimalPrice(
        ...
        if (
          value instanceof
          GetSellersOffersActionRes.Offers.SellingMode.MinimalPrice
        ) {
          this.#minimalPrice = value;
        } else {
          this.#minimalPrice =
            new GetSellersOffersActionRes.Offers.SellingMode.MinimalPrice(
              value,
            );
        }
      }
      ...
      #startingPrice!: InstanceType<
        typeof GetSellersOffersActionRes.Offers.SellingMode.StartingPrice
      >;
      /**
       *
      ...
      set startingPrice(
        ...
        if (
          value instanceof
          GetSellersOffersActionRes.Offers.SellingMode.StartingPrice
        ) {
          this.#startingPrice = value;
        } else {
          this.#startingPrice =
            new GetSellersOffersActionRes.Offers.SellingMode.StartingPrice(
              value,
            );
        }
      }
      ...
      static Price = class Price {
         ...
         **/
        static from(
          possibleDtoObject: GetSellersOffersActionResType.OffersType.SellingModeType.PriceType,
        ) {
          return new GetSellersOffersActionRes.Offers.SellingMode.Price(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.SellingModeType.PriceType>,
        ) {
          return new GetSellersOffersActionRes.Offers.SellingMode.Price(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetSellersOffersActionResType.OffersType.SellingModeType.PriceType>,
        ): InstanceType<
          typeof GetSellersOffersActionRes.Offers.SellingMode.Price
        > {
          return new GetSellersOffersActionRes.Offers.SellingMode.Price({
      ...
      static PriceAutomation = class PriceAutomation {
         ...
         **/
        #rule!: InstanceType<
          typeof GetSellersOffersActionRes.Offers.SellingMode.PriceAutomation.Rule
        >;
        /**
         *
        ...
        set rule(
          ...
          if (
            value instanceof
            GetSellersOffersActionRes.Offers.SellingMode.PriceAutomation.Rule
          ) {
            this.#rule = value;
          } else {
            this.#rule =
              new GetSellersOffersActionRes.Offers.SellingMode.PriceAutomation.Rule(
                value,
              );
          }
        }
        ...
        static Rule = class Rule {
           ...
           **/
          static from(
            possibleDtoObject: GetSellersOffersActionResType.OffersType.SellingModeType.PriceAutomationType.RuleType,
          ) {
            return new GetSellersOffersActionRes.Offers.SellingMode.PriceAutomation.Rule(
              possibleDtoObject,
            );
          }
          /**
           ...
           **/
          static with(
            partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.SellingModeType.PriceAutomationType.RuleType>,
          ) {
            return new GetSellersOffersActionRes.Offers.SellingMode.PriceAutomation.Rule(
              partialDtoObject,
            );
          ...
          copyWith(
            partial: PartialDeep<GetSellersOffersActionResType.OffersType.SellingModeType.PriceAutomationType.RuleType>,
          ): InstanceType<
            typeof GetSellersOffersActionRes.Offers.SellingMode.PriceAutomation.Rule
          > {
            return new GetSellersOffersActionRes.Offers.SellingMode.PriceAutomation.Rule(
         ...
         **/
        static from(
          possibleDtoObject: GetSellersOffersActionResType.OffersType.SellingModeType.PriceAutomationType,
        ) {
          return new GetSellersOffersActionRes.Offers.SellingMode.PriceAutomation(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.SellingModeType.PriceAutomationType>,
        ) {
          return new GetSellersOffersActionRes.Offers.SellingMode.PriceAutomation(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetSellersOffersActionResType.OffersType.SellingModeType.PriceAutomationType>,
        ): InstanceType<
          typeof GetSellersOffersActionRes.Offers.SellingMode.PriceAutomation
        > {
          return new GetSellersOffersActionRes.Offers.SellingMode.PriceAutomation(
      ...
      static MinimalPrice = class MinimalPrice {
         ...
         **/
        static from(
          possibleDtoObject: GetSellersOffersActionResType.OffersType.SellingModeType.MinimalPriceType,
        ) {
          return new GetSellersOffersActionRes.Offers.SellingMode.MinimalPrice(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.SellingModeType.MinimalPriceType>,
        ) {
          return new GetSellersOffersActionRes.Offers.SellingMode.MinimalPrice(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetSellersOffersActionResType.OffersType.SellingModeType.MinimalPriceType>,
        ): InstanceType<
          typeof GetSellersOffersActionRes.Offers.SellingMode.MinimalPrice
        > {
          return new GetSellersOffersActionRes.Offers.SellingMode.MinimalPrice({
      ...
      static StartingPrice = class StartingPrice {
         ...
         **/
        static from(
          possibleDtoObject: GetSellersOffersActionResType.OffersType.SellingModeType.StartingPriceType,
        ) {
          return new GetSellersOffersActionRes.Offers.SellingMode.StartingPrice(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.SellingModeType.StartingPriceType>,
        ) {
          return new GetSellersOffersActionRes.Offers.SellingMode.StartingPrice(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetSellersOffersActionResType.OffersType.SellingModeType.StartingPriceType>,
        ): InstanceType<
          typeof GetSellersOffersActionRes.Offers.SellingMode.StartingPrice
        > {
          return new GetSellersOffersActionRes.Offers.SellingMode.StartingPrice(
      ...
      applyFromObject(data = {}) {
        ...
        if (d.priceAutomation !== undefined) {
          this.priceAutomation = d.priceAutomation;
        }
      ...
      #lateInitFields(data = {}) {
        ...
        if (
          !(
            d.price instanceof
            GetSellersOffersActionRes.Offers.SellingMode.Price
          )
        ) {
          this.price = new GetSellersOffersActionRes.Offers.SellingMode.Price(
            d.price || {},
       ...
       **/
      static from(
        possibleDtoObject: GetSellersOffersActionResType.OffersType.SellingModeType,
      ) {
        return new GetSellersOffersActionRes.Offers.SellingMode(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.SellingModeType>,
      ) {
        return new GetSellersOffersActionRes.Offers.SellingMode(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetSellersOffersActionResType.OffersType.SellingModeType>,
      ): InstanceType<typeof GetSellersOffersActionRes.Offers.SellingMode> {
        return new GetSellersOffersActionRes.Offers.SellingMode({
          ...this.toJSON(),
          ...partial,
        });
    ...
    static SaleInfo = class SaleInfo {
       ...
       **/
      #currentPrice!: InstanceType<
        typeof GetSellersOffersActionRes.Offers.SaleInfo.CurrentPrice
      >;
      /**
       *
      ...
      set currentPrice(
        ...
        if (
          value instanceof
          GetSellersOffersActionRes.Offers.SaleInfo.CurrentPrice
        ) {
          this.#currentPrice = value;
        } else {
          this.#currentPrice =
            new GetSellersOffersActionRes.Offers.SaleInfo.CurrentPrice(value);
        }
      }
      setCurrentPrice(
        value: InstanceType<
      ...
      static CurrentPrice = class CurrentPrice {
         ...
         **/
        static from(
          possibleDtoObject: GetSellersOffersActionResType.OffersType.SaleInfoType.CurrentPriceType,
        ) {
          return new GetSellersOffersActionRes.Offers.SaleInfo.CurrentPrice(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.SaleInfoType.CurrentPriceType>,
        ) {
          return new GetSellersOffersActionRes.Offers.SaleInfo.CurrentPrice(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetSellersOffersActionResType.OffersType.SaleInfoType.CurrentPriceType>,
        ): InstanceType<
          typeof GetSellersOffersActionRes.Offers.SaleInfo.CurrentPrice
        > {
          return new GetSellersOffersActionRes.Offers.SaleInfo.CurrentPrice({
      ...
      applyFromObject(data = {}) {
        ...
        if (d.biddersCount !== undefined) {
          this.biddersCount = d.biddersCount;
        }
        this.#lateInitFields(data);
      }
      /**
      ...
      #lateInitFields(data = {}) {
        ...
        if (
          !(
            d.currentPrice instanceof
            GetSellersOffersActionRes.Offers.SaleInfo.CurrentPrice
          )
        ) {
          this.currentPrice =
            new GetSellersOffersActionRes.Offers.SaleInfo.CurrentPrice(
              d.currentPrice || {},
            );
        }
      }
       ...
       **/
      static from(
        possibleDtoObject: GetSellersOffersActionResType.OffersType.SaleInfoType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.SaleInfoType>,
      ) {
        return new GetSellersOffersActionRes.Offers.SaleInfo(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<GetSellersOffersActionResType.OffersType.SaleInfoType>,
      ): InstanceType<typeof GetSellersOffersActionRes.Offers.SaleInfo> {
        return new GetSellersOffersActionRes.Offers.SaleInfo({
          ...this.toJSON(),
          ...partial,
        });
      }
    ...
    static Stock = class Stock {
       ...
       **/
      static from(
        possibleDtoObject: GetSellersOffersActionResType.OffersType.StockType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.StockType>,
      ) {
        return new GetSellersOffersActionRes.Offers.Stock(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<GetSellersOffersActionResType.OffersType.StockType>,
      ): InstanceType<typeof GetSellersOffersActionRes.Offers.Stock> {
        return new GetSellersOffersActionRes.Offers.Stock({
          ...this.toJSON(),
          ...partial,
        });
      }
    ...
    static Stats = class Stats {
      ...
      applyFromObject(data = {}) {
        ...
        if (d.watchersCount !== undefined) {
          this.watchersCount = d.watchersCount;
        }
        if (d.visitsCount !== undefined) {
          this.visitsCount = d.visitsCount;
        }
      }
      /**
       *	Special toJSON override, since the field are private,
       ...
       **/
      static from(
        possibleDtoObject: GetSellersOffersActionResType.OffersType.StatsType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.StatsType>,
      ) {
        return new GetSellersOffersActionRes.Offers.Stats(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<GetSellersOffersActionResType.OffersType.StatsType>,
      ): InstanceType<typeof GetSellersOffersActionRes.Offers.Stats> {
        return new GetSellersOffersActionRes.Offers.Stats({
          ...this.toJSON(),
          ...partial,
        });
      }
    ...
    static Publication = class Publication {
      ...
      #marketplaces!: InstanceType<
        typeof GetSellersOffersActionRes.Offers.Publication.Marketplaces
      >;
      /**
       *
      ...
      set marketplaces(
        ...
        if (
          ...
          this.#marketplaces =
            new GetSellersOffersActionRes.Offers.Publication.Marketplaces(
              value,
            );
        }
      }
      ...
      static Marketplaces = class Marketplaces {
         ...
         **/
        #base!: InstanceType<
          typeof GetSellersOffersActionRes.Offers.Publication.Marketplaces.Base
        >;
        /**
         *
        ...
        set base(
          ...
          if (
            value instanceof
            GetSellersOffersActionRes.Offers.Publication.Marketplaces.Base
          ) {
            this.#base = value;
          } else {
            this.#base =
              new GetSellersOffersActionRes.Offers.Publication.Marketplaces.Base(
                value,
              );
          }
        }
        ...
        static Base = class Base {
           ...
           **/
          static from(
            possibleDtoObject: GetSellersOffersActionResType.OffersType.PublicationType.MarketplacesType.BaseType,
          ) {
            return new GetSellersOffersActionRes.Offers.Publication.Marketplaces.Base(
              possibleDtoObject,
            );
          }
          /**
           ...
           **/
          static with(
            partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.PublicationType.MarketplacesType.BaseType>,
          ) {
            return new GetSellersOffersActionRes.Offers.Publication.Marketplaces.Base(
              partialDtoObject,
            );
          ...
          copyWith(
            partial: PartialDeep<GetSellersOffersActionResType.OffersType.PublicationType.MarketplacesType.BaseType>,
          ): InstanceType<
            typeof GetSellersOffersActionRes.Offers.Publication.Marketplaces.Base
          > {
            return new GetSellersOffersActionRes.Offers.Publication.Marketplaces.Base(
        ...
        static Additional = class Additional {
           ...
           **/
          static from(
            possibleDtoObject: GetSellersOffersActionResType.OffersType.PublicationType.MarketplacesType.AdditionalType,
          ) {
            return new GetSellersOffersActionRes.Offers.Publication.Marketplaces.Additional(
              possibleDtoObject,
            );
          }
          /**
           ...
           **/
          static with(
            partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.PublicationType.MarketplacesType.AdditionalType>,
          ) {
            return new GetSellersOffersActionRes.Offers.Publication.Marketplaces.Additional(
              partialDtoObject,
            );
          ...
          copyWith(
            partial: PartialDeep<GetSellersOffersActionResType.OffersType.PublicationType.MarketplacesType.AdditionalType>,
          ): InstanceType<
            typeof GetSellersOffersActionRes.Offers.Publication.Marketplaces.Additional
          > {
            return new GetSellersOffersActionRes.Offers.Publication.Marketplaces.Additional(
         ...
         **/
        static from(
          possibleDtoObject: GetSellersOffersActionResType.OffersType.PublicationType.MarketplacesType,
        ) {
          return new GetSellersOffersActionRes.Offers.Publication.Marketplaces(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.PublicationType.MarketplacesType>,
        ) {
          return new GetSellersOffersActionRes.Offers.Publication.Marketplaces(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetSellersOffersActionResType.OffersType.PublicationType.MarketplacesType>,
        ): InstanceType<
          typeof GetSellersOffersActionRes.Offers.Publication.Marketplaces
        > {
          return new GetSellersOffersActionRes.Offers.Publication.Marketplaces({
       ...
       **/
      static from(
        possibleDtoObject: GetSellersOffersActionResType.OffersType.PublicationType,
      ) {
        return new GetSellersOffersActionRes.Offers.Publication(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.PublicationType>,
      ) {
        return new GetSellersOffersActionRes.Offers.Publication(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetSellersOffersActionResType.OffersType.PublicationType>,
      ): InstanceType<typeof GetSellersOffersActionRes.Offers.Publication> {
        return new GetSellersOffersActionRes.Offers.Publication({
          ...this.toJSON(),
          ...partial,
        });
    ...
    static AfterSalesServices = class AfterSalesServices {
      ...
      #impliedWarranty!: InstanceType<
        typeof GetSellersOffersActionRes.Offers.AfterSalesServices.ImpliedWarranty
      >;
      /**
       *
      ...
      set impliedWarranty(
        ...
        if (
          value instanceof
          GetSellersOffersActionRes.Offers.AfterSalesServices.ImpliedWarranty
        ) {
          this.#impliedWarranty = value;
        } else {
          this.#impliedWarranty =
            new GetSellersOffersActionRes.Offers.AfterSalesServices.ImpliedWarranty(
              value,
            );
        }
      }
      ...
      #returnPolicy!: InstanceType<
        typeof GetSellersOffersActionRes.Offers.AfterSalesServices.ReturnPolicy
      >;
      /**
       *
      ...
      set returnPolicy(
        ...
        if (
          value instanceof
          GetSellersOffersActionRes.Offers.AfterSalesServices.ReturnPolicy
        ) {
          this.#returnPolicy = value;
        } else {
          this.#returnPolicy =
            new GetSellersOffersActionRes.Offers.AfterSalesServices.ReturnPolicy(
              value,
            );
        }
      }
      ...
      #warranty!: InstanceType<
        typeof GetSellersOffersActionRes.Offers.AfterSalesServices.Warranty
      >;
      /**
       *
      ...
      set warranty(
        ...
        if (
          value instanceof
          GetSellersOffersActionRes.Offers.AfterSalesServices.Warranty
        ) {
          this.#warranty = value;
        } else {
          this.#warranty =
            new GetSellersOffersActionRes.Offers.AfterSalesServices.Warranty(
              value,
            );
        }
      }
      ...
      static ImpliedWarranty = class ImpliedWarranty {
         ...
         **/
        static from(
          possibleDtoObject: GetSellersOffersActionResType.OffersType.AfterSalesServicesType.ImpliedWarrantyType,
        ) {
          return new GetSellersOffersActionRes.Offers.AfterSalesServices.ImpliedWarranty(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.AfterSalesServicesType.ImpliedWarrantyType>,
        ) {
          return new GetSellersOffersActionRes.Offers.AfterSalesServices.ImpliedWarranty(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetSellersOffersActionResType.OffersType.AfterSalesServicesType.ImpliedWarrantyType>,
        ): InstanceType<
          typeof GetSellersOffersActionRes.Offers.AfterSalesServices.ImpliedWarranty
        > {
          return new GetSellersOffersActionRes.Offers.AfterSalesServices.ImpliedWarranty(
      ...
      static ReturnPolicy = class ReturnPolicy {
         ...
         **/
        static from(
          possibleDtoObject: GetSellersOffersActionResType.OffersType.AfterSalesServicesType.ReturnPolicyType,
        ) {
          return new GetSellersOffersActionRes.Offers.AfterSalesServices.ReturnPolicy(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.AfterSalesServicesType.ReturnPolicyType>,
        ) {
          return new GetSellersOffersActionRes.Offers.AfterSalesServices.ReturnPolicy(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetSellersOffersActionResType.OffersType.AfterSalesServicesType.ReturnPolicyType>,
        ): InstanceType<
          typeof GetSellersOffersActionRes.Offers.AfterSalesServices.ReturnPolicy
        > {
          return new GetSellersOffersActionRes.Offers.AfterSalesServices.ReturnPolicy(
      ...
      static Warranty = class Warranty {
         ...
         **/
        static from(
          possibleDtoObject: GetSellersOffersActionResType.OffersType.AfterSalesServicesType.WarrantyType,
        ) {
          return new GetSellersOffersActionRes.Offers.AfterSalesServices.Warranty(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.AfterSalesServicesType.WarrantyType>,
        ) {
          return new GetSellersOffersActionRes.Offers.AfterSalesServices.Warranty(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetSellersOffersActionResType.OffersType.AfterSalesServicesType.WarrantyType>,
        ): InstanceType<
          typeof GetSellersOffersActionRes.Offers.AfterSalesServices.Warranty
        > {
          return new GetSellersOffersActionRes.Offers.AfterSalesServices.Warranty(
        ...
        return {
          ...
          get impliedWarranty() {
            return withPrefix(
              ...
              GetSellersOffersActionRes.Offers.AfterSalesServices
       ...
       **/
      static from(
        possibleDtoObject: GetSellersOffersActionResType.OffersType.AfterSalesServicesType,
      ) {
        return new GetSellersOffersActionRes.Offers.AfterSalesServices(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.AfterSalesServicesType>,
      ) {
        return new GetSellersOffersActionRes.Offers.AfterSalesServices(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetSellersOffersActionResType.OffersType.AfterSalesServicesType>,
      ): InstanceType<
        typeof GetSellersOffersActionRes.Offers.AfterSalesServices
      > {
        return new GetSellersOffersActionRes.Offers.AfterSalesServices({
    ...
    static AdditionalServices = class AdditionalServices {
       ...
       **/
      static from(
        possibleDtoObject: GetSellersOffersActionResType.OffersType.AdditionalServicesType,
      ) {
        return new GetSellersOffersActionRes.Offers.AdditionalServices(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.AdditionalServicesType>,
      ) {
        return new GetSellersOffersActionRes.Offers.AdditionalServices(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetSellersOffersActionResType.OffersType.AdditionalServicesType>,
      ): InstanceType<
        typeof GetSellersOffersActionRes.Offers.AdditionalServices
      > {
        return new GetSellersOffersActionRes.Offers.AdditionalServices({
    ...
    static External = class External {
       ...
       **/
      static from(
        possibleDtoObject: GetSellersOffersActionResType.OffersType.ExternalType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.ExternalType>,
      ) {
        return new GetSellersOffersActionRes.Offers.External(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<GetSellersOffersActionResType.OffersType.ExternalType>,
      ): InstanceType<typeof GetSellersOffersActionRes.Offers.External> {
        return new GetSellersOffersActionRes.Offers.External({
          ...this.toJSON(),
          ...partial,
        });
      }
    ...
    static Delivery = class Delivery {
      ...
      #shippingRates!: InstanceType<
        typeof GetSellersOffersActionRes.Offers.Delivery.ShippingRates
      >;
      /**
       *
      ...
      set shippingRates(
        ...
        if (
          value instanceof
          GetSellersOffersActionRes.Offers.Delivery.ShippingRates
        ) {
          this.#shippingRates = value;
        } else {
          this.#shippingRates =
            new GetSellersOffersActionRes.Offers.Delivery.ShippingRates(value);
        }
      }
      setShippingRates(
        value: InstanceType<
      ...
      static ShippingRates = class ShippingRates {
         ...
         **/
        static from(
          possibleDtoObject: GetSellersOffersActionResType.OffersType.DeliveryType.ShippingRatesType,
        ) {
          return new GetSellersOffersActionRes.Offers.Delivery.ShippingRates(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.DeliveryType.ShippingRatesType>,
        ) {
          return new GetSellersOffersActionRes.Offers.Delivery.ShippingRates(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetSellersOffersActionResType.OffersType.DeliveryType.ShippingRatesType>,
        ): InstanceType<
          typeof GetSellersOffersActionRes.Offers.Delivery.ShippingRates
        > {
          return new GetSellersOffersActionRes.Offers.Delivery.ShippingRates({
      ...
      #lateInitFields(data = {}) {
        ...
        if (
          ...
          this.shippingRates =
            new GetSellersOffersActionRes.Offers.Delivery.ShippingRates(
              d.shippingRates || {},
            );
        }
      }
       ...
       **/
      static from(
        possibleDtoObject: GetSellersOffersActionResType.OffersType.DeliveryType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.DeliveryType>,
      ) {
        return new GetSellersOffersActionRes.Offers.Delivery(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<GetSellersOffersActionResType.OffersType.DeliveryType>,
      ): InstanceType<typeof GetSellersOffersActionRes.Offers.Delivery> {
        return new GetSellersOffersActionRes.Offers.Delivery({
          ...this.toJSON(),
          ...partial,
        });
      }
    ...
    static B2b = class B2b {
       ...
       **/
      static from(
        possibleDtoObject: GetSellersOffersActionResType.OffersType.B2bType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.B2bType>,
      ) {
        return new GetSellersOffersActionRes.Offers.B2b(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<GetSellersOffersActionResType.OffersType.B2bType>,
      ): InstanceType<typeof GetSellersOffersActionRes.Offers.B2b> {
        return new GetSellersOffersActionRes.Offers.B2b({
          ...this.toJSON(),
          ...partial,
        });
      }
    ...
    static FundraisingCampaign = class FundraisingCampaign {
       ...
       **/
      static from(
        possibleDtoObject: GetSellersOffersActionResType.OffersType.FundraisingCampaignType,
      ) {
        return new GetSellersOffersActionRes.Offers.FundraisingCampaign(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType.FundraisingCampaignType>,
      ) {
        return new GetSellersOffersActionRes.Offers.FundraisingCampaign(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetSellersOffersActionResType.OffersType.FundraisingCampaignType>,
      ): InstanceType<
        typeof GetSellersOffersActionRes.Offers.FundraisingCampaign
      > {
        return new GetSellersOffersActionRes.Offers.FundraisingCampaign({
    ...
    applyFromObject(data = {}) {
      ...
      if (d.primaryImage !== undefined) {
        this.primaryImage = d.primaryImage;
      }
      if (d.sellingMode !== undefined) {
        this.sellingMode = d.sellingMode;
      }
      if (d.saleInfo !== undefined) {
    ...
    #lateInitFields(data = {}) {
      const d = data as Partial<Offers>;
      if (!(d.category instanceof GetSellersOffersActionRes.Offers.Category)) {
        this.category = new GetSellersOffersActionRes.Offers.Category(
          d.category || {},
        );
      }
      if (
        !(
          d.primaryImage instanceof
          GetSellersOffersActionRes.Offers.PrimaryImage
        )
      ) {
        this.primaryImage = new GetSellersOffersActionRes.Offers.PrimaryImage(
          d.primaryImage || {},
      ...
      if (
        !(d.sellingMode instanceof GetSellersOffersActionRes.Offers.SellingMode)
      ) {
        this.sellingMode = new GetSellersOffersActionRes.Offers.SellingMode(
          d.sellingMode || {},
        );
      }
      if (!(d.saleInfo instanceof GetSellersOffersActionRes.Offers.SaleInfo)) {
        this.saleInfo = new GetSellersOffersActionRes.Offers.SaleInfo(
          d.saleInfo || {},
        );
      }
      if (!(d.stock instanceof GetSellersOffersActionRes.Offers.Stock)) {
        this.stock = new GetSellersOffersActionRes.Offers.Stock(d.stock || {});
      }
      if (!(d.stats instanceof GetSellersOffersActionRes.Offers.Stats)) {
        this.stats = new GetSellersOffersActionRes.Offers.Stats(d.stats || {});
      }
      if (
        !(d.publication instanceof GetSellersOffersActionRes.Offers.Publication)
      ) {
        this.publication = new GetSellersOffersActionRes.Offers.Publication(
          d.publication || {},
        );
      ...
      if (
        ...
        this.afterSalesServices =
          new GetSellersOffersActionRes.Offers.AfterSalesServices(
      ...
      if (
        !(
          ...
          GetSellersOffersActionRes.Offers.AdditionalServices
        )
      ) {
        this.additionalServices =
          new GetSellersOffersActionRes.Offers.AdditionalServices(
            d.additionalServices || {},
          );
      }
      if (!(d.external instanceof GetSellersOffersActionRes.Offers.External)) {
        this.external = new GetSellersOffersActionRes.Offers.External(
          d.external || {},
        );
      }
      if (!(d.delivery instanceof GetSellersOffersActionRes.Offers.Delivery)) {
        this.delivery = new GetSellersOffersActionRes.Offers.Delivery(
          d.delivery || {},
        );
      }
      if (!(d.b2b instanceof GetSellersOffersActionRes.Offers.B2b)) {
        this.b2b = new GetSellersOffersActionRes.Offers.B2b(d.b2b || {});
      }
      if (
        !(
          d.fundraisingCampaign instanceof
          GetSellersOffersActionRes.Offers.FundraisingCampaign
        )
      ) {
        this.fundraisingCampaign =
          new GetSellersOffersActionRes.Offers.FundraisingCampaign(
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetSellersOffersActionResType.OffersType>,
    ) {
      return new GetSellersOffersActionRes.Offers(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<GetSellersOffersActionResType.OffersType>,
    ): InstanceType<typeof GetSellersOffersActionRes.Offers> {
      return new GetSellersOffersActionRes.Offers({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  copyWith(
    partial: PartialDeep<GetSellersOffersActionResType>,
  ): InstanceType<typeof GetSellersOffersActionRes> {
