...
export class GetOffersWithMissingParametersAction {
  ...
  static NewUrl = (qs?: URLSearchParams) =>
    buildUrl(GetOffersWithMissingParametersAction.URL, undefined, qs);
  static Method = "get";
  static Fetch$ = async (
    qs?: URLSearchParams,
    ctx?: FetchxContext,
    ...
    return fetchx<GetOffersWithMissingParametersActionRes, unknown, unknown>(
      overrideUrl ?? GetOffersWithMissingParametersAction.NewUrl(qs),
      {
  ...
  static Fetch = async (
    init?: TypedRequestInit<unknown, unknown>,
    {
      ...
      creatorFn?:
        | ((item: unknown) => GetOffersWithMissingParametersActionRes)
        | undefined;
      qs?: URLSearchParams;
      ctx?: FetchxContext;
    ...
    creatorFn =
      creatorFn ||
      ((item) => new GetOffersWithMissingParametersActionRes(item));
...
export class GetOffersWithMissingParametersActionRes {
   ...
   **/
  #offers: InstanceType<
    typeof GetOffersWithMissingParametersActionRes.Offers
  >[] = [];
  /**
   *
  ...
  static Offers = class Offers {
    ...
    #parameters: InstanceType<
      typeof GetOffersWithMissingParametersActionRes.Offers.Parameters
    >[] = [];
    /**
     *
    ...
    #category!: InstanceType<
      typeof GetOffersWithMissingParametersActionRes.Offers.Category
    >;
    /**
     *
    ...
    set category(
      ...
      if (
        value instanceof GetOffersWithMissingParametersActionRes.Offers.Category
      ) {
        this.#category = value;
      } else {
        this.#category =
          new GetOffersWithMissingParametersActionRes.Offers.Category(value);
      }
    }
    setCategory(
      value: InstanceType<
    ...
    static Parameters = class Parameters {
       ...
       **/
      static from(
        possibleDtoObject: GetOffersWithMissingParametersActionResType.OffersType.ParametersType,
      ) {
        return new GetOffersWithMissingParametersActionRes.Offers.Parameters(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetOffersWithMissingParametersActionResType.OffersType.ParametersType>,
      ) {
        return new GetOffersWithMissingParametersActionRes.Offers.Parameters(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetOffersWithMissingParametersActionResType.OffersType.ParametersType>,
      ): InstanceType<
        typeof GetOffersWithMissingParametersActionRes.Offers.Parameters
      > {
        return new GetOffersWithMissingParametersActionRes.Offers.Parameters({
    ...
    static Category = class Category {
       ...
       **/
      static from(
        possibleDtoObject: GetOffersWithMissingParametersActionResType.OffersType.CategoryType,
      ) {
        return new GetOffersWithMissingParametersActionRes.Offers.Category(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetOffersWithMissingParametersActionResType.OffersType.CategoryType>,
      ) {
        return new GetOffersWithMissingParametersActionRes.Offers.Category(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetOffersWithMissingParametersActionResType.OffersType.CategoryType>,
      ): InstanceType<
        typeof GetOffersWithMissingParametersActionRes.Offers.Category
      > {
        return new GetOffersWithMissingParametersActionRes.Offers.Category({
    ...
    #lateInitFields(data = {}) {
      ...
      if (
        !(
          ...
          GetOffersWithMissingParametersActionRes.Offers.Category
        )
      ) {
        this.category =
          new GetOffersWithMissingParametersActionRes.Offers.Category(
            d.category || {},
          );
      }
    }
     ...
     **/
    static from(
      possibleDtoObject: GetOffersWithMissingParametersActionResType.OffersType,
    ) {
      return new GetOffersWithMissingParametersActionRes.Offers(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetOffersWithMissingParametersActionResType.OffersType>,
    ) {
      return new GetOffersWithMissingParametersActionRes.Offers(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetOffersWithMissingParametersActionResType.OffersType>,
    ): InstanceType<typeof GetOffersWithMissingParametersActionRes.Offers> {
      return new GetOffersWithMissingParametersActionRes.Offers({
        ...this.toJSON(),
        ...partial,
      });
   ...
   **/
  static with(
    partialDtoObject: PartialDeep<GetOffersWithMissingParametersActionResType>,
  ) {
    return new GetOffersWithMissingParametersActionRes(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<GetOffersWithMissingParametersActionResType>,
  ): InstanceType<typeof GetOffersWithMissingParametersActionRes> {
    return new GetOffersWithMissingParametersActionRes({
      ...this.toJSON(),
      ...partial,
    });
  }
