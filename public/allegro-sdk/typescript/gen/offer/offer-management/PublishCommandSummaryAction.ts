...
export class PublishCommandSummaryAction {
  ...
  static NewUrl = (qs?: URLSearchParams) =>
    buildUrl(PublishCommandSummaryAction.URL, undefined, qs);
  static Method = "get";
  static Fetch$ = async (
    qs?: URLSearchParams,
    ctx?: FetchxContext,
    ...
    return fetchx<PublishCommandSummaryActionRes, unknown, unknown>(
      overrideUrl ?? PublishCommandSummaryAction.NewUrl(qs),
      {
  ...
  static Fetch = async (
    init?: TypedRequestInit<unknown, unknown>,
    {
      ...
      creatorFn?:
        | ((item: unknown) => PublishCommandSummaryActionRes)
        | undefined;
      qs?: URLSearchParams;
      ctx?: FetchxContext;
...
export class PublishCommandSummaryActionRes {
   ...
   **/
  set taskCount(
    value: InstanceType<typeof PublishCommandSummaryActionRes.TaskCount>,
  ) {
  ...
  static TaskCount = class TaskCount {
     ...
     **/
    static from(
      possibleDtoObject: PublishCommandSummaryActionResType.TaskCountType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<PublishCommandSummaryActionResType.TaskCountType>,
    ) {
      return new PublishCommandSummaryActionRes.TaskCount(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<PublishCommandSummaryActionResType.TaskCountType>,
    ): InstanceType<typeof PublishCommandSummaryActionRes.TaskCount> {
      return new PublishCommandSummaryActionRes.TaskCount({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  #lateInitFields(data = {}) {
    const d = data as Partial<PublishCommandSummaryActionRes>;
    if (!(d.taskCount instanceof PublishCommandSummaryActionRes.TaskCount)) {
      this.taskCount = new PublishCommandSummaryActionRes.TaskCount(
        d.taskCount || {},
      );
    }
  }
   ...
   **/
  static with(
    partialDtoObject: PartialDeep<PublishCommandSummaryActionResType>,
  ) {
    return new PublishCommandSummaryActionRes(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<PublishCommandSummaryActionResType>,
  ): InstanceType<typeof PublishCommandSummaryActionRes> {
