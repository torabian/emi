...
export class CreateOfferBasedOnProductAction {
  ...
  static NewUrl = (qs?: URLSearchParams) =>
    buildUrl(CreateOfferBasedOnProductAction.URL, undefined, qs);
  static Method = "post";
  static Fetch$ = async (
    qs?: URLSearchParams,
    ctx?: FetchxContext,
    ...
    return fetchx<unknown, CreateOfferBasedOnProductActionReq, unknown>(
      overrideUrl ?? CreateOfferBasedOnProductAction.NewUrl(qs),
      {
...
export class CreateOfferBasedOnProductActionReq {
   ...
   **/
  set category(
    value: InstanceType<typeof CreateOfferBasedOnProductActionReq.Category>,
  ) {
  ...
  #productSet: InstanceType<
    typeof CreateOfferBasedOnProductActionReq.ProductSet
  >[] = [];
  /**
   * Product details and associated quantities
  ...
  set productSet(
    ...
    if (
      value.length > 0 &&
      value[0] instanceof CreateOfferBasedOnProductActionReq.ProductSet
    ) {
      this.#productSet = value;
    } else {
      this.#productSet = value.map(
        (item) => new CreateOfferBasedOnProductActionReq.ProductSet(item),
      );
    }
  }
  setProductSet(
   ...
   **/
  set stock(
    value: InstanceType<typeof CreateOfferBasedOnProductActionReq.Stock>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
  ...
  #sellingMode!: InstanceType<
    typeof CreateOfferBasedOnProductActionReq.SellingMode
  >;
  /**
   *
   ...
   **/
  set sellingMode(
    value: InstanceType<typeof CreateOfferBasedOnProductActionReq.SellingMode>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof CreateOfferBasedOnProductActionReq.SellingMode) {
      this.#sellingMode = value;
    } else {
      this.#sellingMode = new CreateOfferBasedOnProductActionReq.SellingMode(
        value,
      );
    }
  }
   ...
   **/
  set payments(
    value: InstanceType<typeof CreateOfferBasedOnProductActionReq.Payments>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
   ...
   **/
  set delivery(
    value: InstanceType<typeof CreateOfferBasedOnProductActionReq.Delivery>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
  ...
  #publication!: InstanceType<
    typeof CreateOfferBasedOnProductActionReq.Publication
  >;
  /**
   *
   ...
   **/
  set publication(
    value: InstanceType<typeof CreateOfferBasedOnProductActionReq.Publication>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof CreateOfferBasedOnProductActionReq.Publication) {
      this.#publication = value;
    } else {
      this.#publication = new CreateOfferBasedOnProductActionReq.Publication(
        value,
      );
    }
  }
  ...
  #compatibilityList!: InstanceType<
    typeof CreateOfferBasedOnProductActionReq.CompatibilityList
  >;
  /**
   *
  ...
  set compatibilityList(
    ...
    if (value instanceof CreateOfferBasedOnProductActionReq.CompatibilityList) {
      ...
      this.#compatibilityList =
        new CreateOfferBasedOnProductActionReq.CompatibilityList(value);
    }
  }
  ...
  #description!: InstanceType<
    typeof CreateOfferBasedOnProductActionReq.Description
  >;
  /**
   *
   ...
   **/
  set description(
    value: InstanceType<typeof CreateOfferBasedOnProductActionReq.Description>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof CreateOfferBasedOnProductActionReq.Description) {
      this.#description = value;
    } else {
      this.#description = new CreateOfferBasedOnProductActionReq.Description(
        value,
      );
    }
  }
  ...
  set attachments(
    ...
    if (
      value.length > 0 &&
      value[0] instanceof CreateOfferBasedOnProductActionReq.Attachments
    ) {
      this.#attachments = value;
    } else {
      this.#attachments = value.map(
        (item) => new CreateOfferBasedOnProductActionReq.Attachments(item),
      );
    }
  }
  setAttachments(
  ...
  #fundraisingCampaign!: InstanceType<
    typeof CreateOfferBasedOnProductActionReq.FundraisingCampaign
  >;
  /**
   *
  ...
  set fundraisingCampaign(
    ...
    // For objects, the sub type needs to always be instance of the sub class.
    if (
      value instanceof CreateOfferBasedOnProductActionReq.FundraisingCampaign
    ) {
      this.#fundraisingCampaign = value;
    } else {
      this.#fundraisingCampaign =
        new CreateOfferBasedOnProductActionReq.FundraisingCampaign(value);
    }
  }
  ...
  #additionalServices!: InstanceType<
    typeof CreateOfferBasedOnProductActionReq.AdditionalServices
  >;
  /**
   *
  ...
  set additionalServices(
    ...
    // For objects, the sub type needs to always be instance of the sub class.
    if (
      value instanceof CreateOfferBasedOnProductActionReq.AdditionalServices
    ) {
      this.#additionalServices = value;
    } else {
      this.#additionalServices =
        new CreateOfferBasedOnProductActionReq.AdditionalServices(value);
    }
  }
  ...
  #afterSalesServices!: InstanceType<
    typeof CreateOfferBasedOnProductActionReq.AfterSalesServices
  >;
  /**
   *
  ...
  set afterSalesServices(
    ...
    // For objects, the sub type needs to always be instance of the sub class.
    if (
      value instanceof CreateOfferBasedOnProductActionReq.AfterSalesServices
    ) {
      this.#afterSalesServices = value;
    } else {
      this.#afterSalesServices =
        new CreateOfferBasedOnProductActionReq.AfterSalesServices(value);
    }
  }
  ...
  #sizeTable!: InstanceType<
    typeof CreateOfferBasedOnProductActionReq.SizeTable
  >;
  /**
   *
   ...
   **/
  set sizeTable(
    value: InstanceType<typeof CreateOfferBasedOnProductActionReq.SizeTable>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
   ...
   **/
  set contact(
    value: InstanceType<typeof CreateOfferBasedOnProductActionReq.Contact>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
  ...
  #discounts!: InstanceType<
    typeof CreateOfferBasedOnProductActionReq.Discounts
  >;
  /**
   *
   ...
   **/
  set discounts(
    value: InstanceType<typeof CreateOfferBasedOnProductActionReq.Discounts>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
   ...
   **/
  set location(
    value: InstanceType<typeof CreateOfferBasedOnProductActionReq.Location>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
   ...
   **/
  set external(
    value: InstanceType<typeof CreateOfferBasedOnProductActionReq.External>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
  ...
  #taxSettings!: InstanceType<
    typeof CreateOfferBasedOnProductActionReq.TaxSettings
  >;
  /**
   *
   ...
   **/
  set taxSettings(
    value: InstanceType<typeof CreateOfferBasedOnProductActionReq.TaxSettings>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof CreateOfferBasedOnProductActionReq.TaxSettings) {
      this.#taxSettings = value;
    } else {
      this.#taxSettings = new CreateOfferBasedOnProductActionReq.TaxSettings(
        value,
      );
    }
  }
  ...
  #messageToSellerSettings!: InstanceType<
    typeof CreateOfferBasedOnProductActionReq.MessageToSellerSettings
  >;
  /**
   *
  ...
  set messageToSellerSettings(
    ...
    if (
      value instanceof
      CreateOfferBasedOnProductActionReq.MessageToSellerSettings
    ) {
      this.#messageToSellerSettings = value;
    } else {
      this.#messageToSellerSettings =
        new CreateOfferBasedOnProductActionReq.MessageToSellerSettings(value);
    }
  }
  ...
  static Category = class Category {
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.CategoryType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.CategoryType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.Category(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.CategoryType>,
    ): InstanceType<typeof CreateOfferBasedOnProductActionReq.Category> {
      return new CreateOfferBasedOnProductActionReq.Category({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static ProductSet = class ProductSet {
    ...
    #product!: InstanceType<
      typeof CreateOfferBasedOnProductActionReq.ProductSet.Product
    >;
    /**
     *
    ...
    set product(
      ...
      // For objects, the sub type needs to always be instance of the sub class.
      if (
        value instanceof CreateOfferBasedOnProductActionReq.ProductSet.Product
      ) {
        this.#product = value;
      } else {
        this.#product =
          new CreateOfferBasedOnProductActionReq.ProductSet.Product(value);
      }
    }
    setProduct(
      value: InstanceType<
    ...
    #quantity!: InstanceType<
      typeof CreateOfferBasedOnProductActionReq.ProductSet.Quantity
    >;
    /**
     *
    ...
    set quantity(
      ...
      // For objects, the sub type needs to always be instance of the sub class.
      if (
        value instanceof CreateOfferBasedOnProductActionReq.ProductSet.Quantity
      ) {
        this.#quantity = value;
      } else {
        this.#quantity =
          new CreateOfferBasedOnProductActionReq.ProductSet.Quantity(value);
      }
    }
    setQuantity(
      value: InstanceType<
    ...
    #responsiblePerson!: InstanceType<
      typeof CreateOfferBasedOnProductActionReq.ProductSet.ResponsiblePerson
    >;
    /**
     *
    ...
    set responsiblePerson(
      ...
      if (
        value instanceof
        CreateOfferBasedOnProductActionReq.ProductSet.ResponsiblePerson
      ) {
        this.#responsiblePerson = value;
      } else {
        this.#responsiblePerson =
          new CreateOfferBasedOnProductActionReq.ProductSet.ResponsiblePerson(
            value,
          );
      }
    }
    ...
    #responsibleProducer!: InstanceType<
      typeof CreateOfferBasedOnProductActionReq.ProductSet.ResponsibleProducer
    >;
    /**
     *
    ...
    set responsibleProducer(
      ...
      if (
        value instanceof
        CreateOfferBasedOnProductActionReq.ProductSet.ResponsibleProducer
      ) {
        this.#responsibleProducer = value;
      } else {
        this.#responsibleProducer =
          new CreateOfferBasedOnProductActionReq.ProductSet.ResponsibleProducer(
            value,
          );
      }
    }
    ...
    #safetyInformation!: InstanceType<
      typeof CreateOfferBasedOnProductActionReq.ProductSet.SafetyInformation
    >;
    /**
     *
    ...
    set safetyInformation(
      ...
      if (
        value instanceof
        CreateOfferBasedOnProductActionReq.ProductSet.SafetyInformation
      ) {
        this.#safetyInformation = value;
      } else {
        this.#safetyInformation =
          new CreateOfferBasedOnProductActionReq.ProductSet.SafetyInformation(
            value,
          );
      }
    }
    ...
    set deposits(
      ...
      if (
        value.length > 0 &&
        value[0] instanceof
          CreateOfferBasedOnProductActionReq.ProductSet.Deposits
      ) {
        this.#deposits = value;
      } else {
        this.#deposits = value.map(
          (item) =>
            new CreateOfferBasedOnProductActionReq.ProductSet.Deposits(item),
        );
      }
    }
    setDeposits(
    ...
    static Product = class Product {
      ...
      #category!: InstanceType<
        typeof CreateOfferBasedOnProductActionReq.ProductSet.Product.Category
      >;
      /**
       *
      ...
      set category(
        ...
        if (
          value instanceof
          CreateOfferBasedOnProductActionReq.ProductSet.Product.Category
        ) {
          this.#category = value;
        } else {
          this.#category =
            new CreateOfferBasedOnProductActionReq.ProductSet.Product.Category(
              value,
            );
        }
      }
      ...
      set parameters(
        ...
        if (
          value.length > 0 &&
          value[0] instanceof
            CreateOfferBasedOnProductActionReq.ProductSet.Product.Parameters
        ) {
          this.#parameters = value;
        } else {
          this.#parameters = value.map(
            (item) =>
              new CreateOfferBasedOnProductActionReq.ProductSet.Product.Parameters(
                item,
              ),
          );
        }
      ...
      static Category = class Category {
         ...
         **/
        static from(
          possibleDtoObject: CreateOfferBasedOnProductActionReqType.ProductSetType.ProductType.CategoryType,
        ) {
          return new CreateOfferBasedOnProductActionReq.ProductSet.Product.Category(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType.ProductType.CategoryType>,
        ) {
          return new CreateOfferBasedOnProductActionReq.ProductSet.Product.Category(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType.ProductType.CategoryType>,
        ): InstanceType<
          typeof CreateOfferBasedOnProductActionReq.ProductSet.Product.Category
        > {
          return new CreateOfferBasedOnProductActionReq.ProductSet.Product.Category(
      ...
      static Parameters = class Parameters {
        ...
        #rangeValue!: InstanceType<
          typeof CreateOfferBasedOnProductActionReq.ProductSet.Product.Parameters.RangeValue
        >;
        /**
         *
        ...
        set rangeValue(
          ...
          if (
            ...
            this.#rangeValue =
              new CreateOfferBasedOnProductActionReq.ProductSet.Product.Parameters.RangeValue(
                value,
              );
          }
        }
        ...
        static RangeValue = class RangeValue {
           ...
           **/
          static from(
            possibleDtoObject: CreateOfferBasedOnProductActionReqType.ProductSetType.ProductType.ParametersType.RangeValueType,
          ) {
            return new CreateOfferBasedOnProductActionReq.ProductSet.Product.Parameters.RangeValue(
              possibleDtoObject,
            );
          }
          /**
           ...
           **/
          static with(
            partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType.ProductType.ParametersType.RangeValueType>,
          ) {
            return new CreateOfferBasedOnProductActionReq.ProductSet.Product.Parameters.RangeValue(
              partialDtoObject,
            );
          ...
          copyWith(
            partial: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType.ProductType.ParametersType.RangeValueType>,
          ): InstanceType<
            typeof CreateOfferBasedOnProductActionReq.ProductSet.Product.Parameters.RangeValue
          > {
            return new CreateOfferBasedOnProductActionReq.ProductSet.Product.Parameters.RangeValue(
         ...
         **/
        static from(
          possibleDtoObject: CreateOfferBasedOnProductActionReqType.ProductSetType.ProductType.ParametersType,
        ) {
          return new CreateOfferBasedOnProductActionReq.ProductSet.Product.Parameters(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType.ProductType.ParametersType>,
        ) {
          return new CreateOfferBasedOnProductActionReq.ProductSet.Product.Parameters(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType.ProductType.ParametersType>,
        ): InstanceType<
          typeof CreateOfferBasedOnProductActionReq.ProductSet.Product.Parameters
        > {
          return new CreateOfferBasedOnProductActionReq.ProductSet.Product.Parameters(
       ...
       **/
      static from(
        possibleDtoObject: CreateOfferBasedOnProductActionReqType.ProductSetType.ProductType,
      ) {
        return new CreateOfferBasedOnProductActionReq.ProductSet.Product(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType.ProductType>,
      ) {
        return new CreateOfferBasedOnProductActionReq.ProductSet.Product(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType.ProductType>,
      ): InstanceType<
        typeof CreateOfferBasedOnProductActionReq.ProductSet.Product
      > {
        return new CreateOfferBasedOnProductActionReq.ProductSet.Product({
    ...
    static Quantity = class Quantity {
       ...
       **/
      static from(
        possibleDtoObject: CreateOfferBasedOnProductActionReqType.ProductSetType.QuantityType,
      ) {
        return new CreateOfferBasedOnProductActionReq.ProductSet.Quantity(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType.QuantityType>,
      ) {
        return new CreateOfferBasedOnProductActionReq.ProductSet.Quantity(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType.QuantityType>,
      ): InstanceType<
        typeof CreateOfferBasedOnProductActionReq.ProductSet.Quantity
      > {
        return new CreateOfferBasedOnProductActionReq.ProductSet.Quantity({
    ...
    static ResponsiblePerson = class ResponsiblePerson {
       ...
       **/
      static from(
        possibleDtoObject: CreateOfferBasedOnProductActionReqType.ProductSetType.ResponsiblePersonType,
      ) {
        return new CreateOfferBasedOnProductActionReq.ProductSet.ResponsiblePerson(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType.ResponsiblePersonType>,
      ) {
        return new CreateOfferBasedOnProductActionReq.ProductSet.ResponsiblePerson(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType.ResponsiblePersonType>,
      ): InstanceType<
        typeof CreateOfferBasedOnProductActionReq.ProductSet.ResponsiblePerson
      > {
        return new CreateOfferBasedOnProductActionReq.ProductSet.ResponsiblePerson(
    ...
    static ResponsibleProducer = class ResponsibleProducer {
       ...
       **/
      static from(
        possibleDtoObject: CreateOfferBasedOnProductActionReqType.ProductSetType.ResponsibleProducerType,
      ) {
        return new CreateOfferBasedOnProductActionReq.ProductSet.ResponsibleProducer(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType.ResponsibleProducerType>,
      ) {
        return new CreateOfferBasedOnProductActionReq.ProductSet.ResponsibleProducer(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType.ResponsibleProducerType>,
      ): InstanceType<
        typeof CreateOfferBasedOnProductActionReq.ProductSet.ResponsibleProducer
      > {
        return new CreateOfferBasedOnProductActionReq.ProductSet.ResponsibleProducer(
    ...
    static SafetyInformation = class SafetyInformation {
       ...
       **/
      static from(
        possibleDtoObject: CreateOfferBasedOnProductActionReqType.ProductSetType.SafetyInformationType,
      ) {
        return new CreateOfferBasedOnProductActionReq.ProductSet.SafetyInformation(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType.SafetyInformationType>,
      ) {
        return new CreateOfferBasedOnProductActionReq.ProductSet.SafetyInformation(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType.SafetyInformationType>,
      ): InstanceType<
        typeof CreateOfferBasedOnProductActionReq.ProductSet.SafetyInformation
      > {
        return new CreateOfferBasedOnProductActionReq.ProductSet.SafetyInformation(
    ...
    static Deposits = class Deposits {
       ...
       **/
      static from(
        possibleDtoObject: CreateOfferBasedOnProductActionReqType.ProductSetType.DepositsType,
      ) {
        return new CreateOfferBasedOnProductActionReq.ProductSet.Deposits(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType.DepositsType>,
      ) {
        return new CreateOfferBasedOnProductActionReq.ProductSet.Deposits(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType.DepositsType>,
      ): InstanceType<
        typeof CreateOfferBasedOnProductActionReq.ProductSet.Deposits
      > {
        return new CreateOfferBasedOnProductActionReq.ProductSet.Deposits({
    ...
    #lateInitFields(data = {}) {
      ...
      if (
        !(
          ...
          CreateOfferBasedOnProductActionReq.ProductSet.Product
        )
      ) {
        this.product =
          new CreateOfferBasedOnProductActionReq.ProductSet.Product(
            d.product || {},
          );
      }
      if (
        !(
          ...
          CreateOfferBasedOnProductActionReq.ProductSet.Quantity
        )
      ) {
        this.quantity =
          new CreateOfferBasedOnProductActionReq.ProductSet.Quantity(
            d.quantity || {},
          );
      }
      if (
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.ProductSetType,
    ) {
      return new CreateOfferBasedOnProductActionReq.ProductSet(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.ProductSet(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.ProductSetType>,
    ): InstanceType<typeof CreateOfferBasedOnProductActionReq.ProductSet> {
      return new CreateOfferBasedOnProductActionReq.ProductSet({
        ...this.toJSON(),
        ...partial,
      });
  ...
  static Stock = class Stock {
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.StockType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.StockType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.Stock(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.StockType>,
    ): InstanceType<typeof CreateOfferBasedOnProductActionReq.Stock> {
      return new CreateOfferBasedOnProductActionReq.Stock({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static SellingMode = class SellingMode {
     ...
     **/
    #price!: InstanceType<
      typeof CreateOfferBasedOnProductActionReq.SellingMode.Price
    >;
    /**
     *
    ...
    set price(
      ...
      // For objects, the sub type needs to always be instance of the sub class.
      if (
        value instanceof CreateOfferBasedOnProductActionReq.SellingMode.Price
      ) {
        this.#price = value;
      } else {
        this.#price = new CreateOfferBasedOnProductActionReq.SellingMode.Price(
          value,
        );
      }
    }
    ...
    #minimalPrice!: InstanceType<
      typeof CreateOfferBasedOnProductActionReq.SellingMode.MinimalPrice
    >;
    /**
     *
    ...
    set minimalPrice(
      ...
      if (
        value instanceof
        CreateOfferBasedOnProductActionReq.SellingMode.MinimalPrice
      ) {
        this.#minimalPrice = value;
      } else {
        this.#minimalPrice =
          new CreateOfferBasedOnProductActionReq.SellingMode.MinimalPrice(
            value,
          );
      }
    }
    ...
    #startingPrice!: InstanceType<
      typeof CreateOfferBasedOnProductActionReq.SellingMode.StartingPrice
    >;
    /**
     *
    ...
    set startingPrice(
      ...
      if (
        value instanceof
        CreateOfferBasedOnProductActionReq.SellingMode.StartingPrice
      ) {
        this.#startingPrice = value;
      } else {
        this.#startingPrice =
          new CreateOfferBasedOnProductActionReq.SellingMode.StartingPrice(
            value,
          );
      }
    }
    ...
    static Price = class Price {
       ...
       **/
      static from(
        possibleDtoObject: CreateOfferBasedOnProductActionReqType.SellingModeType.PriceType,
      ) {
        return new CreateOfferBasedOnProductActionReq.SellingMode.Price(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.SellingModeType.PriceType>,
      ) {
        return new CreateOfferBasedOnProductActionReq.SellingMode.Price(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<CreateOfferBasedOnProductActionReqType.SellingModeType.PriceType>,
      ): InstanceType<
        typeof CreateOfferBasedOnProductActionReq.SellingMode.Price
      > {
        return new CreateOfferBasedOnProductActionReq.SellingMode.Price({
    ...
    static MinimalPrice = class MinimalPrice {
       ...
       **/
      static from(
        possibleDtoObject: CreateOfferBasedOnProductActionReqType.SellingModeType.MinimalPriceType,
      ) {
        return new CreateOfferBasedOnProductActionReq.SellingMode.MinimalPrice(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.SellingModeType.MinimalPriceType>,
      ) {
        return new CreateOfferBasedOnProductActionReq.SellingMode.MinimalPrice(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<CreateOfferBasedOnProductActionReqType.SellingModeType.MinimalPriceType>,
      ): InstanceType<
        typeof CreateOfferBasedOnProductActionReq.SellingMode.MinimalPrice
      > {
        return new CreateOfferBasedOnProductActionReq.SellingMode.MinimalPrice({
    ...
    static StartingPrice = class StartingPrice {
       ...
       **/
      static from(
        possibleDtoObject: CreateOfferBasedOnProductActionReqType.SellingModeType.StartingPriceType,
      ) {
        return new CreateOfferBasedOnProductActionReq.SellingMode.StartingPrice(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.SellingModeType.StartingPriceType>,
      ) {
        return new CreateOfferBasedOnProductActionReq.SellingMode.StartingPrice(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<CreateOfferBasedOnProductActionReqType.SellingModeType.StartingPriceType>,
      ): InstanceType<
        typeof CreateOfferBasedOnProductActionReq.SellingMode.StartingPrice
      > {
        return new CreateOfferBasedOnProductActionReq.SellingMode.StartingPrice(
    ...
    #lateInitFields(data = {}) {
      ...
      if (
        !(
          d.price instanceof
          CreateOfferBasedOnProductActionReq.SellingMode.Price
        )
      ) {
        this.price = new CreateOfferBasedOnProductActionReq.SellingMode.Price(
          d.price || {},
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.SellingModeType,
    ) {
      return new CreateOfferBasedOnProductActionReq.SellingMode(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.SellingModeType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.SellingMode(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.SellingModeType>,
    ): InstanceType<typeof CreateOfferBasedOnProductActionReq.SellingMode> {
      return new CreateOfferBasedOnProductActionReq.SellingMode({
        ...this.toJSON(),
        ...partial,
      });
  ...
  static Payments = class Payments {
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.PaymentsType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.PaymentsType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.Payments(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.PaymentsType>,
    ): InstanceType<typeof CreateOfferBasedOnProductActionReq.Payments> {
      return new CreateOfferBasedOnProductActionReq.Payments({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static Delivery = class Delivery {
    ...
    #shippingRates!: InstanceType<
      typeof CreateOfferBasedOnProductActionReq.Delivery.ShippingRates
    >;
    /**
     * Optional; may be null
    ...
    set shippingRates(
      ...
      if (
        value instanceof
        CreateOfferBasedOnProductActionReq.Delivery.ShippingRates
      ) {
        this.#shippingRates = value;
      } else {
        this.#shippingRates =
          new CreateOfferBasedOnProductActionReq.Delivery.ShippingRates(value);
      }
    }
    setShippingRates(
      value: InstanceType<
    ...
    static ShippingRates = class ShippingRates {
       ...
       **/
      static from(
        possibleDtoObject: CreateOfferBasedOnProductActionReqType.DeliveryType.ShippingRatesType,
      ) {
        return new CreateOfferBasedOnProductActionReq.Delivery.ShippingRates(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.DeliveryType.ShippingRatesType>,
      ) {
        return new CreateOfferBasedOnProductActionReq.Delivery.ShippingRates(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<CreateOfferBasedOnProductActionReqType.DeliveryType.ShippingRatesType>,
      ): InstanceType<
        typeof CreateOfferBasedOnProductActionReq.Delivery.ShippingRates
      > {
        return new CreateOfferBasedOnProductActionReq.Delivery.ShippingRates({
    ...
    #lateInitFields(data = {}) {
      ...
      if (
        ...
        this.shippingRates =
          new CreateOfferBasedOnProductActionReq.Delivery.ShippingRates(
            d.shippingRates || {},
          );
      }
    }
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.DeliveryType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.DeliveryType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.Delivery(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.DeliveryType>,
    ): InstanceType<typeof CreateOfferBasedOnProductActionReq.Delivery> {
      return new CreateOfferBasedOnProductActionReq.Delivery({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static Publication = class Publication {
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.PublicationType,
    ) {
      return new CreateOfferBasedOnProductActionReq.Publication(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.PublicationType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.Publication(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.PublicationType>,
    ): InstanceType<typeof CreateOfferBasedOnProductActionReq.Publication> {
      return new CreateOfferBasedOnProductActionReq.Publication({
        ...this.toJSON(),
        ...partial,
      });
  ...
  static CompatibilityList = class CompatibilityList {
    ...
    set items(
      ...
      if (
        value.length > 0 &&
        value[0] instanceof
          CreateOfferBasedOnProductActionReq.CompatibilityList.Items
      ) {
        this.#items = value;
      } else {
        this.#items = value.map(
          (item) =>
            new CreateOfferBasedOnProductActionReq.CompatibilityList.Items(
              item,
            ),
        );
      }
    ...
    static Items = class Items {
       ...
       **/
      static from(
        possibleDtoObject: CreateOfferBasedOnProductActionReqType.CompatibilityListType.ItemsType,
      ) {
        return new CreateOfferBasedOnProductActionReq.CompatibilityList.Items(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.CompatibilityListType.ItemsType>,
      ) {
        return new CreateOfferBasedOnProductActionReq.CompatibilityList.Items(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<CreateOfferBasedOnProductActionReqType.CompatibilityListType.ItemsType>,
      ): InstanceType<
        typeof CreateOfferBasedOnProductActionReq.CompatibilityList.Items
      > {
        return new CreateOfferBasedOnProductActionReq.CompatibilityList.Items({
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.CompatibilityListType,
    ) {
      return new CreateOfferBasedOnProductActionReq.CompatibilityList(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.CompatibilityListType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.CompatibilityList(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.CompatibilityListType>,
    ): InstanceType<
      typeof CreateOfferBasedOnProductActionReq.CompatibilityList
    > {
      return new CreateOfferBasedOnProductActionReq.CompatibilityList({
  ...
  static Description = class Description {
    ...
    set sections(
      ...
      if (
        value.length > 0 &&
        value[0] instanceof
          CreateOfferBasedOnProductActionReq.Description.Sections
      ) {
        this.#sections = value;
      } else {
        this.#sections = value.map(
          (item) =>
            new CreateOfferBasedOnProductActionReq.Description.Sections(item),
        );
      }
    }
    setSections(
    ...
    static Sections = class Sections {
      ...
      set items(
        ...
        if (
          value.length > 0 &&
          value[0] instanceof
            CreateOfferBasedOnProductActionReq.Description.Sections.Items
        ) {
          this.#items = value;
        } else {
          this.#items = value.map(
            (item) =>
              new CreateOfferBasedOnProductActionReq.Description.Sections.Items(
                item,
              ),
          );
        }
      ...
      static Items = class Items {
         ...
         **/
        static from(
          possibleDtoObject: CreateOfferBasedOnProductActionReqType.DescriptionType.SectionsType.ItemsType,
        ) {
          return new CreateOfferBasedOnProductActionReq.Description.Sections.Items(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.DescriptionType.SectionsType.ItemsType>,
        ) {
          return new CreateOfferBasedOnProductActionReq.Description.Sections.Items(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<CreateOfferBasedOnProductActionReqType.DescriptionType.SectionsType.ItemsType>,
        ): InstanceType<
          typeof CreateOfferBasedOnProductActionReq.Description.Sections.Items
        > {
          return new CreateOfferBasedOnProductActionReq.Description.Sections.Items(
       ...
       **/
      static from(
        possibleDtoObject: CreateOfferBasedOnProductActionReqType.DescriptionType.SectionsType,
      ) {
        return new CreateOfferBasedOnProductActionReq.Description.Sections(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.DescriptionType.SectionsType>,
      ) {
        return new CreateOfferBasedOnProductActionReq.Description.Sections(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<CreateOfferBasedOnProductActionReqType.DescriptionType.SectionsType>,
      ): InstanceType<
        typeof CreateOfferBasedOnProductActionReq.Description.Sections
      > {
        return new CreateOfferBasedOnProductActionReq.Description.Sections({
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.DescriptionType,
    ) {
      return new CreateOfferBasedOnProductActionReq.Description(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.DescriptionType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.Description(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.DescriptionType>,
    ): InstanceType<typeof CreateOfferBasedOnProductActionReq.Description> {
      return new CreateOfferBasedOnProductActionReq.Description({
        ...this.toJSON(),
        ...partial,
      });
  ...
  static B2b = class B2b {
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.B2bType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.B2bType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.B2b(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.B2bType>,
    ): InstanceType<typeof CreateOfferBasedOnProductActionReq.B2b> {
      return new CreateOfferBasedOnProductActionReq.B2b({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static Attachments = class Attachments {
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.AttachmentsType,
    ) {
      return new CreateOfferBasedOnProductActionReq.Attachments(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.AttachmentsType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.Attachments(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.AttachmentsType>,
    ): InstanceType<typeof CreateOfferBasedOnProductActionReq.Attachments> {
      return new CreateOfferBasedOnProductActionReq.Attachments({
        ...this.toJSON(),
        ...partial,
      });
  ...
  static FundraisingCampaign = class FundraisingCampaign {
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.FundraisingCampaignType,
    ) {
      return new CreateOfferBasedOnProductActionReq.FundraisingCampaign(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.FundraisingCampaignType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.FundraisingCampaign(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.FundraisingCampaignType>,
    ): InstanceType<
      typeof CreateOfferBasedOnProductActionReq.FundraisingCampaign
    > {
      return new CreateOfferBasedOnProductActionReq.FundraisingCampaign({
  ...
  static AdditionalServices = class AdditionalServices {
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.AdditionalServicesType,
    ) {
      return new CreateOfferBasedOnProductActionReq.AdditionalServices(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.AdditionalServicesType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.AdditionalServices(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.AdditionalServicesType>,
    ): InstanceType<
      typeof CreateOfferBasedOnProductActionReq.AdditionalServices
    > {
      return new CreateOfferBasedOnProductActionReq.AdditionalServices({
  ...
  static AfterSalesServices = class AfterSalesServices {
    ...
    #impliedWarranty!: InstanceType<
      typeof CreateOfferBasedOnProductActionReq.AfterSalesServices.ImpliedWarranty
    >;
    /**
     *
    ...
    set impliedWarranty(
      ...
      if (
        value instanceof
        CreateOfferBasedOnProductActionReq.AfterSalesServices.ImpliedWarranty
      ) {
        this.#impliedWarranty = value;
      } else {
        this.#impliedWarranty =
          new CreateOfferBasedOnProductActionReq.AfterSalesServices.ImpliedWarranty(
            value,
          );
      }
    }
    ...
    #returnPolicy!: InstanceType<
      typeof CreateOfferBasedOnProductActionReq.AfterSalesServices.ReturnPolicy
    >;
    /**
     *
    ...
    set returnPolicy(
      ...
      if (
        value instanceof
        CreateOfferBasedOnProductActionReq.AfterSalesServices.ReturnPolicy
      ) {
        this.#returnPolicy = value;
      } else {
        this.#returnPolicy =
          new CreateOfferBasedOnProductActionReq.AfterSalesServices.ReturnPolicy(
            value,
          );
      }
    }
    ...
    #warranty!: InstanceType<
      typeof CreateOfferBasedOnProductActionReq.AfterSalesServices.Warranty
    >;
    /**
     *
    ...
    set warranty(
      ...
      if (
        value instanceof
        CreateOfferBasedOnProductActionReq.AfterSalesServices.Warranty
      ) {
        this.#warranty = value;
      } else {
        this.#warranty =
          new CreateOfferBasedOnProductActionReq.AfterSalesServices.Warranty(
            value,
          );
      }
    }
    ...
    static ImpliedWarranty = class ImpliedWarranty {
       ...
       **/
      static from(
        possibleDtoObject: CreateOfferBasedOnProductActionReqType.AfterSalesServicesType.ImpliedWarrantyType,
      ) {
        return new CreateOfferBasedOnProductActionReq.AfterSalesServices.ImpliedWarranty(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.AfterSalesServicesType.ImpliedWarrantyType>,
      ) {
        return new CreateOfferBasedOnProductActionReq.AfterSalesServices.ImpliedWarranty(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<CreateOfferBasedOnProductActionReqType.AfterSalesServicesType.ImpliedWarrantyType>,
      ): InstanceType<
        typeof CreateOfferBasedOnProductActionReq.AfterSalesServices.ImpliedWarranty
      > {
        return new CreateOfferBasedOnProductActionReq.AfterSalesServices.ImpliedWarranty(
    ...
    static ReturnPolicy = class ReturnPolicy {
       ...
       **/
      static from(
        possibleDtoObject: CreateOfferBasedOnProductActionReqType.AfterSalesServicesType.ReturnPolicyType,
      ) {
        return new CreateOfferBasedOnProductActionReq.AfterSalesServices.ReturnPolicy(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.AfterSalesServicesType.ReturnPolicyType>,
      ) {
        return new CreateOfferBasedOnProductActionReq.AfterSalesServices.ReturnPolicy(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<CreateOfferBasedOnProductActionReqType.AfterSalesServicesType.ReturnPolicyType>,
      ): InstanceType<
        typeof CreateOfferBasedOnProductActionReq.AfterSalesServices.ReturnPolicy
      > {
        return new CreateOfferBasedOnProductActionReq.AfterSalesServices.ReturnPolicy(
    ...
    static Warranty = class Warranty {
       ...
       **/
      static from(
        possibleDtoObject: CreateOfferBasedOnProductActionReqType.AfterSalesServicesType.WarrantyType,
      ) {
        return new CreateOfferBasedOnProductActionReq.AfterSalesServices.Warranty(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.AfterSalesServicesType.WarrantyType>,
      ) {
        return new CreateOfferBasedOnProductActionReq.AfterSalesServices.Warranty(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<CreateOfferBasedOnProductActionReqType.AfterSalesServicesType.WarrantyType>,
      ): InstanceType<
        typeof CreateOfferBasedOnProductActionReq.AfterSalesServices.Warranty
      > {
        return new CreateOfferBasedOnProductActionReq.AfterSalesServices.Warranty(
      ...
      return {
        ...
        get impliedWarranty() {
          return withPrefix(
            ...
            CreateOfferBasedOnProductActionReq.AfterSalesServices
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.AfterSalesServicesType,
    ) {
      return new CreateOfferBasedOnProductActionReq.AfterSalesServices(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.AfterSalesServicesType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.AfterSalesServices(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.AfterSalesServicesType>,
    ): InstanceType<
      typeof CreateOfferBasedOnProductActionReq.AfterSalesServices
    > {
      return new CreateOfferBasedOnProductActionReq.AfterSalesServices({
  ...
  static SizeTable = class SizeTable {
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.SizeTableType,
    ) {
      return new CreateOfferBasedOnProductActionReq.SizeTable(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.SizeTableType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.SizeTable(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.SizeTableType>,
    ): InstanceType<typeof CreateOfferBasedOnProductActionReq.SizeTable> {
      return new CreateOfferBasedOnProductActionReq.SizeTable({
        ...this.toJSON(),
        ...partial,
      });
  ...
  static Contact = class Contact {
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.ContactType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.ContactType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.Contact(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.ContactType>,
    ): InstanceType<typeof CreateOfferBasedOnProductActionReq.Contact> {
      return new CreateOfferBasedOnProductActionReq.Contact({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static Discounts = class Discounts {
    ...
    #wholesalePriceList!: InstanceType<
      typeof CreateOfferBasedOnProductActionReq.Discounts.WholesalePriceList
    >;
    /**
     *
    ...
    set wholesalePriceList(
      ...
      if (
        value instanceof
        CreateOfferBasedOnProductActionReq.Discounts.WholesalePriceList
      ) {
        this.#wholesalePriceList = value;
      } else {
        this.#wholesalePriceList =
          new CreateOfferBasedOnProductActionReq.Discounts.WholesalePriceList(
            value,
          );
      }
    }
    ...
    static WholesalePriceList = class WholesalePriceList {
       ...
       **/
      static from(
        possibleDtoObject: CreateOfferBasedOnProductActionReqType.DiscountsType.WholesalePriceListType,
      ) {
        return new CreateOfferBasedOnProductActionReq.Discounts.WholesalePriceList(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.DiscountsType.WholesalePriceListType>,
      ) {
        return new CreateOfferBasedOnProductActionReq.Discounts.WholesalePriceList(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<CreateOfferBasedOnProductActionReqType.DiscountsType.WholesalePriceListType>,
      ): InstanceType<
        typeof CreateOfferBasedOnProductActionReq.Discounts.WholesalePriceList
      > {
        return new CreateOfferBasedOnProductActionReq.Discounts.WholesalePriceList(
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.DiscountsType,
    ) {
      return new CreateOfferBasedOnProductActionReq.Discounts(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.DiscountsType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.Discounts(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.DiscountsType>,
    ): InstanceType<typeof CreateOfferBasedOnProductActionReq.Discounts> {
      return new CreateOfferBasedOnProductActionReq.Discounts({
        ...this.toJSON(),
        ...partial,
      });
  ...
  static Location = class Location {
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.LocationType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.LocationType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.Location(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.LocationType>,
    ): InstanceType<typeof CreateOfferBasedOnProductActionReq.Location> {
      return new CreateOfferBasedOnProductActionReq.Location({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static External = class External {
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.ExternalType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.ExternalType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.External(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.ExternalType>,
    ): InstanceType<typeof CreateOfferBasedOnProductActionReq.External> {
      return new CreateOfferBasedOnProductActionReq.External({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static TaxSettings = class TaxSettings {
    ...
    set rates(
      ...
      if (
        value.length > 0 &&
        value[0] instanceof CreateOfferBasedOnProductActionReq.TaxSettings.Rates
      ) {
        this.#rates = value;
      } else {
        this.#rates = value.map(
          (item) =>
            new CreateOfferBasedOnProductActionReq.TaxSettings.Rates(item),
        );
      }
    }
    setRates(
    ...
    static Rates = class Rates {
       ...
       **/
      static from(
        possibleDtoObject: CreateOfferBasedOnProductActionReqType.TaxSettingsType.RatesType,
      ) {
        return new CreateOfferBasedOnProductActionReq.TaxSettings.Rates(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.TaxSettingsType.RatesType>,
      ) {
        return new CreateOfferBasedOnProductActionReq.TaxSettings.Rates(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<CreateOfferBasedOnProductActionReqType.TaxSettingsType.RatesType>,
      ): InstanceType<
        typeof CreateOfferBasedOnProductActionReq.TaxSettings.Rates
      > {
        return new CreateOfferBasedOnProductActionReq.TaxSettings.Rates({
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.TaxSettingsType,
    ) {
      return new CreateOfferBasedOnProductActionReq.TaxSettings(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.TaxSettingsType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.TaxSettings(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.TaxSettingsType>,
    ): InstanceType<typeof CreateOfferBasedOnProductActionReq.TaxSettings> {
      return new CreateOfferBasedOnProductActionReq.TaxSettings({
        ...this.toJSON(),
        ...partial,
      });
  ...
  static MessageToSellerSettings = class MessageToSellerSettings {
     ...
     **/
    static from(
      possibleDtoObject: CreateOfferBasedOnProductActionReqType.MessageToSellerSettingsType,
    ) {
      return new CreateOfferBasedOnProductActionReq.MessageToSellerSettings(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType.MessageToSellerSettingsType>,
    ) {
      return new CreateOfferBasedOnProductActionReq.MessageToSellerSettings(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<CreateOfferBasedOnProductActionReqType.MessageToSellerSettingsType>,
    ): InstanceType<
      typeof CreateOfferBasedOnProductActionReq.MessageToSellerSettings
    > {
      return new CreateOfferBasedOnProductActionReq.MessageToSellerSettings({
  ...
  #lateInitFields(data = {}) {
    const d = data as Partial<CreateOfferBasedOnProductActionReq>;
    if (!(d.category instanceof CreateOfferBasedOnProductActionReq.Category)) {
      this.category = new CreateOfferBasedOnProductActionReq.Category(
        d.category || {},
      );
    }
    if (!(d.stock instanceof CreateOfferBasedOnProductActionReq.Stock)) {
      this.stock = new CreateOfferBasedOnProductActionReq.Stock(d.stock || {});
    }
    if (
      !(d.sellingMode instanceof CreateOfferBasedOnProductActionReq.SellingMode)
    ) {
      this.sellingMode = new CreateOfferBasedOnProductActionReq.SellingMode(
        d.sellingMode || {},
      );
    }
    if (!(d.payments instanceof CreateOfferBasedOnProductActionReq.Payments)) {
      this.payments = new CreateOfferBasedOnProductActionReq.Payments(
        d.payments || {},
      );
    }
    if (!(d.delivery instanceof CreateOfferBasedOnProductActionReq.Delivery)) {
      this.delivery = new CreateOfferBasedOnProductActionReq.Delivery(
        d.delivery || {},
      );
    }
    if (
      !(d.publication instanceof CreateOfferBasedOnProductActionReq.Publication)
    ) {
      this.publication = new CreateOfferBasedOnProductActionReq.Publication(
        d.publication || {},
      );
    ...
    if (
      !(
        ...
        CreateOfferBasedOnProductActionReq.CompatibilityList
      )
    ) {
      this.compatibilityList =
        new CreateOfferBasedOnProductActionReq.CompatibilityList(
          d.compatibilityList || {},
        );
    }
    if (
      !(d.description instanceof CreateOfferBasedOnProductActionReq.Description)
    ) {
      this.description = new CreateOfferBasedOnProductActionReq.Description(
        d.description || {},
      );
    }
    if (!(d.b2b instanceof CreateOfferBasedOnProductActionReq.B2b)) {
      this.b2b = new CreateOfferBasedOnProductActionReq.B2b(d.b2b || {});
    }
    if (
      !(
        d.fundraisingCampaign instanceof
        CreateOfferBasedOnProductActionReq.FundraisingCampaign
      )
    ) {
      this.fundraisingCampaign =
        new CreateOfferBasedOnProductActionReq.FundraisingCampaign(
    ...
    if (
      !(
        ...
        CreateOfferBasedOnProductActionReq.AdditionalServices
      )
    ) {
      this.additionalServices =
        new CreateOfferBasedOnProductActionReq.AdditionalServices(
    ...
    if (
      ...
      this.afterSalesServices =
        new CreateOfferBasedOnProductActionReq.AfterSalesServices(
          d.afterSalesServices || {},
        );
    }
    if (
      !(d.sizeTable instanceof CreateOfferBasedOnProductActionReq.SizeTable)
    ) {
      this.sizeTable = new CreateOfferBasedOnProductActionReq.SizeTable(
        d.sizeTable || {},
      );
    }
    if (!(d.contact instanceof CreateOfferBasedOnProductActionReq.Contact)) {
      this.contact = new CreateOfferBasedOnProductActionReq.Contact(
        d.contact || {},
      );
    }
    if (
      !(d.discounts instanceof CreateOfferBasedOnProductActionReq.Discounts)
    ) {
      this.discounts = new CreateOfferBasedOnProductActionReq.Discounts(
        d.discounts || {},
      );
    }
    if (!(d.location instanceof CreateOfferBasedOnProductActionReq.Location)) {
      this.location = new CreateOfferBasedOnProductActionReq.Location(
        d.location || {},
      );
    }
    if (!(d.external instanceof CreateOfferBasedOnProductActionReq.External)) {
      this.external = new CreateOfferBasedOnProductActionReq.External(
        d.external || {},
      );
    }
    if (
      !(d.taxSettings instanceof CreateOfferBasedOnProductActionReq.TaxSettings)
    ) {
      this.taxSettings = new CreateOfferBasedOnProductActionReq.TaxSettings(
        d.taxSettings || {},
      );
    ...
    if (
      ...
      this.messageToSellerSettings =
        new CreateOfferBasedOnProductActionReq.MessageToSellerSettings(
  ...
  static get Fields() {
    return {
      ...
      b2b$: "b2b",
      get b2b() {
        return withPrefix("b2b", CreateOfferBasedOnProductActionReq.B2b.Fields);
      },
   ...
   **/
  static with(
    partialDtoObject: PartialDeep<CreateOfferBasedOnProductActionReqType>,
  ) {
    return new CreateOfferBasedOnProductActionReq(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<CreateOfferBasedOnProductActionReqType>,
  ): InstanceType<typeof CreateOfferBasedOnProductActionReq> {
    return new CreateOfferBasedOnProductActionReq({
      ...this.toJSON(),
      ...partial,
    });
  }
