...
export class ModificationCommandSummaryAction {
  ...
  static NewUrl = (qs?: URLSearchParams) =>
    buildUrl(ModificationCommandSummaryAction.URL, undefined, qs);
  static Method = "get";
  static Fetch$ = async (
    qs?: URLSearchParams,
    ctx?: FetchxContext,
    ...
    return fetchx<ModificationCommandSummaryActionRes, unknown, unknown>(
      overrideUrl ?? ModificationCommandSummaryAction.NewUrl(qs),
      {
  ...
  static Fetch = async (
    init?: TypedRequestInit<unknown, unknown>,
    {
      ...
      creatorFn?:
        | ((item: unknown) => ModificationCommandSummaryActionRes)
        | undefined;
      qs?: URLSearchParams;
      ctx?: FetchxContext;
...
export class ModificationCommandSummaryActionRes {
  ...
  #taskCount!: InstanceType<
    typeof ModificationCommandSummaryActionRes.TaskCount
  >;
  /**
   *
   ...
   **/
  set taskCount(
    value: InstanceType<typeof ModificationCommandSummaryActionRes.TaskCount>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof ModificationCommandSummaryActionRes.TaskCount) {
      this.#taskCount = value;
    } else {
      this.#taskCount = new ModificationCommandSummaryActionRes.TaskCount(
        value,
      );
    }
  }
  ...
  static TaskCount = class TaskCount {
     ...
     **/
    static from(
      possibleDtoObject: ModificationCommandSummaryActionResType.TaskCountType,
    ) {
      return new ModificationCommandSummaryActionRes.TaskCount(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<ModificationCommandSummaryActionResType.TaskCountType>,
    ) {
      return new ModificationCommandSummaryActionRes.TaskCount(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<ModificationCommandSummaryActionResType.TaskCountType>,
    ): InstanceType<typeof ModificationCommandSummaryActionRes.TaskCount> {
      return new ModificationCommandSummaryActionRes.TaskCount({
        ...this.toJSON(),
        ...partial,
      });
  ...
  #lateInitFields(data = {}) {
    const d = data as Partial<ModificationCommandSummaryActionRes>;
    if (
      !(d.taskCount instanceof ModificationCommandSummaryActionRes.TaskCount)
    ) {
      this.taskCount = new ModificationCommandSummaryActionRes.TaskCount(
        d.taskCount || {},
      );
   ...
   **/
  static with(
    partialDtoObject: PartialDeep<ModificationCommandSummaryActionResType>,
  ) {
    return new ModificationCommandSummaryActionRes(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<ModificationCommandSummaryActionResType>,
  ): InstanceType<typeof ModificationCommandSummaryActionRes> {
    return new ModificationCommandSummaryActionRes({
      ...this.toJSON(),
      ...partial,
    });
  }
