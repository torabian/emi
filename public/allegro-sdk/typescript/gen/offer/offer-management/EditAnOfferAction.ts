...
export class EditAnOfferAction {
  ...
  static NewUrl = (qs?: URLSearchParams) =>
    buildUrl(EditAnOfferAction.URL, undefined, qs);
  static Method = "patch";
  static Fetch$ = async (
    qs?: URLSearchParams,
    ctx?: FetchxContext,
    ...
    return fetchx<EditAnOfferActionRes, EditAnOfferActionReq, unknown>(
      overrideUrl ?? EditAnOfferAction.NewUrl(qs),
      {
  ...
  static Fetch = async (
    ...
    const res = await EditAnOfferAction.Fetch$(qs, ctx, init, overrideUrl);
  ...
  static Definition = {
    ...
    method: "patch",
    description:
      "Use this resource to edit offer. This resource allows you to edit each field independently, so use it if you want to change only, for example, the price or the quantity in an offer. Read more: PL / EN. Note that requests may be limited.",
    in: {
      fields: [
        {
          name: "name",
...
export class EditAnOfferActionReq {
   ...
   **/
  set sellingMode(
    value: InstanceType<typeof EditAnOfferActionReq.SellingMode>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
   ...
   **/
  set publication(
    value: InstanceType<typeof EditAnOfferActionReq.Publication>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
   ...
   **/
  #compatibilityList!: InstanceType<
    typeof EditAnOfferActionReq.CompatibilityList
  >;
  /**
   *
   ...
   * @type {EditAnOfferActionReq.CompatibilityList}
   **/
  set compatibilityList(
    value: InstanceType<typeof EditAnOfferActionReq.CompatibilityList>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof EditAnOfferActionReq.CompatibilityList) {
      this.#compatibilityList = value;
    } else {
      this.#compatibilityList = new EditAnOfferActionReq.CompatibilityList(
        value,
      );
    }
  }
   ...
   **/
  set description(
    value: InstanceType<typeof EditAnOfferActionReq.Description>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
   ...
   **/
  #fundraisingCampaign!: InstanceType<
    typeof EditAnOfferActionReq.FundraisingCampaign
  >;
  /**
   *
   ...
   * @type {EditAnOfferActionReq.FundraisingCampaign}
   **/
  set fundraisingCampaign(
    value: InstanceType<typeof EditAnOfferActionReq.FundraisingCampaign>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof EditAnOfferActionReq.FundraisingCampaign) {
      this.#fundraisingCampaign = value;
    } else {
      this.#fundraisingCampaign = new EditAnOfferActionReq.FundraisingCampaign(
        value,
      );
    }
  }
  setFundraisingCampaign(
    value: InstanceType<typeof EditAnOfferActionReq.FundraisingCampaign>,
  ) {
    this.fundraisingCampaign = value;
    return this;
   ...
   **/
  #additionalServices!: InstanceType<
    typeof EditAnOfferActionReq.AdditionalServices
  >;
  /**
   *
  ...
  set additionalServices(
    value: InstanceType<typeof EditAnOfferActionReq.AdditionalServices>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof EditAnOfferActionReq.AdditionalServices) {
      this.#additionalServices = value;
    } else {
      this.#additionalServices = new EditAnOfferActionReq.AdditionalServices(
        value,
      );
    }
  }
   ...
   **/
  #afterSalesServices!: InstanceType<
    typeof EditAnOfferActionReq.AfterSalesServices
  >;
  /**
   *
  ...
  set afterSalesServices(
    value: InstanceType<typeof EditAnOfferActionReq.AfterSalesServices>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof EditAnOfferActionReq.AfterSalesServices) {
      this.#afterSalesServices = value;
    } else {
      this.#afterSalesServices = new EditAnOfferActionReq.AfterSalesServices(
        value,
      );
    }
  }
   ...
   **/
  set taxSettings(
    value: InstanceType<typeof EditAnOfferActionReq.TaxSettings>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
   ...
   **/
  #messageToSellerSettings!: InstanceType<
    typeof EditAnOfferActionReq.MessageToSellerSettings
  >;
  /**
   *
   ...
   * @type {EditAnOfferActionReq.MessageToSellerSettings}
   **/
  set messageToSellerSettings(
    value: InstanceType<typeof EditAnOfferActionReq.MessageToSellerSettings>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof EditAnOfferActionReq.MessageToSellerSettings) {
      this.#messageToSellerSettings = value;
    } else {
      this.#messageToSellerSettings =
        new EditAnOfferActionReq.MessageToSellerSettings(value);
    }
  }
  setMessageToSellerSettings(
    value: InstanceType<typeof EditAnOfferActionReq.MessageToSellerSettings>,
  ) {
    this.messageToSellerSettings = value;
    return this;
  ...
  static Category = class Category {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.CategoryType>,
    ) {
      return new EditAnOfferActionReq.Category(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.CategoryType>,
    ): InstanceType<typeof EditAnOfferActionReq.Category> {
      return new EditAnOfferActionReq.Category({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static ProductSet = class ProductSet {
     ...
     **/
    set product(
      value: InstanceType<typeof EditAnOfferActionReq.ProductSet.Product>,
    ) {
      // For objects, the sub type needs to always be instance of the sub class.
     ...
     **/
    set quantity(
      value: InstanceType<typeof EditAnOfferActionReq.ProductSet.Quantity>,
    ) {
      // For objects, the sub type needs to always be instance of the sub class.
     ...
     **/
    #responsiblePerson!: InstanceType<
      typeof EditAnOfferActionReq.ProductSet.ResponsiblePerson
    >;
    /**
     *
    ...
    set responsiblePerson(
      ...
      if (value instanceof EditAnOfferActionReq.ProductSet.ResponsiblePerson) {
        ...
        this.#responsiblePerson =
          new EditAnOfferActionReq.ProductSet.ResponsiblePerson(value);
      }
    }
     ...
     **/
    #responsibleProducer!: InstanceType<
      typeof EditAnOfferActionReq.ProductSet.ResponsibleProducer
    >;
    /**
     *
    ...
    set responsibleProducer(
      ...
      // For objects, the sub type needs to always be instance of the sub class.
      if (
        value instanceof EditAnOfferActionReq.ProductSet.ResponsibleProducer
      ) {
        this.#responsibleProducer = value;
      } else {
        this.#responsibleProducer =
          new EditAnOfferActionReq.ProductSet.ResponsibleProducer(value);
      }
    }
    setResponsibleProducer(
      value: InstanceType<
        typeof EditAnOfferActionReq.ProductSet.ResponsibleProducer
      >,
    ) {
     ...
     **/
    #safetyInformation!: InstanceType<
      typeof EditAnOfferActionReq.ProductSet.SafetyInformation
    >;
    /**
     *
    ...
    set safetyInformation(
      ...
      if (value instanceof EditAnOfferActionReq.ProductSet.SafetyInformation) {
        ...
        this.#safetyInformation =
          new EditAnOfferActionReq.ProductSet.SafetyInformation(value);
      }
    }
    ...
    static Product = class Product {
      ...
      #category!: InstanceType<
        typeof EditAnOfferActionReq.ProductSet.Product.Category
      >;
      /**
       *
      ...
      set category(
        ...
        if (value instanceof EditAnOfferActionReq.ProductSet.Product.Category) {
          ...
          this.#category = new EditAnOfferActionReq.ProductSet.Product.Category(
            value,
          );
        }
      }
      ...
      static Category = class Category {
         ...
         **/
        static from(
          possibleDtoObject: EditAnOfferActionReqType.ProductSetType.ProductType.CategoryType,
        ) {
          return new EditAnOfferActionReq.ProductSet.Product.Category(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<EditAnOfferActionReqType.ProductSetType.ProductType.CategoryType>,
        ) {
          return new EditAnOfferActionReq.ProductSet.Product.Category(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<EditAnOfferActionReqType.ProductSetType.ProductType.CategoryType>,
        ): InstanceType<
          typeof EditAnOfferActionReq.ProductSet.Product.Category
        > {
          return new EditAnOfferActionReq.ProductSet.Product.Category({
      ...
      static Parameters = class Parameters {
         ...
         **/
        #rangeValue!: InstanceType<
          typeof EditAnOfferActionReq.ProductSet.Product.Parameters.RangeValue
        >;
        /**
         *
        ...
        set rangeValue(
          ...
          if (
            value instanceof
            EditAnOfferActionReq.ProductSet.Product.Parameters.RangeValue
          ) {
            this.#rangeValue = value;
          } else {
            this.#rangeValue =
              new EditAnOfferActionReq.ProductSet.Product.Parameters.RangeValue(
                value,
              );
          }
        }
        ...
        static RangeValue = class RangeValue {
           ...
           **/
          static from(
            possibleDtoObject: EditAnOfferActionReqType.ProductSetType.ProductType.ParametersType.RangeValueType,
          ) {
            return new EditAnOfferActionReq.ProductSet.Product.Parameters.RangeValue(
              possibleDtoObject,
            );
          }
          /**
           ...
           **/
          static with(
            partialDtoObject: PartialDeep<EditAnOfferActionReqType.ProductSetType.ProductType.ParametersType.RangeValueType>,
          ) {
            return new EditAnOfferActionReq.ProductSet.Product.Parameters.RangeValue(
              partialDtoObject,
            );
          ...
          copyWith(
            partial: PartialDeep<EditAnOfferActionReqType.ProductSetType.ProductType.ParametersType.RangeValueType>,
          ): InstanceType<
            typeof EditAnOfferActionReq.ProductSet.Product.Parameters.RangeValue
          > {
            return new EditAnOfferActionReq.ProductSet.Product.Parameters.RangeValue(
        ...
        applyFromObject(data = {}) {
          ...
          if (d.rangeValue !== undefined) {
            this.rangeValue = d.rangeValue;
          }
          if (d.values !== undefined) {
            this.values = d.values;
          }
          if (d.valuesIds !== undefined) {
            this.valuesIds = d.valuesIds;
          }
         ...
         **/
        static from(
          possibleDtoObject: EditAnOfferActionReqType.ProductSetType.ProductType.ParametersType,
        ) {
          return new EditAnOfferActionReq.ProductSet.Product.Parameters(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<EditAnOfferActionReqType.ProductSetType.ProductType.ParametersType>,
        ) {
          return new EditAnOfferActionReq.ProductSet.Product.Parameters(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<EditAnOfferActionReqType.ProductSetType.ProductType.ParametersType>,
        ): InstanceType<
          typeof EditAnOfferActionReq.ProductSet.Product.Parameters
        > {
          return new EditAnOfferActionReq.ProductSet.Product.Parameters({
      ...
      #lateInitFields(data = {}) {
        ...
        if (
          !(
            d.category instanceof
            EditAnOfferActionReq.ProductSet.Product.Category
          )
        ) {
          this.category = new EditAnOfferActionReq.ProductSet.Product.Category(
            d.category || {},
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionReqType.ProductSetType.ProductType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionReqType.ProductSetType.ProductType>,
      ) {
        return new EditAnOfferActionReq.ProductSet.Product(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<EditAnOfferActionReqType.ProductSetType.ProductType>,
      ): InstanceType<typeof EditAnOfferActionReq.ProductSet.Product> {
        return new EditAnOfferActionReq.ProductSet.Product({
          ...this.toJSON(),
          ...partial,
        });
      }
    ...
    static Quantity = class Quantity {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionReqType.ProductSetType.QuantityType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionReqType.ProductSetType.QuantityType>,
      ) {
        return new EditAnOfferActionReq.ProductSet.Quantity(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<EditAnOfferActionReqType.ProductSetType.QuantityType>,
      ): InstanceType<typeof EditAnOfferActionReq.ProductSet.Quantity> {
        return new EditAnOfferActionReq.ProductSet.Quantity({
          ...this.toJSON(),
          ...partial,
        });
      }
    ...
    static ResponsiblePerson = class ResponsiblePerson {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionReqType.ProductSetType.ResponsiblePersonType,
      ) {
        return new EditAnOfferActionReq.ProductSet.ResponsiblePerson(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionReqType.ProductSetType.ResponsiblePersonType>,
      ) {
        return new EditAnOfferActionReq.ProductSet.ResponsiblePerson(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionReqType.ProductSetType.ResponsiblePersonType>,
      ): InstanceType<
        typeof EditAnOfferActionReq.ProductSet.ResponsiblePerson
      > {
        return new EditAnOfferActionReq.ProductSet.ResponsiblePerson({
    ...
    static ResponsibleProducer = class ResponsibleProducer {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionReqType.ProductSetType.ResponsibleProducerType,
      ) {
        return new EditAnOfferActionReq.ProductSet.ResponsibleProducer(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionReqType.ProductSetType.ResponsibleProducerType>,
      ) {
        return new EditAnOfferActionReq.ProductSet.ResponsibleProducer(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionReqType.ProductSetType.ResponsibleProducerType>,
      ): InstanceType<
        typeof EditAnOfferActionReq.ProductSet.ResponsibleProducer
      > {
        return new EditAnOfferActionReq.ProductSet.ResponsibleProducer({
    ...
    static SafetyInformation = class SafetyInformation {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionReqType.ProductSetType.SafetyInformationType,
      ) {
        return new EditAnOfferActionReq.ProductSet.SafetyInformation(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionReqType.ProductSetType.SafetyInformationType>,
      ) {
        return new EditAnOfferActionReq.ProductSet.SafetyInformation(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionReqType.ProductSetType.SafetyInformationType>,
      ): InstanceType<
        typeof EditAnOfferActionReq.ProductSet.SafetyInformation
      > {
        return new EditAnOfferActionReq.ProductSet.SafetyInformation({
    ...
    static Deposits = class Deposits {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionReqType.ProductSetType.DepositsType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionReqType.ProductSetType.DepositsType>,
      ) {
        return new EditAnOfferActionReq.ProductSet.Deposits(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<EditAnOfferActionReqType.ProductSetType.DepositsType>,
      ): InstanceType<typeof EditAnOfferActionReq.ProductSet.Deposits> {
        return new EditAnOfferActionReq.ProductSet.Deposits({
          ...this.toJSON(),
          ...partial,
        });
      }
    ...
    applyFromObject(data = {}) {
      ...
      if (d.responsiblePerson !== undefined) {
        this.responsiblePerson = d.responsiblePerson;
      }
      if (d.responsibleProducer !== undefined) {
        this.responsibleProducer = d.responsibleProducer;
      }
      if (d.safetyInformation !== undefined) {
        this.safetyInformation = d.safetyInformation;
      }
      if (d.marketedBeforeGPSRObligation !== undefined) {
        this.marketedBeforeGPSRObligation = d.marketedBeforeGPSRObligation;
      }
      if (d.deposits !== undefined) {
    ...
    #lateInitFields(data = {}) {
      const d = data as Partial<ProductSet>;
      if (!(d.product instanceof EditAnOfferActionReq.ProductSet.Product)) {
        this.product = new EditAnOfferActionReq.ProductSet.Product(
          d.product || {},
        );
      }
      if (!(d.quantity instanceof EditAnOfferActionReq.ProductSet.Quantity)) {
        this.quantity = new EditAnOfferActionReq.ProductSet.Quantity(
          d.quantity || {},
        );
      }
      if (
        !(
          d.responsiblePerson instanceof
          EditAnOfferActionReq.ProductSet.ResponsiblePerson
        )
      ) {
        this.responsiblePerson =
          new EditAnOfferActionReq.ProductSet.ResponsiblePerson(
            d.responsiblePerson || {},
          );
      }
      if (
        !(
          d.responsibleProducer instanceof
          EditAnOfferActionReq.ProductSet.ResponsibleProducer
        )
      ) {
        this.responsibleProducer =
          new EditAnOfferActionReq.ProductSet.ResponsibleProducer(
            d.responsibleProducer || {},
          );
      }
      if (
        !(
          d.safetyInformation instanceof
          EditAnOfferActionReq.ProductSet.SafetyInformation
        )
      ) {
        this.safetyInformation =
          new EditAnOfferActionReq.ProductSet.SafetyInformation(
            d.safetyInformation || {},
          );
      }
    }
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.ProductSetType>,
    ) {
      return new EditAnOfferActionReq.ProductSet(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.ProductSetType>,
    ): InstanceType<typeof EditAnOfferActionReq.ProductSet> {
      return new EditAnOfferActionReq.ProductSet({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static Stock = class Stock {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.StockType>,
    ) {
      return new EditAnOfferActionReq.Stock(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.StockType>,
    ): InstanceType<typeof EditAnOfferActionReq.Stock> {
  ...
  static SellingMode = class SellingMode {
     ...
     **/
    set price(
      value: InstanceType<typeof EditAnOfferActionReq.SellingMode.Price>,
    ) {
      // For objects, the sub type needs to always be instance of the sub class.
     ...
     **/
    #minimalPrice!: InstanceType<
      typeof EditAnOfferActionReq.SellingMode.MinimalPrice
    >;
    /**
     *
     ...
     **/
    set minimalPrice(
      value: InstanceType<typeof EditAnOfferActionReq.SellingMode.MinimalPrice>,
    ) {
      // For objects, the sub type needs to always be instance of the sub class.
      if (value instanceof EditAnOfferActionReq.SellingMode.MinimalPrice) {
        this.#minimalPrice = value;
      } else {
        this.#minimalPrice = new EditAnOfferActionReq.SellingMode.MinimalPrice(
          value,
        );
      }
    }
     ...
     **/
    #startingPrice!: InstanceType<
      typeof EditAnOfferActionReq.SellingMode.StartingPrice
    >;
    /**
     *
    ...
    set startingPrice(
      ...
      if (value instanceof EditAnOfferActionReq.SellingMode.StartingPrice) {
        ...
        this.#startingPrice =
          new EditAnOfferActionReq.SellingMode.StartingPrice(value);
      }
    }
    setStartingPrice(
      value: InstanceType<
    ...
    static Price = class Price {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionReqType.SellingModeType.PriceType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionReqType.SellingModeType.PriceType>,
      ) {
        return new EditAnOfferActionReq.SellingMode.Price(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<EditAnOfferActionReqType.SellingModeType.PriceType>,
      ): InstanceType<typeof EditAnOfferActionReq.SellingMode.Price> {
        return new EditAnOfferActionReq.SellingMode.Price({
          ...this.toJSON(),
          ...partial,
        });
      }
    ...
    static MinimalPrice = class MinimalPrice {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionReqType.SellingModeType.MinimalPriceType,
      ) {
        return new EditAnOfferActionReq.SellingMode.MinimalPrice(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionReqType.SellingModeType.MinimalPriceType>,
      ) {
        return new EditAnOfferActionReq.SellingMode.MinimalPrice(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionReqType.SellingModeType.MinimalPriceType>,
      ): InstanceType<typeof EditAnOfferActionReq.SellingMode.MinimalPrice> {
        return new EditAnOfferActionReq.SellingMode.MinimalPrice({
          ...this.toJSON(),
          ...partial,
        });
    ...
    static StartingPrice = class StartingPrice {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionReqType.SellingModeType.StartingPriceType,
      ) {
        return new EditAnOfferActionReq.SellingMode.StartingPrice(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionReqType.SellingModeType.StartingPriceType>,
      ) {
        return new EditAnOfferActionReq.SellingMode.StartingPrice(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionReqType.SellingModeType.StartingPriceType>,
      ): InstanceType<typeof EditAnOfferActionReq.SellingMode.StartingPrice> {
        return new EditAnOfferActionReq.SellingMode.StartingPrice({
          ...this.toJSON(),
          ...partial,
        });
    ...
    applyFromObject(data = {}) {
      ...
      if (d.minimalPrice !== undefined) {
        this.minimalPrice = d.minimalPrice;
      }
      if (d.startingPrice !== undefined) {
        this.startingPrice = d.startingPrice;
      }
      this.#lateInitFields(data);
    }
    /**
    ...
    #lateInitFields(data = {}) {
      const d = data as Partial<SellingMode>;
      if (!(d.price instanceof EditAnOfferActionReq.SellingMode.Price)) {
        this.price = new EditAnOfferActionReq.SellingMode.Price(d.price || {});
      }
      if (
        !(
          d.minimalPrice instanceof
          EditAnOfferActionReq.SellingMode.MinimalPrice
        )
      ) {
        this.minimalPrice = new EditAnOfferActionReq.SellingMode.MinimalPrice(
          d.minimalPrice || {},
      ...
      if (
        !(
          d.startingPrice instanceof
          EditAnOfferActionReq.SellingMode.StartingPrice
        )
      ) {
        this.startingPrice = new EditAnOfferActionReq.SellingMode.StartingPrice(
          d.startingPrice || {},
        );
      }
    }
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.SellingModeType>,
    ) {
      return new EditAnOfferActionReq.SellingMode(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.SellingModeType>,
    ): InstanceType<typeof EditAnOfferActionReq.SellingMode> {
      return new EditAnOfferActionReq.SellingMode({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static Payments = class Payments {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.PaymentsType>,
    ) {
      return new EditAnOfferActionReq.Payments(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.PaymentsType>,
    ): InstanceType<typeof EditAnOfferActionReq.Payments> {
      return new EditAnOfferActionReq.Payments({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static Delivery = class Delivery {
     ...
     **/
    #shippingRates!: InstanceType<
      typeof EditAnOfferActionReq.Delivery.ShippingRates
    >;
    /**
     *
     ...
     **/
    set shippingRates(
      value: InstanceType<typeof EditAnOfferActionReq.Delivery.ShippingRates>,
    ) {
      // For objects, the sub type needs to always be instance of the sub class.
      if (value instanceof EditAnOfferActionReq.Delivery.ShippingRates) {
        this.#shippingRates = value;
      } else {
        this.#shippingRates = new EditAnOfferActionReq.Delivery.ShippingRates(
          value,
        );
      }
    }
    ...
    static ShippingRates = class ShippingRates {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionReqType.DeliveryType.ShippingRatesType,
      ) {
        return new EditAnOfferActionReq.Delivery.ShippingRates(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionReqType.DeliveryType.ShippingRatesType>,
      ) {
        return new EditAnOfferActionReq.Delivery.ShippingRates(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionReqType.DeliveryType.ShippingRatesType>,
      ): InstanceType<typeof EditAnOfferActionReq.Delivery.ShippingRates> {
        return new EditAnOfferActionReq.Delivery.ShippingRates({
          ...this.toJSON(),
          ...partial,
        });
    ...
    applyFromObject(data = {}) {
      ...
      if (d.handlingTime !== undefined) {
        this.handlingTime = d.handlingTime;
      }
      if (d.additionalInfo !== undefined) {
        this.additionalInfo = d.additionalInfo;
      }
      if (d.shipmentDate !== undefined) {
        this.shipmentDate = d.shipmentDate;
      }
      if (d.shippingRates !== undefined) {
        this.shippingRates = d.shippingRates;
      }
      this.#lateInitFields(data);
    }
    /**
    ...
    #lateInitFields(data = {}) {
      ...
      if (
        !(
          d.shippingRates instanceof EditAnOfferActionReq.Delivery.ShippingRates
        )
      ) {
        this.shippingRates = new EditAnOfferActionReq.Delivery.ShippingRates(
          d.shippingRates || {},
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.DeliveryType>,
    ) {
      return new EditAnOfferActionReq.Delivery(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.DeliveryType>,
    ): InstanceType<typeof EditAnOfferActionReq.Delivery> {
      return new EditAnOfferActionReq.Delivery({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static Publication = class Publication {
    ...
    applyFromObject(data = {}) {
      ...
      if (d.startingAt !== undefined) {
        this.startingAt = d.startingAt;
      }
      if (d.endingAt !== undefined) {
        this.endingAt = d.endingAt;
      }
      if (d.status !== undefined) {
        this.status = d.status;
      }
      if (d.republish !== undefined) {
        this.republish = d.republish;
      }
    }
    /**
     *	Special toJSON override, since the field are private,
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.PublicationType>,
    ) {
      return new EditAnOfferActionReq.Publication(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.PublicationType>,
    ): InstanceType<typeof EditAnOfferActionReq.Publication> {
      return new EditAnOfferActionReq.Publication({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static CompatibilityList = class CompatibilityList {
    ...
    static Items = class Items {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionReqType.CompatibilityListType.ItemsType,
      ) {
        return new EditAnOfferActionReq.CompatibilityList.Items(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionReqType.CompatibilityListType.ItemsType>,
      ) {
        return new EditAnOfferActionReq.CompatibilityList.Items(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionReqType.CompatibilityListType.ItemsType>,
     ...
     **/
    static from(
      possibleDtoObject: EditAnOfferActionReqType.CompatibilityListType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.CompatibilityListType>,
    ) {
      return new EditAnOfferActionReq.CompatibilityList(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.CompatibilityListType>,
    ): InstanceType<typeof EditAnOfferActionReq.CompatibilityList> {
      return new EditAnOfferActionReq.CompatibilityList({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static Description = class Description {
    ...
    static Sections = class Sections {
      ...
      static Items = class Items {
         ...
         **/
        static from(
          possibleDtoObject: EditAnOfferActionReqType.DescriptionType.SectionsType.ItemsType,
        ) {
          return new EditAnOfferActionReq.Description.Sections.Items(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<EditAnOfferActionReqType.DescriptionType.SectionsType.ItemsType>,
        ) {
          return new EditAnOfferActionReq.Description.Sections.Items(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<EditAnOfferActionReqType.DescriptionType.SectionsType.ItemsType>,
        ): InstanceType<
          typeof EditAnOfferActionReq.Description.Sections.Items
        > {
          return new EditAnOfferActionReq.Description.Sections.Items({
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionReqType.DescriptionType.SectionsType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionReqType.DescriptionType.SectionsType>,
      ) {
        return new EditAnOfferActionReq.Description.Sections(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<EditAnOfferActionReqType.DescriptionType.SectionsType>,
      ): InstanceType<typeof EditAnOfferActionReq.Description.Sections> {
        return new EditAnOfferActionReq.Description.Sections({
          ...this.toJSON(),
          ...partial,
        });
      }
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.DescriptionType>,
    ) {
      return new EditAnOfferActionReq.Description(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.DescriptionType>,
    ): InstanceType<typeof EditAnOfferActionReq.Description> {
      return new EditAnOfferActionReq.Description({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static B2b = class B2b {
    ...
    applyFromObject(data = {}) {
      ...
      if (d.buyableOnlyByBusiness !== undefined) {
        this.buyableOnlyByBusiness = d.buyableOnlyByBusiness;
      }
    }
    /**
     *	Special toJSON override, since the field are private,
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.B2bType>,
    ) {
      return new EditAnOfferActionReq.B2b(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.B2bType>,
    ): InstanceType<typeof EditAnOfferActionReq.B2b> {
  ...
  static Attachments = class Attachments {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.AttachmentsType>,
    ) {
      return new EditAnOfferActionReq.Attachments(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.AttachmentsType>,
    ): InstanceType<typeof EditAnOfferActionReq.Attachments> {
      return new EditAnOfferActionReq.Attachments({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static FundraisingCampaign = class FundraisingCampaign {
     ...
     **/
    static from(
      possibleDtoObject: EditAnOfferActionReqType.FundraisingCampaignType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.FundraisingCampaignType>,
    ) {
      return new EditAnOfferActionReq.FundraisingCampaign(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.FundraisingCampaignType>,
    ): InstanceType<typeof EditAnOfferActionReq.FundraisingCampaign> {
      return new EditAnOfferActionReq.FundraisingCampaign({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static AdditionalServices = class AdditionalServices {
     ...
     **/
    static from(
      possibleDtoObject: EditAnOfferActionReqType.AdditionalServicesType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.AdditionalServicesType>,
    ) {
      return new EditAnOfferActionReq.AdditionalServices(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.AdditionalServicesType>,
    ): InstanceType<typeof EditAnOfferActionReq.AdditionalServices> {
      return new EditAnOfferActionReq.AdditionalServices({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static AfterSalesServices = class AfterSalesServices {
     ...
     **/
    #impliedWarranty!: InstanceType<
      typeof EditAnOfferActionReq.AfterSalesServices.ImpliedWarranty
    >;
    /**
     *
    ...
    set impliedWarranty(
      ...
      // For objects, the sub type needs to always be instance of the sub class.
      if (
        value instanceof EditAnOfferActionReq.AfterSalesServices.ImpliedWarranty
      ) {
        this.#impliedWarranty = value;
      } else {
        this.#impliedWarranty =
          new EditAnOfferActionReq.AfterSalesServices.ImpliedWarranty(value);
      }
    }
    setImpliedWarranty(
      value: InstanceType<
     ...
     **/
    #returnPolicy!: InstanceType<
      typeof EditAnOfferActionReq.AfterSalesServices.ReturnPolicy
    >;
    /**
     *
    ...
    set returnPolicy(
      ...
      // For objects, the sub type needs to always be instance of the sub class.
      if (
        value instanceof EditAnOfferActionReq.AfterSalesServices.ReturnPolicy
      ) {
        this.#returnPolicy = value;
      } else {
        this.#returnPolicy =
          new EditAnOfferActionReq.AfterSalesServices.ReturnPolicy(value);
      }
    }
    setReturnPolicy(
      value: InstanceType<
     ...
     **/
    #warranty!: InstanceType<
      typeof EditAnOfferActionReq.AfterSalesServices.Warranty
    >;
    /**
     *
    ...
    set warranty(
      ...
      if (value instanceof EditAnOfferActionReq.AfterSalesServices.Warranty) {
        ...
        this.#warranty = new EditAnOfferActionReq.AfterSalesServices.Warranty(
          value,
        );
      }
    }
    ...
    static ImpliedWarranty = class ImpliedWarranty {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionReqType.AfterSalesServicesType.ImpliedWarrantyType,
      ) {
        return new EditAnOfferActionReq.AfterSalesServices.ImpliedWarranty(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionReqType.AfterSalesServicesType.ImpliedWarrantyType>,
      ) {
        return new EditAnOfferActionReq.AfterSalesServices.ImpliedWarranty(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionReqType.AfterSalesServicesType.ImpliedWarrantyType>,
      ): InstanceType<
        typeof EditAnOfferActionReq.AfterSalesServices.ImpliedWarranty
      > {
        return new EditAnOfferActionReq.AfterSalesServices.ImpliedWarranty({
    ...
    static ReturnPolicy = class ReturnPolicy {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionReqType.AfterSalesServicesType.ReturnPolicyType,
      ) {
        return new EditAnOfferActionReq.AfterSalesServices.ReturnPolicy(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionReqType.AfterSalesServicesType.ReturnPolicyType>,
      ) {
        return new EditAnOfferActionReq.AfterSalesServices.ReturnPolicy(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionReqType.AfterSalesServicesType.ReturnPolicyType>,
      ): InstanceType<
        typeof EditAnOfferActionReq.AfterSalesServices.ReturnPolicy
      > {
        return new EditAnOfferActionReq.AfterSalesServices.ReturnPolicy({
    ...
    static Warranty = class Warranty {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionReqType.AfterSalesServicesType.WarrantyType,
      ) {
        return new EditAnOfferActionReq.AfterSalesServices.Warranty(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionReqType.AfterSalesServicesType.WarrantyType>,
      ) {
        return new EditAnOfferActionReq.AfterSalesServices.Warranty(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionReqType.AfterSalesServicesType.WarrantyType>,
      ): InstanceType<typeof EditAnOfferActionReq.AfterSalesServices.Warranty> {
        return new EditAnOfferActionReq.AfterSalesServices.Warranty({
          ...this.toJSON(),
          ...partial,
        });
    ...
    applyFromObject(data = {}) {
      ...
      if (d.impliedWarranty !== undefined) {
        this.impliedWarranty = d.impliedWarranty;
      }
      if (d.returnPolicy !== undefined) {
        this.returnPolicy = d.returnPolicy;
      }
      if (d.warranty !== undefined) {
        this.warranty = d.warranty;
      }
      this.#lateInitFields(data);
    }
    /**
    ...
    #lateInitFields(data = {}) {
      ...
      if (
        !(
          d.impliedWarranty instanceof
          EditAnOfferActionReq.AfterSalesServices.ImpliedWarranty
        )
      ) {
        this.impliedWarranty =
          new EditAnOfferActionReq.AfterSalesServices.ImpliedWarranty(
            d.impliedWarranty || {},
          );
      }
      if (
        !(
          d.returnPolicy instanceof
          EditAnOfferActionReq.AfterSalesServices.ReturnPolicy
        )
      ) {
        this.returnPolicy =
          new EditAnOfferActionReq.AfterSalesServices.ReturnPolicy(
            d.returnPolicy || {},
          );
      }
      if (
        !(
          d.warranty instanceof EditAnOfferActionReq.AfterSalesServices.Warranty
        )
      ) {
        this.warranty = new EditAnOfferActionReq.AfterSalesServices.Warranty(
          d.warranty || {},
     ...
     **/
    static from(
      possibleDtoObject: EditAnOfferActionReqType.AfterSalesServicesType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.AfterSalesServicesType>,
    ) {
      return new EditAnOfferActionReq.AfterSalesServices(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.AfterSalesServicesType>,
    ): InstanceType<typeof EditAnOfferActionReq.AfterSalesServices> {
      return new EditAnOfferActionReq.AfterSalesServices({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static SizeTable = class SizeTable {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.SizeTableType>,
    ) {
      return new EditAnOfferActionReq.SizeTable(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.SizeTableType>,
    ): InstanceType<typeof EditAnOfferActionReq.SizeTable> {
      return new EditAnOfferActionReq.SizeTable({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static Contact = class Contact {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.ContactType>,
    ) {
      return new EditAnOfferActionReq.Contact(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.ContactType>,
    ): InstanceType<typeof EditAnOfferActionReq.Contact> {
  ...
  static Discounts = class Discounts {
     ...
     **/
    #wholesalePriceList!: InstanceType<
      typeof EditAnOfferActionReq.Discounts.WholesalePriceList
    >;
    /**
     *
    ...
    set wholesalePriceList(
      ...
      if (value instanceof EditAnOfferActionReq.Discounts.WholesalePriceList) {
        ...
        this.#wholesalePriceList =
          new EditAnOfferActionReq.Discounts.WholesalePriceList(value);
      }
    }
    setWholesalePriceList(
      value: InstanceType<
        typeof EditAnOfferActionReq.Discounts.WholesalePriceList
      >,
    ) {
    ...
    static WholesalePriceList = class WholesalePriceList {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionReqType.DiscountsType.WholesalePriceListType,
      ) {
        return new EditAnOfferActionReq.Discounts.WholesalePriceList(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionReqType.DiscountsType.WholesalePriceListType>,
      ) {
        return new EditAnOfferActionReq.Discounts.WholesalePriceList(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionReqType.DiscountsType.WholesalePriceListType>,
      ): InstanceType<
        typeof EditAnOfferActionReq.Discounts.WholesalePriceList
      > {
        return new EditAnOfferActionReq.Discounts.WholesalePriceList({
    ...
    applyFromObject(data = {}) {
      ...
      if (d.wholesalePriceList !== undefined) {
        this.wholesalePriceList = d.wholesalePriceList;
      }
      this.#lateInitFields(data);
    }
    /**
    ...
    #lateInitFields(data = {}) {
      ...
      if (
        !(
          d.wholesalePriceList instanceof
          EditAnOfferActionReq.Discounts.WholesalePriceList
        )
      ) {
        this.wholesalePriceList =
          new EditAnOfferActionReq.Discounts.WholesalePriceList(
            d.wholesalePriceList || {},
          );
      }
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.DiscountsType>,
    ) {
      return new EditAnOfferActionReq.Discounts(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.DiscountsType>,
    ): InstanceType<typeof EditAnOfferActionReq.Discounts> {
      return new EditAnOfferActionReq.Discounts({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static Location = class Location {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.LocationType>,
    ) {
      return new EditAnOfferActionReq.Location(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.LocationType>,
    ): InstanceType<typeof EditAnOfferActionReq.Location> {
      return new EditAnOfferActionReq.Location({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static External = class External {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.ExternalType>,
    ) {
      return new EditAnOfferActionReq.External(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.ExternalType>,
    ): InstanceType<typeof EditAnOfferActionReq.External> {
      return new EditAnOfferActionReq.External({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static TaxSettings = class TaxSettings {
    ...
    static Rates = class Rates {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionReqType.TaxSettingsType.RatesType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionReqType.TaxSettingsType.RatesType>,
      ) {
        return new EditAnOfferActionReq.TaxSettings.Rates(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<EditAnOfferActionReqType.TaxSettingsType.RatesType>,
      ): InstanceType<typeof EditAnOfferActionReq.TaxSettings.Rates> {
        return new EditAnOfferActionReq.TaxSettings.Rates({
          ...this.toJSON(),
          ...partial,
        });
      }
    ...
    applyFromObject(data = {}) {
      ...
      if (d.exemption !== undefined) {
        this.exemption = d.exemption;
      }
      if (d.rates !== undefined) {
        this.rates = d.rates;
      }
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.TaxSettingsType>,
    ) {
      return new EditAnOfferActionReq.TaxSettings(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.TaxSettingsType>,
    ): InstanceType<typeof EditAnOfferActionReq.TaxSettings> {
      return new EditAnOfferActionReq.TaxSettings({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static MessageToSellerSettings = class MessageToSellerSettings {
     ...
     **/
    static from(
      possibleDtoObject: EditAnOfferActionReqType.MessageToSellerSettingsType,
    ) {
      return new EditAnOfferActionReq.MessageToSellerSettings(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionReqType.MessageToSellerSettingsType>,
    ) {
      return new EditAnOfferActionReq.MessageToSellerSettings(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionReqType.MessageToSellerSettingsType>,
    ): InstanceType<typeof EditAnOfferActionReq.MessageToSellerSettings> {
      return new EditAnOfferActionReq.MessageToSellerSettings({
        ...this.toJSON(),
        ...partial,
      });
  ...
  applyFromObject(data = {}) {
    ...
    if (d.productSet !== undefined) {
      this.productSet = d.productSet;
    }
    if (d.stock !== undefined) {
      this.stock = d.stock;
    }
    if (d.sellingMode !== undefined) {
      this.sellingMode = d.sellingMode;
    }
    ...
    if (d.compatibilityList !== undefined) {
      this.compatibilityList = d.compatibilityList;
    }
    if (d.images !== undefined) {
      this.images = d.images;
    }
    ...
    if (d.fundraisingCampaign !== undefined) {
      this.fundraisingCampaign = d.fundraisingCampaign;
    }
    if (d.additionalServices !== undefined) {
      this.additionalServices = d.additionalServices;
    }
    if (d.afterSalesServices !== undefined) {
      this.afterSalesServices = d.afterSalesServices;
    }
    if (d.sizeTable !== undefined) {
      this.sizeTable = d.sizeTable;
    }
    ...
    if (d.taxSettings !== undefined) {
      this.taxSettings = d.taxSettings;
    }
    if (d.messageToSellerSettings !== undefined) {
      this.messageToSellerSettings = d.messageToSellerSettings;
    }
    this.#lateInitFields(data);
  }
  /**
  ...
  #lateInitFields(data = {}) {
    const d = data as Partial<EditAnOfferActionReq>;
    if (!(d.category instanceof EditAnOfferActionReq.Category)) {
      this.category = new EditAnOfferActionReq.Category(d.category || {});
    }
    if (!(d.stock instanceof EditAnOfferActionReq.Stock)) {
      this.stock = new EditAnOfferActionReq.Stock(d.stock || {});
    }
    if (!(d.sellingMode instanceof EditAnOfferActionReq.SellingMode)) {
      this.sellingMode = new EditAnOfferActionReq.SellingMode(
        d.sellingMode || {},
      );
    }
    if (!(d.payments instanceof EditAnOfferActionReq.Payments)) {
      this.payments = new EditAnOfferActionReq.Payments(d.payments || {});
    }
    if (!(d.delivery instanceof EditAnOfferActionReq.Delivery)) {
      this.delivery = new EditAnOfferActionReq.Delivery(d.delivery || {});
    }
    if (!(d.publication instanceof EditAnOfferActionReq.Publication)) {
      this.publication = new EditAnOfferActionReq.Publication(
        d.publication || {},
      );
    }
    if (
      !(d.compatibilityList instanceof EditAnOfferActionReq.CompatibilityList)
    ) {
      this.compatibilityList = new EditAnOfferActionReq.CompatibilityList(
        d.compatibilityList || {},
      );
    }
    if (!(d.description instanceof EditAnOfferActionReq.Description)) {
      this.description = new EditAnOfferActionReq.Description(
        d.description || {},
      );
    }
    if (!(d.b2b instanceof EditAnOfferActionReq.B2b)) {
      this.b2b = new EditAnOfferActionReq.B2b(d.b2b || {});
    }
    if (
      !(
        d.fundraisingCampaign instanceof
        EditAnOfferActionReq.FundraisingCampaign
      )
    ) {
      this.fundraisingCampaign = new EditAnOfferActionReq.FundraisingCampaign(
        d.fundraisingCampaign || {},
      );
    }
    if (
      !(d.additionalServices instanceof EditAnOfferActionReq.AdditionalServices)
    ) {
      this.additionalServices = new EditAnOfferActionReq.AdditionalServices(
    ...
    if (
      !(d.afterSalesServices instanceof EditAnOfferActionReq.AfterSalesServices)
    ) {
      this.afterSalesServices = new EditAnOfferActionReq.AfterSalesServices(
        d.afterSalesServices || {},
      );
    }
    if (!(d.sizeTable instanceof EditAnOfferActionReq.SizeTable)) {
      this.sizeTable = new EditAnOfferActionReq.SizeTable(d.sizeTable || {});
    }
    if (!(d.contact instanceof EditAnOfferActionReq.Contact)) {
      this.contact = new EditAnOfferActionReq.Contact(d.contact || {});
    }
    if (!(d.discounts instanceof EditAnOfferActionReq.Discounts)) {
      this.discounts = new EditAnOfferActionReq.Discounts(d.discounts || {});
    }
    if (!(d.location instanceof EditAnOfferActionReq.Location)) {
      this.location = new EditAnOfferActionReq.Location(d.location || {});
    }
    if (!(d.external instanceof EditAnOfferActionReq.External)) {
      this.external = new EditAnOfferActionReq.External(d.external || {});
    }
    if (!(d.taxSettings instanceof EditAnOfferActionReq.TaxSettings)) {
      this.taxSettings = new EditAnOfferActionReq.TaxSettings(
        d.taxSettings || {},
      );
    }
    if (
      !(
        d.messageToSellerSettings instanceof
        EditAnOfferActionReq.MessageToSellerSettings
      )
    ) {
      this.messageToSellerSettings =
        new EditAnOfferActionReq.MessageToSellerSettings(
          d.messageToSellerSettings || {},
        );
    }
  }
  /**
  ...
  static get Fields() {
    return {
      ...
      category$: "category",
      get category() {
        return withPrefix("category", EditAnOfferActionReq.Category.Fields);
      },
      ...
      stock$: "stock",
      get stock() {
        return withPrefix("stock", EditAnOfferActionReq.Stock.Fields);
      },
      ...
      payments$: "payments",
      get payments() {
        return withPrefix("payments", EditAnOfferActionReq.Payments.Fields);
      },
      delivery$: "delivery",
      get delivery() {
        return withPrefix("delivery", EditAnOfferActionReq.Delivery.Fields);
      },
      ...
      b2b$: "b2b",
      get b2b() {
        return withPrefix("b2b", EditAnOfferActionReq.B2b.Fields);
      },
      ...
      sizeTable$: "sizeTable",
      get sizeTable() {
        return withPrefix("sizeTable", EditAnOfferActionReq.SizeTable.Fields);
      },
      contact$: "contact",
      get contact() {
        return withPrefix("contact", EditAnOfferActionReq.Contact.Fields);
      },
      discounts$: "discounts",
      get discounts() {
        return withPrefix("discounts", EditAnOfferActionReq.Discounts.Fields);
      },
      location$: "location",
      get location() {
        return withPrefix("location", EditAnOfferActionReq.Location.Fields);
      },
      external$: "external",
      get external() {
        return withPrefix("external", EditAnOfferActionReq.External.Fields);
      },
  ...
  copyWith(
    partial: PartialDeep<EditAnOfferActionReqType>,
  ): InstanceType<typeof EditAnOfferActionReq> {
...
export class EditAnOfferActionRes {
   ...
   **/
  set sellingMode(
    value: InstanceType<typeof EditAnOfferActionRes.SellingMode>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
   ...
   **/
  set publication(
    value: InstanceType<typeof EditAnOfferActionRes.Publication>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
  ...
  #additionalMarketplaces!: InstanceType<
    typeof EditAnOfferActionRes.AdditionalMarketplaces
  >;
  /**
   *
  ...
  set additionalMarketplaces(
    value: InstanceType<typeof EditAnOfferActionRes.AdditionalMarketplaces>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof EditAnOfferActionRes.AdditionalMarketplaces) {
      this.#additionalMarketplaces = value;
    } else {
      this.#additionalMarketplaces =
        new EditAnOfferActionRes.AdditionalMarketplaces(value);
    }
  }
   ...
   **/
  #compatibilityList!: InstanceType<
    typeof EditAnOfferActionRes.CompatibilityList
  >;
  /**
   *
   ...
   **/
  set compatibilityList(
    value: InstanceType<typeof EditAnOfferActionRes.CompatibilityList>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof EditAnOfferActionRes.CompatibilityList) {
      this.#compatibilityList = value;
    } else {
      this.#compatibilityList = new EditAnOfferActionRes.CompatibilityList(
        value,
      );
    }
  }
   ...
   **/
  #afterSalesServices!: InstanceType<
    typeof EditAnOfferActionRes.AfterSalesServices
  >;
  /**
   *
   ...
   **/
  set afterSalesServices(
    value: InstanceType<typeof EditAnOfferActionRes.AfterSalesServices>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof EditAnOfferActionRes.AfterSalesServices) {
      this.#afterSalesServices = value;
    } else {
      this.#afterSalesServices = new EditAnOfferActionRes.AfterSalesServices(
        value,
      );
    }
  }
   ...
   **/
  #fundraisingCampaign!: InstanceType<
    typeof EditAnOfferActionRes.FundraisingCampaign
  >;
  /**
   *
   ...
   **/
  set fundraisingCampaign(
    value: InstanceType<typeof EditAnOfferActionRes.FundraisingCampaign>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof EditAnOfferActionRes.FundraisingCampaign) {
      this.#fundraisingCampaign = value;
    } else {
      this.#fundraisingCampaign = new EditAnOfferActionRes.FundraisingCampaign(
        value,
      );
    }
  }
   ...
   **/
  #additionalServices!: InstanceType<
    typeof EditAnOfferActionRes.AdditionalServices
  >;
  /**
   *
   ...
   **/
  set additionalServices(
    value: InstanceType<typeof EditAnOfferActionRes.AdditionalServices>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof EditAnOfferActionRes.AdditionalServices) {
      this.#additionalServices = value;
    } else {
      this.#additionalServices = new EditAnOfferActionRes.AdditionalServices(
        value,
      );
    }
  }
   ...
   **/
  set taxSettings(
    value: InstanceType<typeof EditAnOfferActionRes.TaxSettings>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
   ...
   **/
  #messageToSellerSettings!: InstanceType<
    typeof EditAnOfferActionRes.MessageToSellerSettings
  >;
  /**
   *
   ...
   **/
  set messageToSellerSettings(
    value: InstanceType<typeof EditAnOfferActionRes.MessageToSellerSettings>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof EditAnOfferActionRes.MessageToSellerSettings) {
      ...
      this.#messageToSellerSettings =
        new EditAnOfferActionRes.MessageToSellerSettings(value);
    }
  }
  setMessageToSellerSettings(
    value: InstanceType<typeof EditAnOfferActionRes.MessageToSellerSettings>,
   ...
   **/
  set description(
    value: InstanceType<typeof EditAnOfferActionRes.Description>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
  ...
  static Category = class Category {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.CategoryType>,
    ) {
      return new EditAnOfferActionRes.Category(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.CategoryType>,
    ): InstanceType<typeof EditAnOfferActionRes.Category> {
      return new EditAnOfferActionRes.Category({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static ProductSet = class ProductSet {
     ...
     **/
    set quantity(
      value: InstanceType<typeof EditAnOfferActionRes.ProductSet.Quantity>,
    ) {
      // For objects, the sub type needs to always be instance of the sub class.
     ...
     **/
    set product(
      value: InstanceType<typeof EditAnOfferActionRes.ProductSet.Product>,
    ) {
      // For objects, the sub type needs to always be instance of the sub class.
     ...
     **/
    #responsiblePerson!: InstanceType<
      typeof EditAnOfferActionRes.ProductSet.ResponsiblePerson
    >;
    /**
     *
    ...
    set responsiblePerson(
      ...
      if (value instanceof EditAnOfferActionRes.ProductSet.ResponsiblePerson) {
        ...
        this.#responsiblePerson =
          new EditAnOfferActionRes.ProductSet.ResponsiblePerson(value);
      }
    }
    setResponsiblePerson(
      value: InstanceType<
     ...
     **/
    #responsibleProducer!: InstanceType<
      typeof EditAnOfferActionRes.ProductSet.ResponsibleProducer
    >;
    /**
     *
    ...
    set responsibleProducer(
      ...
      // For objects, the sub type needs to always be instance of the sub class.
      if (
        value instanceof EditAnOfferActionRes.ProductSet.ResponsibleProducer
      ) {
        this.#responsibleProducer = value;
      } else {
        this.#responsibleProducer =
          new EditAnOfferActionRes.ProductSet.ResponsibleProducer(value);
      }
    }
    setResponsibleProducer(
      value: InstanceType<
     ...
     **/
    #safetyInformation!: InstanceType<
      typeof EditAnOfferActionRes.ProductSet.SafetyInformation
    >;
    /**
     *
    ...
    set safetyInformation(
      ...
      if (value instanceof EditAnOfferActionRes.ProductSet.SafetyInformation) {
        ...
        this.#safetyInformation =
          new EditAnOfferActionRes.ProductSet.SafetyInformation(value);
      }
    }
    setSafetyInformation(
      value: InstanceType<
    ...
    static Quantity = class Quantity {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.ProductSetType.QuantityType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.ProductSetType.QuantityType>,
      ) {
        return new EditAnOfferActionRes.ProductSet.Quantity(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.ProductSetType.QuantityType>,
      ): InstanceType<typeof EditAnOfferActionRes.ProductSet.Quantity> {
        return new EditAnOfferActionRes.ProductSet.Quantity({
          ...this.toJSON(),
          ...partial,
        });
      }
    ...
    static Product = class Product {
       ...
       **/
      #publication!: InstanceType<
        typeof EditAnOfferActionRes.ProductSet.Product.Publication
      >;
      /**
       *
      ...
      set publication(
        ...
        // For objects, the sub type needs to always be instance of the sub class.
        if (
          value instanceof EditAnOfferActionRes.ProductSet.Product.Publication
        ) {
          this.#publication = value;
        } else {
          this.#publication =
            new EditAnOfferActionRes.ProductSet.Product.Publication(value);
        }
      }
      setPublication(
        value: InstanceType<
      ...
      static Publication = class Publication {
         ...
         **/
        static from(
          possibleDtoObject: EditAnOfferActionResType.ProductSetType.ProductType.PublicationType,
        ) {
          return new EditAnOfferActionRes.ProductSet.Product.Publication(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<EditAnOfferActionResType.ProductSetType.ProductType.PublicationType>,
        ) {
          return new EditAnOfferActionRes.ProductSet.Product.Publication(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<EditAnOfferActionResType.ProductSetType.ProductType.PublicationType>,
        ): InstanceType<
          typeof EditAnOfferActionRes.ProductSet.Product.Publication
        > {
          return new EditAnOfferActionRes.ProductSet.Product.Publication({
      ...
      static Parameters = class Parameters {
         ...
         **/
        #rangeValue!: InstanceType<
          typeof EditAnOfferActionRes.ProductSet.Product.Parameters.RangeValue
        >;
        /**
         *
        ...
        set rangeValue(
          ...
          if (
            value instanceof
            EditAnOfferActionRes.ProductSet.Product.Parameters.RangeValue
          ) {
            this.#rangeValue = value;
          } else {
            this.#rangeValue =
              new EditAnOfferActionRes.ProductSet.Product.Parameters.RangeValue(
                value,
              );
          }
        }
        ...
        static RangeValue = class RangeValue {
           ...
           **/
          static from(
            possibleDtoObject: EditAnOfferActionResType.ProductSetType.ProductType.ParametersType.RangeValueType,
          ) {
            return new EditAnOfferActionRes.ProductSet.Product.Parameters.RangeValue(
              possibleDtoObject,
            );
          }
          /**
           ...
           **/
          static with(
            partialDtoObject: PartialDeep<EditAnOfferActionResType.ProductSetType.ProductType.ParametersType.RangeValueType>,
          ) {
            return new EditAnOfferActionRes.ProductSet.Product.Parameters.RangeValue(
              partialDtoObject,
            );
          ...
          copyWith(
            partial: PartialDeep<EditAnOfferActionResType.ProductSetType.ProductType.ParametersType.RangeValueType>,
          ): InstanceType<
            typeof EditAnOfferActionRes.ProductSet.Product.Parameters.RangeValue
          > {
            return new EditAnOfferActionRes.ProductSet.Product.Parameters.RangeValue(
         ...
         **/
        static from(
          possibleDtoObject: EditAnOfferActionResType.ProductSetType.ProductType.ParametersType,
        ) {
          return new EditAnOfferActionRes.ProductSet.Product.Parameters(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<EditAnOfferActionResType.ProductSetType.ProductType.ParametersType>,
        ) {
          return new EditAnOfferActionRes.ProductSet.Product.Parameters(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<EditAnOfferActionResType.ProductSetType.ProductType.ParametersType>,
        ): InstanceType<
          typeof EditAnOfferActionRes.ProductSet.Product.Parameters
        > {
          return new EditAnOfferActionRes.ProductSet.Product.Parameters({
      ...
      applyFromObject(data = {}) {
        ...
        if (d.isAiCoCreated !== undefined) {
          this.isAiCoCreated = d.isAiCoCreated;
        }
        if (d.publication !== undefined) {
          this.publication = d.publication;
        }
      ...
      #lateInitFields(data = {}) {
        ...
        if (
          !(
            d.publication instanceof
            EditAnOfferActionRes.ProductSet.Product.Publication
          )
        ) {
          this.publication =
            new EditAnOfferActionRes.ProductSet.Product.Publication(
              d.publication || {},
            );
        }
      }
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.ProductSetType.ProductType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.ProductSetType.ProductType>,
      ) {
        return new EditAnOfferActionRes.ProductSet.Product(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.ProductSetType.ProductType>,
      ): InstanceType<typeof EditAnOfferActionRes.ProductSet.Product> {
        return new EditAnOfferActionRes.ProductSet.Product({
          ...this.toJSON(),
          ...partial,
        });
      }
    ...
    static ResponsiblePerson = class ResponsiblePerson {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.ProductSetType.ResponsiblePersonType,
      ) {
        return new EditAnOfferActionRes.ProductSet.ResponsiblePerson(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.ProductSetType.ResponsiblePersonType>,
      ) {
        return new EditAnOfferActionRes.ProductSet.ResponsiblePerson(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.ProductSetType.ResponsiblePersonType>,
      ): InstanceType<
        typeof EditAnOfferActionRes.ProductSet.ResponsiblePerson
      > {
        return new EditAnOfferActionRes.ProductSet.ResponsiblePerson({
    ...
    static ResponsibleProducer = class ResponsibleProducer {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.ProductSetType.ResponsibleProducerType,
      ) {
        return new EditAnOfferActionRes.ProductSet.ResponsibleProducer(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.ProductSetType.ResponsibleProducerType>,
      ) {
        return new EditAnOfferActionRes.ProductSet.ResponsibleProducer(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.ProductSetType.ResponsibleProducerType>,
      ): InstanceType<
        typeof EditAnOfferActionRes.ProductSet.ResponsibleProducer
      > {
        return new EditAnOfferActionRes.ProductSet.ResponsibleProducer({
    ...
    static SafetyInformation = class SafetyInformation {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.ProductSetType.SafetyInformationType,
      ) {
        return new EditAnOfferActionRes.ProductSet.SafetyInformation(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.ProductSetType.SafetyInformationType>,
      ) {
        return new EditAnOfferActionRes.ProductSet.SafetyInformation(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.ProductSetType.SafetyInformationType>,
      ): InstanceType<
        typeof EditAnOfferActionRes.ProductSet.SafetyInformation
      > {
        return new EditAnOfferActionRes.ProductSet.SafetyInformation({
    ...
    static Deposits = class Deposits {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.ProductSetType.DepositsType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.ProductSetType.DepositsType>,
      ) {
        return new EditAnOfferActionRes.ProductSet.Deposits(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.ProductSetType.DepositsType>,
      ): InstanceType<typeof EditAnOfferActionRes.ProductSet.Deposits> {
        return new EditAnOfferActionRes.ProductSet.Deposits({
          ...this.toJSON(),
          ...partial,
        });
      }
    ...
    #lateInitFields(data = {}) {
      const d = data as Partial<ProductSet>;
      if (!(d.quantity instanceof EditAnOfferActionRes.ProductSet.Quantity)) {
        this.quantity = new EditAnOfferActionRes.ProductSet.Quantity(
          d.quantity || {},
        );
      }
      if (!(d.product instanceof EditAnOfferActionRes.ProductSet.Product)) {
        this.product = new EditAnOfferActionRes.ProductSet.Product(
          d.product || {},
        );
      }
      if (
        !(
          d.responsiblePerson instanceof
          EditAnOfferActionRes.ProductSet.ResponsiblePerson
        )
      ) {
        this.responsiblePerson =
          new EditAnOfferActionRes.ProductSet.ResponsiblePerson(
            d.responsiblePerson || {},
          );
      }
      if (
        !(
          d.responsibleProducer instanceof
          EditAnOfferActionRes.ProductSet.ResponsibleProducer
        )
      ) {
        this.responsibleProducer =
          new EditAnOfferActionRes.ProductSet.ResponsibleProducer(
            d.responsibleProducer || {},
          );
      }
      if (
        !(
          d.safetyInformation instanceof
          EditAnOfferActionRes.ProductSet.SafetyInformation
        )
      ) {
        this.safetyInformation =
          new EditAnOfferActionRes.ProductSet.SafetyInformation(
            d.safetyInformation || {},
          );
      }
    }
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.ProductSetType>,
    ) {
      return new EditAnOfferActionRes.ProductSet(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.ProductSetType>,
    ): InstanceType<typeof EditAnOfferActionRes.ProductSet> {
      return new EditAnOfferActionRes.ProductSet({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static Stock = class Stock {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.StockType>,
    ) {
      return new EditAnOfferActionRes.Stock(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.StockType>,
    ): InstanceType<typeof EditAnOfferActionRes.Stock> {
  ...
  static Payments = class Payments {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.PaymentsType>,
    ) {
      return new EditAnOfferActionRes.Payments(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.PaymentsType>,
    ): InstanceType<typeof EditAnOfferActionRes.Payments> {
      return new EditAnOfferActionRes.Payments({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static SellingMode = class SellingMode {
     ...
     **/
    set price(
      value: InstanceType<typeof EditAnOfferActionRes.SellingMode.Price>,
    ) {
      // For objects, the sub type needs to always be instance of the sub class.
     ...
     **/
    #minimalPrice!: InstanceType<
      typeof EditAnOfferActionRes.SellingMode.MinimalPrice
    >;
    /**
     *
     ...
     **/
    set minimalPrice(
      value: InstanceType<typeof EditAnOfferActionRes.SellingMode.MinimalPrice>,
    ) {
      // For objects, the sub type needs to always be instance of the sub class.
      if (value instanceof EditAnOfferActionRes.SellingMode.MinimalPrice) {
        this.#minimalPrice = value;
      } else {
        this.#minimalPrice = new EditAnOfferActionRes.SellingMode.MinimalPrice(
          value,
        );
      }
    }
     ...
     **/
    #startingPrice!: InstanceType<
      typeof EditAnOfferActionRes.SellingMode.StartingPrice
    >;
    /**
     *
    ...
    set startingPrice(
      ...
      if (value instanceof EditAnOfferActionRes.SellingMode.StartingPrice) {
        ...
        this.#startingPrice =
          new EditAnOfferActionRes.SellingMode.StartingPrice(value);
      }
    }
    setStartingPrice(
      value: InstanceType<
    ...
    static Price = class Price {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.SellingModeType.PriceType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.SellingModeType.PriceType>,
      ) {
        return new EditAnOfferActionRes.SellingMode.Price(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.SellingModeType.PriceType>,
      ): InstanceType<typeof EditAnOfferActionRes.SellingMode.Price> {
        return new EditAnOfferActionRes.SellingMode.Price({
          ...this.toJSON(),
          ...partial,
        });
      }
    ...
    static MinimalPrice = class MinimalPrice {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.SellingModeType.MinimalPriceType,
      ) {
        return new EditAnOfferActionRes.SellingMode.MinimalPrice(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.SellingModeType.MinimalPriceType>,
      ) {
        return new EditAnOfferActionRes.SellingMode.MinimalPrice(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.SellingModeType.MinimalPriceType>,
      ): InstanceType<typeof EditAnOfferActionRes.SellingMode.MinimalPrice> {
        return new EditAnOfferActionRes.SellingMode.MinimalPrice({
          ...this.toJSON(),
          ...partial,
        });
    ...
    static StartingPrice = class StartingPrice {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.SellingModeType.StartingPriceType,
      ) {
        return new EditAnOfferActionRes.SellingMode.StartingPrice(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.SellingModeType.StartingPriceType>,
      ) {
        return new EditAnOfferActionRes.SellingMode.StartingPrice(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.SellingModeType.StartingPriceType>,
      ): InstanceType<typeof EditAnOfferActionRes.SellingMode.StartingPrice> {
        return new EditAnOfferActionRes.SellingMode.StartingPrice({
          ...this.toJSON(),
          ...partial,
        });
    ...
    #lateInitFields(data = {}) {
      const d = data as Partial<SellingMode>;
      if (!(d.price instanceof EditAnOfferActionRes.SellingMode.Price)) {
        this.price = new EditAnOfferActionRes.SellingMode.Price(d.price || {});
      }
      if (
        !(
          d.minimalPrice instanceof
          EditAnOfferActionRes.SellingMode.MinimalPrice
        )
      ) {
        this.minimalPrice = new EditAnOfferActionRes.SellingMode.MinimalPrice(
          d.minimalPrice || {},
      ...
      if (
        !(
          d.startingPrice instanceof
          EditAnOfferActionRes.SellingMode.StartingPrice
        )
      ) {
        this.startingPrice = new EditAnOfferActionRes.SellingMode.StartingPrice(
          d.startingPrice || {},
        );
      }
    }
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.SellingModeType>,
    ) {
      return new EditAnOfferActionRes.SellingMode(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.SellingModeType>,
    ): InstanceType<typeof EditAnOfferActionRes.SellingMode> {
      return new EditAnOfferActionRes.SellingMode({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static Delivery = class Delivery {
     ...
     **/
    #shippingRates!: InstanceType<
      typeof EditAnOfferActionRes.Delivery.ShippingRates
    >;
    /**
     *
     ...
     **/
    set shippingRates(
      value: InstanceType<typeof EditAnOfferActionRes.Delivery.ShippingRates>,
    ) {
      // For objects, the sub type needs to always be instance of the sub class.
      if (value instanceof EditAnOfferActionRes.Delivery.ShippingRates) {
        this.#shippingRates = value;
      } else {
        this.#shippingRates = new EditAnOfferActionRes.Delivery.ShippingRates(
          value,
        );
      }
    }
    ...
    static ShippingRates = class ShippingRates {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.DeliveryType.ShippingRatesType,
      ) {
        return new EditAnOfferActionRes.Delivery.ShippingRates(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.DeliveryType.ShippingRatesType>,
      ) {
        return new EditAnOfferActionRes.Delivery.ShippingRates(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.DeliveryType.ShippingRatesType>,
      ): InstanceType<typeof EditAnOfferActionRes.Delivery.ShippingRates> {
        return new EditAnOfferActionRes.Delivery.ShippingRates({
          ...this.toJSON(),
          ...partial,
        });
    ...
    #lateInitFields(data = {}) {
      ...
      if (
        !(
          d.shippingRates instanceof EditAnOfferActionRes.Delivery.ShippingRates
        )
      ) {
        this.shippingRates = new EditAnOfferActionRes.Delivery.ShippingRates(
          d.shippingRates || {},
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.DeliveryType>,
    ) {
      return new EditAnOfferActionRes.Delivery(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.DeliveryType>,
    ): InstanceType<typeof EditAnOfferActionRes.Delivery> {
      return new EditAnOfferActionRes.Delivery({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static Publication = class Publication {
     ...
     **/
    #marketplaces!: InstanceType<
      typeof EditAnOfferActionRes.Publication.Marketplaces
    >;
    /**
     *
     ...
     **/
    set marketplaces(
      value: InstanceType<typeof EditAnOfferActionRes.Publication.Marketplaces>,
    ) {
      // For objects, the sub type needs to always be instance of the sub class.
      if (value instanceof EditAnOfferActionRes.Publication.Marketplaces) {
        this.#marketplaces = value;
      } else {
        this.#marketplaces = new EditAnOfferActionRes.Publication.Marketplaces(
          value,
        );
      }
    }
    ...
    static Marketplaces = class Marketplaces {
       ...
       **/
      #base!: InstanceType<
        typeof EditAnOfferActionRes.Publication.Marketplaces.Base
      >;
      /**
       *
      ...
      set base(
        ...
        // For objects, the sub type needs to always be instance of the sub class.
        if (
          value instanceof EditAnOfferActionRes.Publication.Marketplaces.Base
        ) {
          this.#base = value;
        } else {
          this.#base = new EditAnOfferActionRes.Publication.Marketplaces.Base(
            value,
          );
        }
      }
      ...
      static Base = class Base {
         ...
         **/
        static from(
          possibleDtoObject: EditAnOfferActionResType.PublicationType.MarketplacesType.BaseType,
        ) {
          return new EditAnOfferActionRes.Publication.Marketplaces.Base(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<EditAnOfferActionResType.PublicationType.MarketplacesType.BaseType>,
        ) {
          return new EditAnOfferActionRes.Publication.Marketplaces.Base(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<EditAnOfferActionResType.PublicationType.MarketplacesType.BaseType>,
        ): InstanceType<
          typeof EditAnOfferActionRes.Publication.Marketplaces.Base
        > {
          return new EditAnOfferActionRes.Publication.Marketplaces.Base({
      ...
      static Additional = class Additional {
         ...
         **/
        static from(
          possibleDtoObject: EditAnOfferActionResType.PublicationType.MarketplacesType.AdditionalType,
        ) {
          return new EditAnOfferActionRes.Publication.Marketplaces.Additional(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<EditAnOfferActionResType.PublicationType.MarketplacesType.AdditionalType>,
        ) {
          return new EditAnOfferActionRes.Publication.Marketplaces.Additional(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<EditAnOfferActionResType.PublicationType.MarketplacesType.AdditionalType>,
        ): InstanceType<
          typeof EditAnOfferActionRes.Publication.Marketplaces.Additional
        > {
          return new EditAnOfferActionRes.Publication.Marketplaces.Additional({
      ...
      applyFromObject(data = {}) {
        ...
        if (d.additional !== undefined) {
          this.additional = d.additional;
        }
        this.#lateInitFields(data);
      }
      /**
      ...
      #lateInitFields(data = {}) {
        ...
        if (
          !(
            d.base instanceof EditAnOfferActionRes.Publication.Marketplaces.Base
          )
        ) {
          this.base = new EditAnOfferActionRes.Publication.Marketplaces.Base(
            d.base || {},
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.PublicationType.MarketplacesType,
      ) {
        return new EditAnOfferActionRes.Publication.Marketplaces(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.PublicationType.MarketplacesType>,
      ) {
        return new EditAnOfferActionRes.Publication.Marketplaces(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.PublicationType.MarketplacesType>,
      ): InstanceType<typeof EditAnOfferActionRes.Publication.Marketplaces> {
        return new EditAnOfferActionRes.Publication.Marketplaces({
          ...this.toJSON(),
          ...partial,
        });
    ...
    applyFromObject(data = {}) {
      ...
      if (d.endedBy !== undefined) {
        this.endedBy = d.endedBy;
      }
      if (d.status !== undefined) {
        this.status = d.status;
      }
    ...
    #lateInitFields(data = {}) {
      ...
      if (
        !(
          d.marketplaces instanceof
          EditAnOfferActionRes.Publication.Marketplaces
        )
      ) {
        this.marketplaces = new EditAnOfferActionRes.Publication.Marketplaces(
          d.marketplaces || {},
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.PublicationType>,
    ) {
      return new EditAnOfferActionRes.Publication(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.PublicationType>,
    ): InstanceType<typeof EditAnOfferActionRes.Publication> {
      return new EditAnOfferActionRes.Publication({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static AdditionalMarketplaces = class AdditionalMarketplaces {
     ...
     **/
    #sellingMode!: InstanceType<
      typeof EditAnOfferActionRes.AdditionalMarketplaces.SellingMode
    >;
    /**
     *
    ...
    set sellingMode(
      ...
      // For objects, the sub type needs to always be instance of the sub class.
      if (
        value instanceof EditAnOfferActionRes.AdditionalMarketplaces.SellingMode
      ) {
        this.#sellingMode = value;
      } else {
        this.#sellingMode =
          new EditAnOfferActionRes.AdditionalMarketplaces.SellingMode(value);
      }
    }
    setSellingMode(
      value: InstanceType<
     ...
     **/
    #publication!: InstanceType<
      typeof EditAnOfferActionRes.AdditionalMarketplaces.Publication
    >;
    /**
     *
    ...
    set publication(
      ...
      // For objects, the sub type needs to always be instance of the sub class.
      if (
        value instanceof EditAnOfferActionRes.AdditionalMarketplaces.Publication
      ) {
        this.#publication = value;
      } else {
        this.#publication =
          new EditAnOfferActionRes.AdditionalMarketplaces.Publication(value);
      }
    }
    setPublication(
      value: InstanceType<
    ...
    static SellingMode = class SellingMode {
       ...
       **/
      #price!: InstanceType<
        typeof EditAnOfferActionRes.AdditionalMarketplaces.SellingMode.Price
      >;
      /**
       *
      ...
      set price(
        ...
        if (
          value instanceof
          EditAnOfferActionRes.AdditionalMarketplaces.SellingMode.Price
        ) {
          this.#price = value;
        } else {
          this.#price =
            new EditAnOfferActionRes.AdditionalMarketplaces.SellingMode.Price(
              value,
            );
        }
      }
      ...
      static Price = class Price {
         ...
         **/
        static from(
          possibleDtoObject: EditAnOfferActionResType.AdditionalMarketplacesType.SellingModeType.PriceType,
        ) {
          return new EditAnOfferActionRes.AdditionalMarketplaces.SellingMode.Price(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<EditAnOfferActionResType.AdditionalMarketplacesType.SellingModeType.PriceType>,
        ) {
          return new EditAnOfferActionRes.AdditionalMarketplaces.SellingMode.Price(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<EditAnOfferActionResType.AdditionalMarketplacesType.SellingModeType.PriceType>,
        ): InstanceType<
          typeof EditAnOfferActionRes.AdditionalMarketplaces.SellingMode.Price
        > {
          return new EditAnOfferActionRes.AdditionalMarketplaces.SellingMode.Price(
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.AdditionalMarketplacesType.SellingModeType,
      ) {
        return new EditAnOfferActionRes.AdditionalMarketplaces.SellingMode(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.AdditionalMarketplacesType.SellingModeType>,
      ) {
        return new EditAnOfferActionRes.AdditionalMarketplaces.SellingMode(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.AdditionalMarketplacesType.SellingModeType>,
      ): InstanceType<
        typeof EditAnOfferActionRes.AdditionalMarketplaces.SellingMode
      > {
        return new EditAnOfferActionRes.AdditionalMarketplaces.SellingMode({
    ...
    static Publication = class Publication {
      ...
      static RefusalReasons = class RefusalReasons {
         ...
         **/
        #parameters!: InstanceType<
          typeof EditAnOfferActionRes.AdditionalMarketplaces.Publication.RefusalReasons.Parameters
        >;
        /**
         *
        ...
        set parameters(
          ...
          if (
            value instanceof
            EditAnOfferActionRes.AdditionalMarketplaces.Publication
              .RefusalReasons.Parameters
          ) {
            this.#parameters = value;
          } else {
            this.#parameters =
              new EditAnOfferActionRes.AdditionalMarketplaces.Publication.RefusalReasons.Parameters(
                value,
              );
          }
        }
        ...
        static Parameters = class Parameters {
          ...
          get maxAllowedPriceDecreasePercent() {
            return this.#maxAllowedPriceDecreasePercent;
          }
          /**
           *
           * @type {string[]}
          ...
          applyFromObject(data = {}) {
            const d = data as Partial<Parameters>;
            if (d.maxAllowedPriceDecreasePercent !== undefined) {
              this.maxAllowedPriceDecreasePercent =
                d.maxAllowedPriceDecreasePercent;
            }
          }
          /**
           *	Special toJSON override, since the field are private,
           ...
           **/
          static from(
            possibleDtoObject: EditAnOfferActionResType.AdditionalMarketplacesType.PublicationType.RefusalReasonsType.ParametersType,
          ) {
            return new EditAnOfferActionRes.AdditionalMarketplaces.Publication.RefusalReasons.Parameters(
              possibleDtoObject,
            );
          }
          /**
           ...
           **/
          static with(
            partialDtoObject: PartialDeep<EditAnOfferActionResType.AdditionalMarketplacesType.PublicationType.RefusalReasonsType.ParametersType>,
          ) {
            return new EditAnOfferActionRes.AdditionalMarketplaces.Publication.RefusalReasons.Parameters(
              partialDtoObject,
            );
          ...
          copyWith(
            partial: PartialDeep<EditAnOfferActionResType.AdditionalMarketplacesType.PublicationType.RefusalReasonsType.ParametersType>,
          ): InstanceType<
            typeof EditAnOfferActionRes.AdditionalMarketplaces.Publication.RefusalReasons.Parameters
          > {
            return new EditAnOfferActionRes.AdditionalMarketplaces.Publication.RefusalReasons.Parameters(
        ...
        applyFromObject(data = {}) {
          ...
          if (d.userMessage !== undefined) {
            this.userMessage = d.userMessage;
          }
          if (d.parameters !== undefined) {
            this.parameters = d.parameters;
          }
          ...
          return {
            ...
            get parameters() {
              return withPrefix(
                ...
                EditAnOfferActionRes.AdditionalMarketplaces.Publication
                  .RefusalReasons.Parameters.Fields,
              );
            },
          };
        }
         ...
         **/
        static from(
          possibleDtoObject: EditAnOfferActionResType.AdditionalMarketplacesType.PublicationType.RefusalReasonsType,
        ) {
          return new EditAnOfferActionRes.AdditionalMarketplaces.Publication.RefusalReasons(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<EditAnOfferActionResType.AdditionalMarketplacesType.PublicationType.RefusalReasonsType>,
        ) {
          return new EditAnOfferActionRes.AdditionalMarketplaces.Publication.RefusalReasons(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<EditAnOfferActionResType.AdditionalMarketplacesType.PublicationType.RefusalReasonsType>,
        ): InstanceType<
          typeof EditAnOfferActionRes.AdditionalMarketplaces.Publication.RefusalReasons
        > {
          return new EditAnOfferActionRes.AdditionalMarketplaces.Publication.RefusalReasons(
      ...
      applyFromObject(data = {}) {
        ...
        if (d.refusalReasons !== undefined) {
          this.refusalReasons = d.refusalReasons;
        }
      }
      /**
       *	Special toJSON override, since the field are private,
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.AdditionalMarketplacesType.PublicationType,
      ) {
        return new EditAnOfferActionRes.AdditionalMarketplaces.Publication(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.AdditionalMarketplacesType.PublicationType>,
      ) {
        return new EditAnOfferActionRes.AdditionalMarketplaces.Publication(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.AdditionalMarketplacesType.PublicationType>,
      ): InstanceType<
        typeof EditAnOfferActionRes.AdditionalMarketplaces.Publication
      > {
        return new EditAnOfferActionRes.AdditionalMarketplaces.Publication({
    ...
    #lateInitFields(data = {}) {
      ...
      if (
        !(
          d.sellingMode instanceof
          EditAnOfferActionRes.AdditionalMarketplaces.SellingMode
        )
      ) {
        this.sellingMode =
          new EditAnOfferActionRes.AdditionalMarketplaces.SellingMode(
            d.sellingMode || {},
          );
      }
      if (
        ...
        this.publication =
          new EditAnOfferActionRes.AdditionalMarketplaces.Publication(
            d.publication || {},
          );
      }
    }
     ...
     **/
    static from(
      possibleDtoObject: EditAnOfferActionResType.AdditionalMarketplacesType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.AdditionalMarketplacesType>,
    ) {
      return new EditAnOfferActionRes.AdditionalMarketplaces(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.AdditionalMarketplacesType>,
    ): InstanceType<typeof EditAnOfferActionRes.AdditionalMarketplaces> {
      return new EditAnOfferActionRes.AdditionalMarketplaces({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static B2b = class B2b {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.B2bType>,
    ) {
      return new EditAnOfferActionRes.B2b(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.B2bType>,
    ): InstanceType<typeof EditAnOfferActionRes.B2b> {
  ...
  static CompatibilityList = class CompatibilityList {
     ...
     **/
    static from(
      possibleDtoObject: EditAnOfferActionResType.CompatibilityListType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.CompatibilityListType>,
    ) {
      return new EditAnOfferActionRes.CompatibilityList(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.CompatibilityListType>,
    ): InstanceType<typeof EditAnOfferActionRes.CompatibilityList> {
      return new EditAnOfferActionRes.CompatibilityList({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static Validation = class Validation {
    ...
    static Errors = class Errors {
      ...
      #metadata!: InstanceType<
        typeof EditAnOfferActionRes.Validation.Errors.Metadata
      >;
      /**
       *
      ...
      set metadata(
        ...
        if (value instanceof EditAnOfferActionRes.Validation.Errors.Metadata) {
          ...
          this.#metadata = new EditAnOfferActionRes.Validation.Errors.Metadata(
            value,
          );
        }
      }
      ...
      static Metadata = class Metadata {
         ...
         **/
        static from(
          possibleDtoObject: EditAnOfferActionResType.ValidationType.ErrorsType.MetadataType,
        ) {
          return new EditAnOfferActionRes.Validation.Errors.Metadata(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<EditAnOfferActionResType.ValidationType.ErrorsType.MetadataType>,
        ) {
          return new EditAnOfferActionRes.Validation.Errors.Metadata(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<EditAnOfferActionResType.ValidationType.ErrorsType.MetadataType>,
        ): InstanceType<
          typeof EditAnOfferActionRes.Validation.Errors.Metadata
        > {
          return new EditAnOfferActionRes.Validation.Errors.Metadata({
      ...
      #lateInitFields(data = {}) {
        ...
        if (
          !(
            d.metadata instanceof
            EditAnOfferActionRes.Validation.Errors.Metadata
          )
        ) {
          this.metadata = new EditAnOfferActionRes.Validation.Errors.Metadata(
            d.metadata || {},
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.ValidationType.ErrorsType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.ValidationType.ErrorsType>,
      ) {
        return new EditAnOfferActionRes.Validation.Errors(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.ValidationType.ErrorsType>,
      ): InstanceType<typeof EditAnOfferActionRes.Validation.Errors> {
        return new EditAnOfferActionRes.Validation.Errors({
          ...this.toJSON(),
          ...partial,
        });
      }
    ...
    static Warnings = class Warnings {
       ...
       **/
      #metadata!: InstanceType<
        typeof EditAnOfferActionRes.Validation.Warnings.Metadata
      >;
      /**
       *
      ...
      set metadata(
        ...
        // For objects, the sub type needs to always be instance of the sub class.
        if (
          value instanceof EditAnOfferActionRes.Validation.Warnings.Metadata
        ) {
          this.#metadata = value;
        } else {
          this.#metadata =
            new EditAnOfferActionRes.Validation.Warnings.Metadata(value);
        }
      }
      setMetadata(
        value: InstanceType<
      ...
      static Metadata = class Metadata {
         ...
         **/
        static from(
          possibleDtoObject: EditAnOfferActionResType.ValidationType.WarningsType.MetadataType,
        ) {
          return new EditAnOfferActionRes.Validation.Warnings.Metadata(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<EditAnOfferActionResType.ValidationType.WarningsType.MetadataType>,
        ) {
          return new EditAnOfferActionRes.Validation.Warnings.Metadata(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<EditAnOfferActionResType.ValidationType.WarningsType.MetadataType>,
        ): InstanceType<
          typeof EditAnOfferActionRes.Validation.Warnings.Metadata
        > {
          return new EditAnOfferActionRes.Validation.Warnings.Metadata({
      ...
      #lateInitFields(data = {}) {
        ...
        if (
          !(
            d.metadata instanceof
            EditAnOfferActionRes.Validation.Warnings.Metadata
          )
        ) {
          this.metadata = new EditAnOfferActionRes.Validation.Warnings.Metadata(
            d.metadata || {},
          );
        }
      }
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.ValidationType.WarningsType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.ValidationType.WarningsType>,
      ) {
        return new EditAnOfferActionRes.Validation.Warnings(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.ValidationType.WarningsType>,
      ): InstanceType<typeof EditAnOfferActionRes.Validation.Warnings> {
        return new EditAnOfferActionRes.Validation.Warnings({
          ...this.toJSON(),
          ...partial,
        });
      }
    ...
    applyFromObject(data = {}) {
      ...
      if (d.validatedAt !== undefined) {
        this.validatedAt = d.validatedAt;
      }
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.ValidationType>,
    ) {
      return new EditAnOfferActionRes.Validation(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.ValidationType>,
    ): InstanceType<typeof EditAnOfferActionRes.Validation> {
      return new EditAnOfferActionRes.Validation({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static AfterSalesServices = class AfterSalesServices {
     ...
     **/
    #impliedWarranty!: InstanceType<
      typeof EditAnOfferActionRes.AfterSalesServices.ImpliedWarranty
    >;
    /**
     *
    ...
    set impliedWarranty(
      ...
      // For objects, the sub type needs to always be instance of the sub class.
      if (
        value instanceof EditAnOfferActionRes.AfterSalesServices.ImpliedWarranty
      ) {
        this.#impliedWarranty = value;
      } else {
        this.#impliedWarranty =
          new EditAnOfferActionRes.AfterSalesServices.ImpliedWarranty(value);
      }
    }
    setImpliedWarranty(
      value: InstanceType<
     ...
     **/
    #returnPolicy!: InstanceType<
      typeof EditAnOfferActionRes.AfterSalesServices.ReturnPolicy
    >;
    /**
     *
    ...
    set returnPolicy(
      ...
      // For objects, the sub type needs to always be instance of the sub class.
      if (
        value instanceof EditAnOfferActionRes.AfterSalesServices.ReturnPolicy
      ) {
        this.#returnPolicy = value;
      } else {
        this.#returnPolicy =
          new EditAnOfferActionRes.AfterSalesServices.ReturnPolicy(value);
      }
    }
    setReturnPolicy(
      value: InstanceType<
     ...
     **/
    #warranty!: InstanceType<
      typeof EditAnOfferActionRes.AfterSalesServices.Warranty
    >;
    /**
     *
    ...
    set warranty(
      ...
      if (value instanceof EditAnOfferActionRes.AfterSalesServices.Warranty) {
        ...
        this.#warranty = new EditAnOfferActionRes.AfterSalesServices.Warranty(
          value,
        );
      }
    }
    ...
    static ImpliedWarranty = class ImpliedWarranty {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.AfterSalesServicesType.ImpliedWarrantyType,
      ) {
        return new EditAnOfferActionRes.AfterSalesServices.ImpliedWarranty(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.AfterSalesServicesType.ImpliedWarrantyType>,
      ) {
        return new EditAnOfferActionRes.AfterSalesServices.ImpliedWarranty(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.AfterSalesServicesType.ImpliedWarrantyType>,
      ): InstanceType<
        typeof EditAnOfferActionRes.AfterSalesServices.ImpliedWarranty
      > {
        return new EditAnOfferActionRes.AfterSalesServices.ImpliedWarranty({
    ...
    static ReturnPolicy = class ReturnPolicy {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.AfterSalesServicesType.ReturnPolicyType,
      ) {
        return new EditAnOfferActionRes.AfterSalesServices.ReturnPolicy(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.AfterSalesServicesType.ReturnPolicyType>,
      ) {
        return new EditAnOfferActionRes.AfterSalesServices.ReturnPolicy(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.AfterSalesServicesType.ReturnPolicyType>,
      ): InstanceType<
        typeof EditAnOfferActionRes.AfterSalesServices.ReturnPolicy
      > {
        return new EditAnOfferActionRes.AfterSalesServices.ReturnPolicy({
    ...
    static Warranty = class Warranty {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.AfterSalesServicesType.WarrantyType,
      ) {
        return new EditAnOfferActionRes.AfterSalesServices.Warranty(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.AfterSalesServicesType.WarrantyType>,
      ) {
        return new EditAnOfferActionRes.AfterSalesServices.Warranty(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.AfterSalesServicesType.WarrantyType>,
      ): InstanceType<typeof EditAnOfferActionRes.AfterSalesServices.Warranty> {
        return new EditAnOfferActionRes.AfterSalesServices.Warranty({
          ...this.toJSON(),
          ...partial,
        });
    ...
    #lateInitFields(data = {}) {
      ...
      if (
        !(
          d.impliedWarranty instanceof
          EditAnOfferActionRes.AfterSalesServices.ImpliedWarranty
        )
      ) {
        this.impliedWarranty =
          new EditAnOfferActionRes.AfterSalesServices.ImpliedWarranty(
            d.impliedWarranty || {},
          );
      }
      if (
        !(
          d.returnPolicy instanceof
          EditAnOfferActionRes.AfterSalesServices.ReturnPolicy
        )
      ) {
        this.returnPolicy =
          new EditAnOfferActionRes.AfterSalesServices.ReturnPolicy(
            d.returnPolicy || {},
          );
      }
      if (
        !(
          d.warranty instanceof EditAnOfferActionRes.AfterSalesServices.Warranty
        )
      ) {
        this.warranty = new EditAnOfferActionRes.AfterSalesServices.Warranty(
          d.warranty || {},
     ...
     **/
    static from(
      possibleDtoObject: EditAnOfferActionResType.AfterSalesServicesType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.AfterSalesServicesType>,
    ) {
      return new EditAnOfferActionRes.AfterSalesServices(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.AfterSalesServicesType>,
    ): InstanceType<typeof EditAnOfferActionRes.AfterSalesServices> {
      return new EditAnOfferActionRes.AfterSalesServices({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static Discounts = class Discounts {
     ...
     **/
    #wholesalePriceList!: InstanceType<
      typeof EditAnOfferActionRes.Discounts.WholesalePriceList
    >;
    /**
     *
    ...
    set wholesalePriceList(
      ...
      if (value instanceof EditAnOfferActionRes.Discounts.WholesalePriceList) {
        ...
        this.#wholesalePriceList =
          new EditAnOfferActionRes.Discounts.WholesalePriceList(value);
      }
    }
    setWholesalePriceList(
      value: InstanceType<
    ...
    static WholesalePriceList = class WholesalePriceList {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.DiscountsType.WholesalePriceListType,
      ) {
        return new EditAnOfferActionRes.Discounts.WholesalePriceList(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.DiscountsType.WholesalePriceListType>,
      ) {
        return new EditAnOfferActionRes.Discounts.WholesalePriceList(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.DiscountsType.WholesalePriceListType>,
      ): InstanceType<
        typeof EditAnOfferActionRes.Discounts.WholesalePriceList
      > {
        return new EditAnOfferActionRes.Discounts.WholesalePriceList({
    ...
    #lateInitFields(data = {}) {
      ...
      if (
        !(
          d.wholesalePriceList instanceof
          EditAnOfferActionRes.Discounts.WholesalePriceList
        )
      ) {
        this.wholesalePriceList =
          new EditAnOfferActionRes.Discounts.WholesalePriceList(
            d.wholesalePriceList || {},
          );
      }
    }
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.DiscountsType>,
    ) {
      return new EditAnOfferActionRes.Discounts(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.DiscountsType>,
    ): InstanceType<typeof EditAnOfferActionRes.Discounts> {
      return new EditAnOfferActionRes.Discounts({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static Contact = class Contact {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.ContactType>,
    ) {
      return new EditAnOfferActionRes.Contact(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.ContactType>,
    ): InstanceType<typeof EditAnOfferActionRes.Contact> {
  ...
  static Attachments = class Attachments {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.AttachmentsType>,
    ) {
      return new EditAnOfferActionRes.Attachments(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.AttachmentsType>,
    ): InstanceType<typeof EditAnOfferActionRes.Attachments> {
      return new EditAnOfferActionRes.Attachments({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static FundraisingCampaign = class FundraisingCampaign {
     ...
     **/
    static from(
      possibleDtoObject: EditAnOfferActionResType.FundraisingCampaignType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.FundraisingCampaignType>,
    ) {
      return new EditAnOfferActionRes.FundraisingCampaign(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.FundraisingCampaignType>,
    ): InstanceType<typeof EditAnOfferActionRes.FundraisingCampaign> {
      return new EditAnOfferActionRes.FundraisingCampaign({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static AdditionalServices = class AdditionalServices {
     ...
     **/
    static from(
      possibleDtoObject: EditAnOfferActionResType.AdditionalServicesType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.AdditionalServicesType>,
    ) {
      return new EditAnOfferActionRes.AdditionalServices(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.AdditionalServicesType>,
    ): InstanceType<typeof EditAnOfferActionRes.AdditionalServices> {
      return new EditAnOfferActionRes.AdditionalServices({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static SizeTable = class SizeTable {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.SizeTableType>,
    ) {
      return new EditAnOfferActionRes.SizeTable(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.SizeTableType>,
    ): InstanceType<typeof EditAnOfferActionRes.SizeTable> {
      return new EditAnOfferActionRes.SizeTable({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static Location = class Location {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.LocationType>,
    ) {
      return new EditAnOfferActionRes.Location(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.LocationType>,
    ): InstanceType<typeof EditAnOfferActionRes.Location> {
      return new EditAnOfferActionRes.Location({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static External = class External {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.ExternalType>,
    ) {
      return new EditAnOfferActionRes.External(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.ExternalType>,
    ): InstanceType<typeof EditAnOfferActionRes.External> {
      return new EditAnOfferActionRes.External({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static TaxSettings = class TaxSettings {
    ...
    static Rates = class Rates {
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.TaxSettingsType.RatesType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.TaxSettingsType.RatesType>,
      ) {
        return new EditAnOfferActionRes.TaxSettings.Rates(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.TaxSettingsType.RatesType>,
      ): InstanceType<typeof EditAnOfferActionRes.TaxSettings.Rates> {
        return new EditAnOfferActionRes.TaxSettings.Rates({
          ...this.toJSON(),
          ...partial,
        });
      }
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.TaxSettingsType>,
    ) {
      return new EditAnOfferActionRes.TaxSettings(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.TaxSettingsType>,
    ): InstanceType<typeof EditAnOfferActionRes.TaxSettings> {
      return new EditAnOfferActionRes.TaxSettings({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static MessageToSellerSettings = class MessageToSellerSettings {
     ...
     **/
    static from(
      possibleDtoObject: EditAnOfferActionResType.MessageToSellerSettingsType,
    ) {
      return new EditAnOfferActionRes.MessageToSellerSettings(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.MessageToSellerSettingsType>,
    ) {
      return new EditAnOfferActionRes.MessageToSellerSettings(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.MessageToSellerSettingsType>,
    ): InstanceType<typeof EditAnOfferActionRes.MessageToSellerSettings> {
      return new EditAnOfferActionRes.MessageToSellerSettings({
        ...this.toJSON(),
        ...partial,
      });
  ...
  static Description = class Description {
    ...
    static Sections = class Sections {
      ...
      static Items = class Items {
         ...
         **/
        static from(
          possibleDtoObject: EditAnOfferActionResType.DescriptionType.SectionsType.ItemsType,
        ) {
          return new EditAnOfferActionRes.Description.Sections.Items(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<EditAnOfferActionResType.DescriptionType.SectionsType.ItemsType>,
        ) {
          return new EditAnOfferActionRes.Description.Sections.Items(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<EditAnOfferActionResType.DescriptionType.SectionsType.ItemsType>,
        ): InstanceType<
          typeof EditAnOfferActionRes.Description.Sections.Items
        > {
          return new EditAnOfferActionRes.Description.Sections.Items({
       ...
       **/
      static from(
        possibleDtoObject: EditAnOfferActionResType.DescriptionType.SectionsType,
      ) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<EditAnOfferActionResType.DescriptionType.SectionsType>,
      ) {
        return new EditAnOfferActionRes.Description.Sections(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<EditAnOfferActionResType.DescriptionType.SectionsType>,
      ): InstanceType<typeof EditAnOfferActionRes.Description.Sections> {
        return new EditAnOfferActionRes.Description.Sections({
          ...this.toJSON(),
          ...partial,
        });
      }
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<EditAnOfferActionResType.DescriptionType>,
    ) {
      return new EditAnOfferActionRes.Description(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<EditAnOfferActionResType.DescriptionType>,
    ): InstanceType<typeof EditAnOfferActionRes.Description> {
      return new EditAnOfferActionRes.Description({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  #lateInitFields(data = {}) {
    const d = data as Partial<EditAnOfferActionRes>;
    if (!(d.category instanceof EditAnOfferActionRes.Category)) {
      this.category = new EditAnOfferActionRes.Category(d.category || {});
    }
    if (!(d.stock instanceof EditAnOfferActionRes.Stock)) {
      this.stock = new EditAnOfferActionRes.Stock(d.stock || {});
    }
    if (!(d.payments instanceof EditAnOfferActionRes.Payments)) {
      this.payments = new EditAnOfferActionRes.Payments(d.payments || {});
    }
    if (!(d.sellingMode instanceof EditAnOfferActionRes.SellingMode)) {
      this.sellingMode = new EditAnOfferActionRes.SellingMode(
        d.sellingMode || {},
      );
    }
    if (!(d.delivery instanceof EditAnOfferActionRes.Delivery)) {
      this.delivery = new EditAnOfferActionRes.Delivery(d.delivery || {});
    }
    if (!(d.publication instanceof EditAnOfferActionRes.Publication)) {
      this.publication = new EditAnOfferActionRes.Publication(
        d.publication || {},
      );
    }
    if (
      !(
        d.additionalMarketplaces instanceof
        EditAnOfferActionRes.AdditionalMarketplaces
      )
    ) {
      this.additionalMarketplaces =
        new EditAnOfferActionRes.AdditionalMarketplaces(
          d.additionalMarketplaces || {},
        );
    }
    if (!(d.b2b instanceof EditAnOfferActionRes.B2b)) {
      this.b2b = new EditAnOfferActionRes.B2b(d.b2b || {});
    }
    if (
      !(d.compatibilityList instanceof EditAnOfferActionRes.CompatibilityList)
    ) {
      this.compatibilityList = new EditAnOfferActionRes.CompatibilityList(
        d.compatibilityList || {},
      );
    }
    if (!(d.validation instanceof EditAnOfferActionRes.Validation)) {
      this.validation = new EditAnOfferActionRes.Validation(d.validation || {});
    }
    if (
      !(d.afterSalesServices instanceof EditAnOfferActionRes.AfterSalesServices)
    ) {
      this.afterSalesServices = new EditAnOfferActionRes.AfterSalesServices(
        d.afterSalesServices || {},
      );
    }
    if (!(d.discounts instanceof EditAnOfferActionRes.Discounts)) {
      this.discounts = new EditAnOfferActionRes.Discounts(d.discounts || {});
    }
    if (!(d.contact instanceof EditAnOfferActionRes.Contact)) {
      this.contact = new EditAnOfferActionRes.Contact(d.contact || {});
    }
    if (
      !(
        d.fundraisingCampaign instanceof
        EditAnOfferActionRes.FundraisingCampaign
      )
    ) {
      this.fundraisingCampaign = new EditAnOfferActionRes.FundraisingCampaign(
        d.fundraisingCampaign || {},
    ...
    if (
      !(d.additionalServices instanceof EditAnOfferActionRes.AdditionalServices)
    ) {
      this.additionalServices = new EditAnOfferActionRes.AdditionalServices(
        d.additionalServices || {},
      );
    }
    if (!(d.sizeTable instanceof EditAnOfferActionRes.SizeTable)) {
      this.sizeTable = new EditAnOfferActionRes.SizeTable(d.sizeTable || {});
    }
    if (!(d.location instanceof EditAnOfferActionRes.Location)) {
      this.location = new EditAnOfferActionRes.Location(d.location || {});
    }
    if (!(d.external instanceof EditAnOfferActionRes.External)) {
      this.external = new EditAnOfferActionRes.External(d.external || {});
    }
    if (!(d.taxSettings instanceof EditAnOfferActionRes.TaxSettings)) {
      this.taxSettings = new EditAnOfferActionRes.TaxSettings(
        d.taxSettings || {},
      );
    }
    if (
      !(
        d.messageToSellerSettings instanceof
        EditAnOfferActionRes.MessageToSellerSettings
      )
    ) {
      this.messageToSellerSettings =
        new EditAnOfferActionRes.MessageToSellerSettings(
          d.messageToSellerSettings || {},
        );
    }
    if (!(d.description instanceof EditAnOfferActionRes.Description)) {
      this.description = new EditAnOfferActionRes.Description(
        d.description || {},
      );
    }
  }
  ...
  static get Fields() {
    return {
      ...
      category$: "category",
      get category() {
        return withPrefix("category", EditAnOfferActionRes.Category.Fields);
      },
      productSet$: "productSet",
      get productSet() {
        return withPrefix(
      ...
      stock$: "stock",
      get stock() {
        return withPrefix("stock", EditAnOfferActionRes.Stock.Fields);
      },
      payments$: "payments",
      get payments() {
        return withPrefix("payments", EditAnOfferActionRes.Payments.Fields);
      },
      sellingMode$: "sellingMode",
      get sellingMode() {
        return withPrefix(
      ...
      delivery$: "delivery",
      get delivery() {
        return withPrefix("delivery", EditAnOfferActionRes.Delivery.Fields);
      },
      publication$: "publication",
      get publication() {
        return withPrefix(
      ...
      b2b$: "b2b",
      get b2b() {
        return withPrefix("b2b", EditAnOfferActionRes.B2b.Fields);
      },
      compatibilityList$: "compatibilityList",
      get compatibilityList() {
        return withPrefix(
      ...
      get validation() {
        return withPrefix("validation", EditAnOfferActionRes.Validation.Fields);
      },
      warnings$: "warnings",
      get warnings() {
        return "warnings[:i]";
      ...
      discounts$: "discounts",
      get discounts() {
        return withPrefix("discounts", EditAnOfferActionRes.Discounts.Fields);
      },
      contact$: "contact",
      get contact() {
        return withPrefix("contact", EditAnOfferActionRes.Contact.Fields);
      },
      attachments$: "attachments",
      get attachments() {
        return withPrefix(
      ...
      sizeTable$: "sizeTable",
      get sizeTable() {
        return withPrefix("sizeTable", EditAnOfferActionRes.SizeTable.Fields);
      },
      location$: "location",
      get location() {
        return withPrefix("location", EditAnOfferActionRes.Location.Fields);
      },
      external$: "external",
      get external() {
        return withPrefix("external", EditAnOfferActionRes.External.Fields);
      },
      taxSettings$: "taxSettings",
      get taxSettings() {
        return withPrefix(
  ...
  copyWith(
    partial: PartialDeep<EditAnOfferActionResType>,
  ): InstanceType<typeof EditAnOfferActionRes> {
