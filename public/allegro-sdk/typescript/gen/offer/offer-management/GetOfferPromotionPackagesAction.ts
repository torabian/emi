...
export class GetOfferPromotionPackagesAction {
  ...
  static NewUrl = (qs?: URLSearchParams) =>
    buildUrl(GetOfferPromotionPackagesAction.URL, undefined, qs);
  static Method = "get";
  static Fetch$ = async (
    qs?: URLSearchParams,
    ctx?: FetchxContext,
    ...
    return fetchx<GetOfferPromotionPackagesActionRes, unknown, unknown>(
      overrideUrl ?? GetOfferPromotionPackagesAction.NewUrl(qs),
      {
  ...
  static Fetch = async (
    init?: TypedRequestInit<unknown, unknown>,
    {
      ...
      creatorFn?:
        | ((item: unknown) => GetOfferPromotionPackagesActionRes)
        | undefined;
      qs?: URLSearchParams;
      ctx?: FetchxContext;
...
export class GetOfferPromotionPackagesActionRes {
  ...
  #basePackage!: InstanceType<
    typeof GetOfferPromotionPackagesActionRes.BasePackage
  >;
  /**
   *
   ...
   **/
  set basePackage(
    value: InstanceType<typeof GetOfferPromotionPackagesActionRes.BasePackage>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof GetOfferPromotionPackagesActionRes.BasePackage) {
      this.#basePackage = value;
    } else {
      this.#basePackage = new GetOfferPromotionPackagesActionRes.BasePackage(
        value,
      );
    }
  }
  ...
  #extraPackages: InstanceType<
    typeof GetOfferPromotionPackagesActionRes.ExtraPackages
  >[] = [];
  /**
   *
  ...
  set extraPackages(
    ...
    if (
      value.length > 0 &&
      value[0] instanceof GetOfferPromotionPackagesActionRes.ExtraPackages
    ) {
      this.#extraPackages = value;
    } else {
      this.#extraPackages = value.map(
        (item) => new GetOfferPromotionPackagesActionRes.ExtraPackages(item),
      );
    }
  }
  setExtraPackages(
  ...
  #pendingChanges!: InstanceType<
    typeof GetOfferPromotionPackagesActionRes.PendingChanges
  >;
  /**
   *
  ...
  set pendingChanges(
    ...
    if (value instanceof GetOfferPromotionPackagesActionRes.PendingChanges) {
      ...
      this.#pendingChanges =
        new GetOfferPromotionPackagesActionRes.PendingChanges(value);
    }
  }
  setPendingChanges(
    value: InstanceType<
  ...
  #additionalMarketplaces: InstanceType<
    typeof GetOfferPromotionPackagesActionRes.AdditionalMarketplaces
  >[] = [];
  /**
   *
  ...
  set additionalMarketplaces(
    ...
    if (
      value.length > 0 &&
      value[0] instanceof
        GetOfferPromotionPackagesActionRes.AdditionalMarketplaces
    ) {
      this.#additionalMarketplaces = value;
    } else {
      this.#additionalMarketplaces = value.map(
        (item) =>
          new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces(item),
      );
    }
  }
  ...
  static BasePackage = class BasePackage {
     ...
     **/
    static from(
      possibleDtoObject: GetOfferPromotionPackagesActionResType.BasePackageType,
    ) {
      return new GetOfferPromotionPackagesActionRes.BasePackage(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetOfferPromotionPackagesActionResType.BasePackageType>,
    ) {
      return new GetOfferPromotionPackagesActionRes.BasePackage(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetOfferPromotionPackagesActionResType.BasePackageType>,
    ): InstanceType<typeof GetOfferPromotionPackagesActionRes.BasePackage> {
      return new GetOfferPromotionPackagesActionRes.BasePackage({
        ...this.toJSON(),
        ...partial,
      });
  ...
  static ExtraPackages = class ExtraPackages {
     ...
     **/
    static from(
      possibleDtoObject: GetOfferPromotionPackagesActionResType.ExtraPackagesType,
    ) {
      return new GetOfferPromotionPackagesActionRes.ExtraPackages(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetOfferPromotionPackagesActionResType.ExtraPackagesType>,
    ) {
      return new GetOfferPromotionPackagesActionRes.ExtraPackages(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetOfferPromotionPackagesActionResType.ExtraPackagesType>,
    ): InstanceType<typeof GetOfferPromotionPackagesActionRes.ExtraPackages> {
      return new GetOfferPromotionPackagesActionRes.ExtraPackages({
        ...this.toJSON(),
        ...partial,
      });
  ...
  static PendingChanges = class PendingChanges {
     ...
     **/
    #basePackage!: InstanceType<
      typeof GetOfferPromotionPackagesActionRes.PendingChanges.BasePackage
    >;
    /**
     *
    ...
    set basePackage(
      ...
      if (
        value instanceof
        GetOfferPromotionPackagesActionRes.PendingChanges.BasePackage
      ) {
        this.#basePackage = value;
      } else {
        this.#basePackage =
          new GetOfferPromotionPackagesActionRes.PendingChanges.BasePackage(
            value,
          );
      }
    }
    ...
    static BasePackage = class BasePackage {
       ...
       **/
      static from(
        possibleDtoObject: GetOfferPromotionPackagesActionResType.PendingChangesType.BasePackageType,
      ) {
        return new GetOfferPromotionPackagesActionRes.PendingChanges.BasePackage(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetOfferPromotionPackagesActionResType.PendingChangesType.BasePackageType>,
      ) {
        return new GetOfferPromotionPackagesActionRes.PendingChanges.BasePackage(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetOfferPromotionPackagesActionResType.PendingChangesType.BasePackageType>,
      ): InstanceType<
        typeof GetOfferPromotionPackagesActionRes.PendingChanges.BasePackage
      > {
        return new GetOfferPromotionPackagesActionRes.PendingChanges.BasePackage(
     ...
     **/
    static from(
      possibleDtoObject: GetOfferPromotionPackagesActionResType.PendingChangesType,
    ) {
      return new GetOfferPromotionPackagesActionRes.PendingChanges(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetOfferPromotionPackagesActionResType.PendingChangesType>,
    ) {
      return new GetOfferPromotionPackagesActionRes.PendingChanges(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetOfferPromotionPackagesActionResType.PendingChangesType>,
    ): InstanceType<typeof GetOfferPromotionPackagesActionRes.PendingChanges> {
      return new GetOfferPromotionPackagesActionRes.PendingChanges({
        ...this.toJSON(),
        ...partial,
      });
  ...
  static AdditionalMarketplaces = class AdditionalMarketplaces {
     ...
     **/
    #basePackage!: InstanceType<
      typeof GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.BasePackage
    >;
    /**
     *
    ...
    set basePackage(
      ...
      if (
        value instanceof
        GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.BasePackage
      ) {
        this.#basePackage = value;
      } else {
        this.#basePackage =
          new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.BasePackage(
            value,
          );
      }
    }
     ...
     **/
    #extraPackages: InstanceType<
      typeof GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.ExtraPackages
    >[] = [];
    /**
     *
    ...
    set extraPackages(
      ...
      if (
        ...
        this.#extraPackages = value.map(
          (item) =>
            new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.ExtraPackages(
              item,
            ),
        );
      }
     ...
     **/
    #pendingChanges!: InstanceType<
      typeof GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges
    >;
    /**
     *
    ...
    set pendingChanges(
      ...
      if (
        value instanceof
        GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges
      ) {
        this.#pendingChanges = value;
      } else {
        this.#pendingChanges =
          new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges(
            value,
          );
      }
    }
    ...
    static BasePackage = class BasePackage {
       ...
       **/
      static from(
        possibleDtoObject: GetOfferPromotionPackagesActionResType.AdditionalMarketplacesType.BasePackageType,
      ) {
        return new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.BasePackage(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetOfferPromotionPackagesActionResType.AdditionalMarketplacesType.BasePackageType>,
      ) {
        return new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.BasePackage(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetOfferPromotionPackagesActionResType.AdditionalMarketplacesType.BasePackageType>,
      ): InstanceType<
        typeof GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.BasePackage
      > {
        return new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.BasePackage(
    ...
    static ExtraPackages = class ExtraPackages {
       ...
       **/
      static from(
        possibleDtoObject: GetOfferPromotionPackagesActionResType.AdditionalMarketplacesType.ExtraPackagesType,
      ) {
        return new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.ExtraPackages(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetOfferPromotionPackagesActionResType.AdditionalMarketplacesType.ExtraPackagesType>,
      ) {
        return new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.ExtraPackages(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetOfferPromotionPackagesActionResType.AdditionalMarketplacesType.ExtraPackagesType>,
      ): InstanceType<
        typeof GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.ExtraPackages
      > {
        return new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.ExtraPackages(
    ...
    static PendingChanges = class PendingChanges {
       ...
       **/
      #basePackage!: InstanceType<
        typeof GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges.BasePackage
      >;
      /**
       *
      ...
      set basePackage(
        ...
        if (
          ...
          this.#basePackage =
            new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges.BasePackage(
              value,
            );
        }
      }
      ...
      static BasePackage = class BasePackage {
         ...
         **/
        static from(
          possibleDtoObject: GetOfferPromotionPackagesActionResType.AdditionalMarketplacesType.PendingChangesType.BasePackageType,
        ) {
          return new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges.BasePackage(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetOfferPromotionPackagesActionResType.AdditionalMarketplacesType.PendingChangesType.BasePackageType>,
        ) {
          return new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges.BasePackage(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetOfferPromotionPackagesActionResType.AdditionalMarketplacesType.PendingChangesType.BasePackageType>,
        ): InstanceType<
          typeof GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges.BasePackage
        > {
          return new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges.BasePackage(
       ...
       **/
      static from(
        possibleDtoObject: GetOfferPromotionPackagesActionResType.AdditionalMarketplacesType.PendingChangesType,
      ) {
        return new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetOfferPromotionPackagesActionResType.AdditionalMarketplacesType.PendingChangesType>,
      ) {
        return new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetOfferPromotionPackagesActionResType.AdditionalMarketplacesType.PendingChangesType>,
      ): InstanceType<
        typeof GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges
      > {
        return new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges(
     ...
     **/
    static from(
      possibleDtoObject: GetOfferPromotionPackagesActionResType.AdditionalMarketplacesType,
    ) {
      return new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetOfferPromotionPackagesActionResType.AdditionalMarketplacesType>,
    ) {
      return new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetOfferPromotionPackagesActionResType.AdditionalMarketplacesType>,
    ): InstanceType<
      typeof GetOfferPromotionPackagesActionRes.AdditionalMarketplaces
    > {
      return new GetOfferPromotionPackagesActionRes.AdditionalMarketplaces({
  ...
  #lateInitFields(data = {}) {
    const d = data as Partial<GetOfferPromotionPackagesActionRes>;
    if (
      !(d.basePackage instanceof GetOfferPromotionPackagesActionRes.BasePackage)
    ) {
      this.basePackage = new GetOfferPromotionPackagesActionRes.BasePackage(
        d.basePackage || {},
      );
    ...
    if (
      !(
        d.pendingChanges instanceof
        GetOfferPromotionPackagesActionRes.PendingChanges
      )
    ) {
      this.pendingChanges =
        new GetOfferPromotionPackagesActionRes.PendingChanges(
          d.pendingChanges || {},
        );
    }
  }
   ...
   **/
  static with(
    partialDtoObject: PartialDeep<GetOfferPromotionPackagesActionResType>,
  ) {
    return new GetOfferPromotionPackagesActionRes(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<GetOfferPromotionPackagesActionResType>,
  ): InstanceType<typeof GetOfferPromotionPackagesActionRes> {
    return new GetOfferPromotionPackagesActionRes({
      ...this.toJSON(),
      ...partial,
    });
  }
