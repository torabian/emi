...
export class ModificationCommandDetailedResultAction {
  ...
  static NewUrl = (qs?: URLSearchParams) =>
    buildUrl(ModificationCommandDetailedResultAction.URL, undefined, qs);
  static Method = "get";
  static Fetch$ = async (
    qs?: URLSearchParams,
    ctx?: FetchxContext,
    ...
    return fetchx<ModificationCommandDetailedResultActionRes, unknown, unknown>(
      overrideUrl ?? ModificationCommandDetailedResultAction.NewUrl(qs),
      {
  ...
  static Fetch = async (
    init?: TypedRequestInit<unknown, unknown>,
    {
      ...
      creatorFn?:
        | ((item: unknown) => ModificationCommandDetailedResultActionRes)
        | undefined;
      qs?: URLSearchParams;
      ctx?: FetchxContext;
    ...
    creatorFn =
      creatorFn ||
      ((item) => new ModificationCommandDetailedResultActionRes(item));
...
export class ModificationCommandDetailedResultActionRes {
  ...
  set tasks(
    ...
    if (
      value.length > 0 &&
      value[0] instanceof ModificationCommandDetailedResultActionRes.Tasks
    ) {
      this.#tasks = value;
    } else {
      this.#tasks = value.map(
        (item) => new ModificationCommandDetailedResultActionRes.Tasks(item),
      );
    }
  }
  setTasks(
  ...
  #modification!: InstanceType<
    typeof ModificationCommandDetailedResultActionRes.Modification
  >;
  /**
   *
  ...
  set modification(
    ...
    if (
      value instanceof ModificationCommandDetailedResultActionRes.Modification
    ) {
      this.#modification = value;
    } else {
      this.#modification =
        new ModificationCommandDetailedResultActionRes.Modification(value);
    }
  }
  setModification(
    value: InstanceType<
  ...
  set additionalMarketplaces(
    ...
    if (
      value.length > 0 &&
      value[0] instanceof
        ModificationCommandDetailedResultActionRes.AdditionalMarketplaces
    ) {
      this.#additionalMarketplaces = value;
    } else {
      this.#additionalMarketplaces = value.map(
        (item) =>
          new ModificationCommandDetailedResultActionRes.AdditionalMarketplaces(
            item,
          ),
      );
    }
  ...
  static Tasks = class Tasks {
     ...
     **/
    #offer!: InstanceType<
      typeof ModificationCommandDetailedResultActionRes.Tasks.Offer
    >;
    /**
     *
    ...
    set offer(
      ...
      // For objects, the sub type needs to always be instance of the sub class.
      if (
        value instanceof ModificationCommandDetailedResultActionRes.Tasks.Offer
      ) {
        this.#offer = value;
      } else {
        this.#offer =
          new ModificationCommandDetailedResultActionRes.Tasks.Offer(value);
      }
    }
    setOffer(
      value: InstanceType<
    ...
    set errors(
      ...
      if (
        value.length > 0 &&
        value[0] instanceof
          ModificationCommandDetailedResultActionRes.Tasks.Errors
      ) {
        this.#errors = value;
      } else {
        this.#errors = value.map(
          (item) =>
            new ModificationCommandDetailedResultActionRes.Tasks.Errors(item),
        );
      }
    }
    setErrors(
    ...
    static Offer = class Offer {
       ...
       **/
      static from(
        possibleDtoObject: ModificationCommandDetailedResultActionResType.TasksType.OfferType,
      ) {
        return new ModificationCommandDetailedResultActionRes.Tasks.Offer(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<ModificationCommandDetailedResultActionResType.TasksType.OfferType>,
      ) {
        return new ModificationCommandDetailedResultActionRes.Tasks.Offer(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<ModificationCommandDetailedResultActionResType.TasksType.OfferType>,
      ): InstanceType<
        typeof ModificationCommandDetailedResultActionRes.Tasks.Offer
      > {
        return new ModificationCommandDetailedResultActionRes.Tasks.Offer({
    ...
    static Errors = class Errors {
      ...
      #metadata!: InstanceType<
        typeof ModificationCommandDetailedResultActionRes.Tasks.Errors.Metadata
      >;
      /**
       *
      ...
      set metadata(
        ...
        if (
          value instanceof
          ModificationCommandDetailedResultActionRes.Tasks.Errors.Metadata
        ) {
          this.#metadata = value;
        } else {
          this.#metadata =
            new ModificationCommandDetailedResultActionRes.Tasks.Errors.Metadata(
              value,
            );
        }
      }
      ...
      static Metadata = class Metadata {
         ...
         **/
        static from(
          possibleDtoObject: ModificationCommandDetailedResultActionResType.TasksType.ErrorsType.MetadataType,
        ) {
          return new ModificationCommandDetailedResultActionRes.Tasks.Errors.Metadata(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<ModificationCommandDetailedResultActionResType.TasksType.ErrorsType.MetadataType>,
        ) {
          return new ModificationCommandDetailedResultActionRes.Tasks.Errors.Metadata(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<ModificationCommandDetailedResultActionResType.TasksType.ErrorsType.MetadataType>,
        ): InstanceType<
          typeof ModificationCommandDetailedResultActionRes.Tasks.Errors.Metadata
        > {
          return new ModificationCommandDetailedResultActionRes.Tasks.Errors.Metadata(
       ...
       **/
      static from(
        possibleDtoObject: ModificationCommandDetailedResultActionResType.TasksType.ErrorsType,
      ) {
        return new ModificationCommandDetailedResultActionRes.Tasks.Errors(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<ModificationCommandDetailedResultActionResType.TasksType.ErrorsType>,
      ) {
        return new ModificationCommandDetailedResultActionRes.Tasks.Errors(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<ModificationCommandDetailedResultActionResType.TasksType.ErrorsType>,
      ): InstanceType<
        typeof ModificationCommandDetailedResultActionRes.Tasks.Errors
      > {
        return new ModificationCommandDetailedResultActionRes.Tasks.Errors({
    ...
    applyFromObject(data = {}) {
      ...
      if (d.scheduledAt !== undefined) {
        this.scheduledAt = d.scheduledAt;
      }
      if (d.finishedAt !== undefined) {
        this.finishedAt = d.finishedAt;
      }
    ...
    #lateInitFields(data = {}) {
      ...
      if (
        !(
          d.offer instanceof
          ModificationCommandDetailedResultActionRes.Tasks.Offer
        )
      ) {
        this.offer = new ModificationCommandDetailedResultActionRes.Tasks.Offer(
          d.offer || {},
        );
      }
    }
     ...
     **/
    static from(
      possibleDtoObject: ModificationCommandDetailedResultActionResType.TasksType,
    ) {
      return new ModificationCommandDetailedResultActionRes.Tasks(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<ModificationCommandDetailedResultActionResType.TasksType>,
    ) {
      return new ModificationCommandDetailedResultActionRes.Tasks(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<ModificationCommandDetailedResultActionResType.TasksType>,
    ): InstanceType<typeof ModificationCommandDetailedResultActionRes.Tasks> {
      return new ModificationCommandDetailedResultActionRes.Tasks({
        ...this.toJSON(),
        ...partial,
      });
  ...
  static Modification = class Modification {
    ...
    #basePackage!: InstanceType<
      typeof ModificationCommandDetailedResultActionRes.Modification.BasePackage
    >;
    /**
     *
    ...
    set basePackage(
      ...
      if (
        value instanceof
        ModificationCommandDetailedResultActionRes.Modification.BasePackage
      ) {
        this.#basePackage = value;
      } else {
        this.#basePackage =
          new ModificationCommandDetailedResultActionRes.Modification.BasePackage(
            value,
          );
      }
    }
    ...
    set extraPackages(
      ...
      if (
        value.length > 0 &&
        value[0] instanceof
          ModificationCommandDetailedResultActionRes.Modification.ExtraPackages
      ) {
        this.#extraPackages = value;
      } else {
        this.#extraPackages = value.map(
          (item) =>
            new ModificationCommandDetailedResultActionRes.Modification.ExtraPackages(
              item,
            ),
        );
      }
    ...
    static BasePackage = class BasePackage {
       ...
       **/
      static from(
        possibleDtoObject: ModificationCommandDetailedResultActionResType.ModificationType.BasePackageType,
      ) {
        return new ModificationCommandDetailedResultActionRes.Modification.BasePackage(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<ModificationCommandDetailedResultActionResType.ModificationType.BasePackageType>,
      ) {
        return new ModificationCommandDetailedResultActionRes.Modification.BasePackage(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<ModificationCommandDetailedResultActionResType.ModificationType.BasePackageType>,
      ): InstanceType<
        typeof ModificationCommandDetailedResultActionRes.Modification.BasePackage
      > {
        return new ModificationCommandDetailedResultActionRes.Modification.BasePackage(
    ...
    static ExtraPackages = class ExtraPackages {
       ...
       **/
      static from(
        possibleDtoObject: ModificationCommandDetailedResultActionResType.ModificationType.ExtraPackagesType,
      ) {
        return new ModificationCommandDetailedResultActionRes.Modification.ExtraPackages(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<ModificationCommandDetailedResultActionResType.ModificationType.ExtraPackagesType>,
      ) {
        return new ModificationCommandDetailedResultActionRes.Modification.ExtraPackages(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<ModificationCommandDetailedResultActionResType.ModificationType.ExtraPackagesType>,
      ): InstanceType<
        typeof ModificationCommandDetailedResultActionRes.Modification.ExtraPackages
      > {
        return new ModificationCommandDetailedResultActionRes.Modification.ExtraPackages(
      ...
      return {
        ...
        get extraPackages() {
          return withPrefix(
            ...
            ModificationCommandDetailedResultActionRes.Modification
     ...
     **/
    static from(
      possibleDtoObject: ModificationCommandDetailedResultActionResType.ModificationType,
    ) {
      return new ModificationCommandDetailedResultActionRes.Modification(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<ModificationCommandDetailedResultActionResType.ModificationType>,
    ) {
      return new ModificationCommandDetailedResultActionRes.Modification(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<ModificationCommandDetailedResultActionResType.ModificationType>,
    ): InstanceType<
      typeof ModificationCommandDetailedResultActionRes.Modification
    > {
      return new ModificationCommandDetailedResultActionRes.Modification({
  ...
  static AdditionalMarketplaces = class AdditionalMarketplaces {
     ...
     **/
    #modification!: InstanceType<
      typeof ModificationCommandDetailedResultActionRes.AdditionalMarketplaces.Modification
    >;
    /**
     *
    ...
    set modification(
      ...
      if (
        ...
        this.#modification =
          new ModificationCommandDetailedResultActionRes.AdditionalMarketplaces.Modification(
            value,
          );
      }
    }
    ...
    static Modification = class Modification {
       ...
       **/
      #basePackage!: InstanceType<
        typeof ModificationCommandDetailedResultActionRes.AdditionalMarketplaces.Modification.BasePackage
      >;
      /**
       *
      ...
      set basePackage(
        ...
        if (
          ...
          this.#basePackage =
            new ModificationCommandDetailedResultActionRes.AdditionalMarketplaces.Modification.BasePackage(
              value,
            );
        }
      }
      ...
      set extraPackages(
        ...
        if (
          ...
          value[0] instanceof
            ModificationCommandDetailedResultActionRes.AdditionalMarketplaces
              .Modification.ExtraPackages
        ) {
          this.#extraPackages = value;
        } else {
          this.#extraPackages = value.map(
            (item) =>
              new ModificationCommandDetailedResultActionRes.AdditionalMarketplaces.Modification.ExtraPackages(
                item,
              ),
          );
        }
      ...
      static BasePackage = class BasePackage {
         ...
         **/
        static from(
          possibleDtoObject: ModificationCommandDetailedResultActionResType.AdditionalMarketplacesType.ModificationType.BasePackageType,
        ) {
          return new ModificationCommandDetailedResultActionRes.AdditionalMarketplaces.Modification.BasePackage(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<ModificationCommandDetailedResultActionResType.AdditionalMarketplacesType.ModificationType.BasePackageType>,
        ) {
          return new ModificationCommandDetailedResultActionRes.AdditionalMarketplaces.Modification.BasePackage(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<ModificationCommandDetailedResultActionResType.AdditionalMarketplacesType.ModificationType.BasePackageType>,
        ): InstanceType<
          typeof ModificationCommandDetailedResultActionRes.AdditionalMarketplaces.Modification.BasePackage
        > {
          return new ModificationCommandDetailedResultActionRes.AdditionalMarketplaces.Modification.BasePackage(
      ...
      static ExtraPackages = class ExtraPackages {
         ...
         **/
        static from(
          possibleDtoObject: ModificationCommandDetailedResultActionResType.AdditionalMarketplacesType.ModificationType.ExtraPackagesType,
        ) {
          return new ModificationCommandDetailedResultActionRes.AdditionalMarketplaces.Modification.ExtraPackages(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<ModificationCommandDetailedResultActionResType.AdditionalMarketplacesType.ModificationType.ExtraPackagesType>,
        ) {
          return new ModificationCommandDetailedResultActionRes.AdditionalMarketplaces.Modification.ExtraPackages(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<ModificationCommandDetailedResultActionResType.AdditionalMarketplacesType.ModificationType.ExtraPackagesType>,
        ): InstanceType<
          typeof ModificationCommandDetailedResultActionRes.AdditionalMarketplaces.Modification.ExtraPackages
        > {
          return new ModificationCommandDetailedResultActionRes.AdditionalMarketplaces.Modification.ExtraPackages(
        ...
        return {
          ...
          get basePackage() {
            return withPrefix(
              ...
              ModificationCommandDetailedResultActionRes.AdditionalMarketplaces
                .Modification.BasePackage.Fields,
            );
          },
          extraPackages$: "extraPackages",
          get extraPackages() {
            return withPrefix(
              ...
              ModificationCommandDetailedResultActionRes.AdditionalMarketplaces
                .Modification.ExtraPackages.Fields,
            );
          },
          modificationTime: "modificationTime",
        };
       ...
       **/
      static from(
        possibleDtoObject: ModificationCommandDetailedResultActionResType.AdditionalMarketplacesType.ModificationType,
      ) {
        return new ModificationCommandDetailedResultActionRes.AdditionalMarketplaces.Modification(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<ModificationCommandDetailedResultActionResType.AdditionalMarketplacesType.ModificationType>,
      ) {
        return new ModificationCommandDetailedResultActionRes.AdditionalMarketplaces.Modification(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<ModificationCommandDetailedResultActionResType.AdditionalMarketplacesType.ModificationType>,
      ): InstanceType<
        typeof ModificationCommandDetailedResultActionRes.AdditionalMarketplaces.Modification
      > {
        return new ModificationCommandDetailedResultActionRes.AdditionalMarketplaces.Modification(
     ...
     **/
    static from(
      possibleDtoObject: ModificationCommandDetailedResultActionResType.AdditionalMarketplacesType,
    ) {
      return new ModificationCommandDetailedResultActionRes.AdditionalMarketplaces(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<ModificationCommandDetailedResultActionResType.AdditionalMarketplacesType>,
    ) {
      return new ModificationCommandDetailedResultActionRes.AdditionalMarketplaces(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<ModificationCommandDetailedResultActionResType.AdditionalMarketplacesType>,
    ): InstanceType<
      typeof ModificationCommandDetailedResultActionRes.AdditionalMarketplaces
    > {
      return new ModificationCommandDetailedResultActionRes.AdditionalMarketplaces(
  ...
  #lateInitFields(data = {}) {
    ...
    if (
      ...
      this.modification =
        new ModificationCommandDetailedResultActionRes.Modification(
          d.modification || {},
        );
    }
  }
   ...
   **/
  static from(
    possibleDtoObject: ModificationCommandDetailedResultActionResType,
  ) {
   ...
   **/
  static with(
    partialDtoObject: PartialDeep<ModificationCommandDetailedResultActionResType>,
  ) {
    return new ModificationCommandDetailedResultActionRes(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<ModificationCommandDetailedResultActionResType>,
  ): InstanceType<typeof ModificationCommandDetailedResultActionRes> {
    return new ModificationCommandDetailedResultActionRes({
      ...this.toJSON(),
      ...partial,
    });
  }
