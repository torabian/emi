...
export class CheckTheProcessingStatusOfAPOSTOrPATCHRequestAction {
  ...
  static Fetch$ = async (
    ...
    >(
      overrideUrl ??
        CheckTheProcessingStatusOfAPOSTOrPATCHRequestAction.NewUrl(qs),
      {
  ...
  static Fetch = async (
    init?: TypedRequestInit<unknown, unknown>,
    {
      ...
      creatorFn: (item) =>
        new CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes(item),
    },
  ) => {
    creatorFn =
      creatorFn ||
      ((item) =>
        new CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes(item));
    const res =
      await CheckTheProcessingStatusOfAPOSTOrPATCHRequestAction.Fetch$(
        qs,
        ctx,
        init,
        overrideUrl,
...
export class CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes {
   ...
   **/
  #offer!: InstanceType<
    typeof CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes.Offer
  >;
  /**
   *
  ...
  set offer(
    ...
    if (
      value instanceof
      CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes.Offer
    ) {
      this.#offer = value;
    } else {
      this.#offer =
        new CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes.Offer(value);
    }
  }
  setOffer(
    value: InstanceType<
  ...
  #operation!: InstanceType<
    typeof CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes.Operation
  >;
  /**
   *
  ...
  set operation(
    ...
    if (
      value instanceof
      CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes.Operation
    ) {
      this.#operation = value;
    } else {
      this.#operation =
        new CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes.Operation(
          value,
        );
    }
  }
  ...
  static Offer = class Offer {
     ...
     **/
    static from(
      possibleDtoObject: CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionResType.OfferType,
    ) {
      return new CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes.Offer(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionResType.OfferType>,
    ) {
      return new CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes.Offer(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionResType.OfferType>,
    ): InstanceType<
      typeof CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes.Offer
    > {
      return new CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes.Offer({
  ...
  static Operation = class Operation {
     ...
     **/
    static from(
      possibleDtoObject: CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionResType.OperationType,
    ) {
      return new CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes.Operation(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionResType.OperationType>,
    ) {
      return new CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes.Operation(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionResType.OperationType>,
    ): InstanceType<
      typeof CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes.Operation
    > {
      return new CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes.Operation(
  ...
  applyFromObject(data = {}) {
    const d =
      data as Partial<CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes>;
    if (d.offer !== undefined) {
      this.offer = d.offer;
    }
    if (d.operation !== undefined) {
  ...
  #lateInitFields(data = {}) {
    ...
    if (
      ...
      this.offer =
        new CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes.Offer(
          d.offer || {},
        );
    }
    if (
      !(
        d.operation instanceof
        CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes.Operation
      )
    ) {
      this.operation =
   ...
   **/
  static from(
    possibleDtoObject: CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionResType,
  ) {
    return new CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes(
      possibleDtoObject,
    );
  }
  /**
   ...
   **/
  static with(
    partialDtoObject: PartialDeep<CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionResType>,
  ) {
    return new CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes(
      partialDtoObject,
    );
  ...
  copyWith(
    partial: PartialDeep<CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionResType>,
  ): InstanceType<
    typeof CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes
  > {
    return new CheckTheProcessingStatusOfAPOSTOrPATCHRequestActionRes({
      ...this.toJSON(),
      ...partial,
