...
export class UpdateOfferTranslationAction {
  ...
  static NewUrl = (qs?: URLSearchParams) =>
    buildUrl(UpdateOfferTranslationAction.URL, undefined, qs);
  static Method = "patch";
  static Fetch$ = async (
    qs?: URLSearchParams,
    ctx?: FetchxContext,
    ...
    return fetchx<unknown, UpdateOfferTranslationActionReq, unknown>(
      overrideUrl ?? UpdateOfferTranslationAction.NewUrl(qs),
      {
...
export class UpdateOfferTranslationActionReq {
  ...
  #description!: InstanceType<
    typeof UpdateOfferTranslationActionReq.Description
  >;
  /**
   *
   ...
   **/
  set description(
    value: InstanceType<typeof UpdateOfferTranslationActionReq.Description>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof UpdateOfferTranslationActionReq.Description) {
      this.#description = value;
    } else {
      this.#description = new UpdateOfferTranslationActionReq.Description(
        value,
      );
    }
  }
  ...
  #safetyInformation!: InstanceType<
    typeof UpdateOfferTranslationActionReq.SafetyInformation
  >;
  /**
   *
  ...
  set safetyInformation(
    ...
    if (value instanceof UpdateOfferTranslationActionReq.SafetyInformation) {
      ...
      this.#safetyInformation =
        new UpdateOfferTranslationActionReq.SafetyInformation(value);
    }
  }
  ...
  static Description = class Description {
    ...
    #translation!: InstanceType<
      typeof UpdateOfferTranslationActionReq.Description.Translation
    >;
    /**
     *
    ...
    set translation(
      ...
      // For objects, the sub type needs to always be instance of the sub class.
      if (
        value instanceof UpdateOfferTranslationActionReq.Description.Translation
      ) {
        this.#translation = value;
      } else {
        this.#translation =
          new UpdateOfferTranslationActionReq.Description.Translation(value);
      }
    }
    setTranslation(
      value: InstanceType<
    ...
    static Translation = class Translation {
      ...
      set sections(
        ...
        if (
          value.length > 0 &&
          value[0] instanceof
            UpdateOfferTranslationActionReq.Description.Translation.Sections
        ) {
          this.#sections = value;
        } else {
          this.#sections = value.map(
            (item) =>
              new UpdateOfferTranslationActionReq.Description.Translation.Sections(
                item,
              ),
          );
        }
      ...
      static Sections = class Sections {
        ...
        set items(
          ...
          if (
            ...
            this.#items = value.map(
              (item) =>
                new UpdateOfferTranslationActionReq.Description.Translation.Sections.Items(
                  item,
                ),
            );
          }
        ...
        static Items = class Items {
           ...
           **/
          static from(
            possibleDtoObject: UpdateOfferTranslationActionReqType.DescriptionType.TranslationType.SectionsType.ItemsType,
          ) {
            return new UpdateOfferTranslationActionReq.Description.Translation.Sections.Items(
              possibleDtoObject,
            );
          }
          /**
           ...
           **/
          static with(
            partialDtoObject: PartialDeep<UpdateOfferTranslationActionReqType.DescriptionType.TranslationType.SectionsType.ItemsType>,
          ) {
            return new UpdateOfferTranslationActionReq.Description.Translation.Sections.Items(
              partialDtoObject,
            );
          ...
          copyWith(
            partial: PartialDeep<UpdateOfferTranslationActionReqType.DescriptionType.TranslationType.SectionsType.ItemsType>,
          ): InstanceType<
            typeof UpdateOfferTranslationActionReq.Description.Translation.Sections.Items
          > {
            return new UpdateOfferTranslationActionReq.Description.Translation.Sections.Items(
         ...
         **/
        static from(
          possibleDtoObject: UpdateOfferTranslationActionReqType.DescriptionType.TranslationType.SectionsType,
        ) {
          return new UpdateOfferTranslationActionReq.Description.Translation.Sections(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<UpdateOfferTranslationActionReqType.DescriptionType.TranslationType.SectionsType>,
        ) {
          return new UpdateOfferTranslationActionReq.Description.Translation.Sections(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<UpdateOfferTranslationActionReqType.DescriptionType.TranslationType.SectionsType>,
        ): InstanceType<
          typeof UpdateOfferTranslationActionReq.Description.Translation.Sections
        > {
          return new UpdateOfferTranslationActionReq.Description.Translation.Sections(
       ...
       **/
      static from(
        possibleDtoObject: UpdateOfferTranslationActionReqType.DescriptionType.TranslationType,
      ) {
        return new UpdateOfferTranslationActionReq.Description.Translation(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<UpdateOfferTranslationActionReqType.DescriptionType.TranslationType>,
      ) {
        return new UpdateOfferTranslationActionReq.Description.Translation(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<UpdateOfferTranslationActionReqType.DescriptionType.TranslationType>,
      ): InstanceType<
        typeof UpdateOfferTranslationActionReq.Description.Translation
      > {
        return new UpdateOfferTranslationActionReq.Description.Translation({
    ...
    #lateInitFields(data = {}) {
      ...
      if (
        !(
          ...
          UpdateOfferTranslationActionReq.Description.Translation
        )
      ) {
        this.translation =
          new UpdateOfferTranslationActionReq.Description.Translation(
            d.translation || {},
          );
      }
    }
     ...
     **/
    static from(
      possibleDtoObject: UpdateOfferTranslationActionReqType.DescriptionType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<UpdateOfferTranslationActionReqType.DescriptionType>,
    ) {
      return new UpdateOfferTranslationActionReq.Description(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<UpdateOfferTranslationActionReqType.DescriptionType>,
    ): InstanceType<typeof UpdateOfferTranslationActionReq.Description> {
      return new UpdateOfferTranslationActionReq.Description({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static Title = class Title {
     ...
     **/
    static from(
      possibleDtoObject: UpdateOfferTranslationActionReqType.TitleType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<UpdateOfferTranslationActionReqType.TitleType>,
    ) {
      return new UpdateOfferTranslationActionReq.Title(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<UpdateOfferTranslationActionReqType.TitleType>,
    ): InstanceType<typeof UpdateOfferTranslationActionReq.Title> {
      return new UpdateOfferTranslationActionReq.Title({
        ...this.toJSON(),
        ...partial,
      });
    }
  ...
  static SafetyInformation = class SafetyInformation {
    ...
    set products(
      ...
      if (
        value.length > 0 &&
        value[0] instanceof
          UpdateOfferTranslationActionReq.SafetyInformation.Products
      ) {
        this.#products = value;
      } else {
        this.#products = value.map(
          (item) =>
            new UpdateOfferTranslationActionReq.SafetyInformation.Products(
              item,
            ),
        );
      }
    ...
    static Products = class Products {
       ...
       **/
      static from(
        possibleDtoObject: UpdateOfferTranslationActionReqType.SafetyInformationType.ProductsType,
      ) {
        return new UpdateOfferTranslationActionReq.SafetyInformation.Products(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<UpdateOfferTranslationActionReqType.SafetyInformationType.ProductsType>,
      ) {
        return new UpdateOfferTranslationActionReq.SafetyInformation.Products(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<UpdateOfferTranslationActionReqType.SafetyInformationType.ProductsType>,
      ): InstanceType<
        typeof UpdateOfferTranslationActionReq.SafetyInformation.Products
      > {
        return new UpdateOfferTranslationActionReq.SafetyInformation.Products({
     ...
     **/
    static from(
      possibleDtoObject: UpdateOfferTranslationActionReqType.SafetyInformationType,
    ) {
      return new UpdateOfferTranslationActionReq.SafetyInformation(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<UpdateOfferTranslationActionReqType.SafetyInformationType>,
    ) {
      return new UpdateOfferTranslationActionReq.SafetyInformation(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<UpdateOfferTranslationActionReqType.SafetyInformationType>,
  ...
  #lateInitFields(data = {}) {
    const d = data as Partial<UpdateOfferTranslationActionReq>;
    if (
      !(d.description instanceof UpdateOfferTranslationActionReq.Description)
    ) {
      this.description = new UpdateOfferTranslationActionReq.Description(
        d.description || {},
      );
    }
    if (!(d.title instanceof UpdateOfferTranslationActionReq.Title)) {
      this.title = new UpdateOfferTranslationActionReq.Title(d.title || {});
    }
    if (
      !(
        d.safetyInformation instanceof
        UpdateOfferTranslationActionReq.SafetyInformation
      )
    ) {
      this.safetyInformation =
        new UpdateOfferTranslationActionReq.SafetyInformation(
          d.safetyInformation || {},
        );
    }
  }
   ...
   **/
  static with(
    partialDtoObject: PartialDeep<UpdateOfferTranslationActionReqType>,
  ) {
    return new UpdateOfferTranslationActionReq(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<UpdateOfferTranslationActionReqType>,
  ): InstanceType<typeof UpdateOfferTranslationActionReq> {
    return new UpdateOfferTranslationActionReq({
      ...this.toJSON(),
      ...partial,
    });
  }
