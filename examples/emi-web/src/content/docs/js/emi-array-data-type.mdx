...
export class MyArrayClassDto {
  ...
  static Contacts = class Contacts {
     ...
     **/
    toJSON(): MyArrayClassDtoType.ContactsType {
      return {
        email: this.#toPlainJSON(this.#email),
        phone: this.#toPlainJSON(this.#phone),
      } as MyArrayClassDtoType.ContactsType;
    }
    /**
   ...
   *	class gets, rather than a shallow object still holding class instances.
   **/
  toJSON(): MyArrayClassDtoType {
    return {
      contacts: this.#toPlainJSON(this.#contacts),
    } as MyArrayClassDtoType;
  }
  /**
   * Resolves value into a plain, JSON-serializable value: recurses into
   * arrays, and - the case JSON.stringify's own recursion would only get to
...
export class MyArrayClassDto {
  ...
  set nullableTags(
    ...
    if (value === null || value === undefined) {
      this.#nullableTags = value === null ? null : undefined;
      return;
    }
    // When the passed value is already an array, we check if we need to
    // cast the inner items into class instance.
  ...
  /**
   * The base class definition for nullableTags
   **/
  static NullableTags = class NullableTags {
    constructor(data: unknown = undefined) {
      if (data === null || data === undefined) {
        return;
      }
     ...
     **/
    applyFromObject(data = {}) {
      const d = data as Partial<NullableTags>;
    }
    /**
     *	Special toJSON override, since the field are private,
     *	Json stringify won't see them unless we mention it explicitly. Each
     ...
     *	class gets, rather than a shallow object still holding class instances.
     **/
    toJSON(): MyArrayClassDtoType.NullableTagsType {
      return {} as MyArrayClassDtoType.NullableTagsType;
    }
    /**
     * Resolves value into a plain, JSON-serializable value: recurses into
     * arrays, and - the case JSON.stringify's own recursion would only get to
    ...
    /**
     * Creates an instance of MyArrayClassDto.NullableTags, and possibleDtoObject
     * needs to satisfy the type requirement fully, otherwise typescript compile would
     * be complaining.
     **/
    static from(possibleDtoObject: MyArrayClassDtoType.NullableTagsType) {
      return new MyArrayClassDto.NullableTags(possibleDtoObject);
    }
    /**
     * Creates an instance of MyArrayClassDto.NullableTags, and partialDtoObject
     * needs to satisfy the type, but partially, and rest of the content would
     * be constructed according to data types and nullability.
     **/
    static with(
      partialDtoObject: PartialDeep<MyArrayClassDtoType.NullableTagsType>,
    ) {
      return new MyArrayClassDto.NullableTags(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<MyArrayClassDtoType.NullableTagsType>,
    ): InstanceType<typeof MyArrayClassDto.NullableTags> {
      return new MyArrayClassDto.NullableTags({ ...this.toJSON(), ...partial });
    }
    clone(): InstanceType<typeof MyArrayClassDto.NullableTags> {
      return new MyArrayClassDto.NullableTags(this.toJSON());
    }
  };
  constructor(data: unknown = undefined) {
    if (data === null || data === undefined) {
  ...
  toJSON(): MyArrayClassDtoType {
    return {
      nullableTags: this.#toPlainJSON(this.#nullableTags),
    } as MyArrayClassDtoType;
  }
  /**
   * Resolves value into a plain, JSON-serializable value: recurses into
...
export namespace MyArrayClassDtoType {
  /**
   * The base type definition for nullableTagsType
   **/
  export type NullableTagsType = {};
  // eslint-disable-next-line @typescript-eslint/no-namespace
