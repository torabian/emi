 ...
 * @typedef {Object} AnonymouseType.LoginHistoryType.DataType
 * @property {string} ipAddress
 */
/**
 * The base type definition for loginHistoryType
 * @typedef {Object} AnonymouseType.LoginHistoryType
 * @property {string} time
 * @property {AnonymouseType.LoginHistoryType.DataType} data
 */
/**
 * The base type definition for anonymouse
 * @typedef {Object} AnonymouseType
 * @property {string} firstName
 * @property {AnonymouseType.LoginHistoryType[]} loginHistory
 */
/**
...
export class Anonymouse {
  ...
  set loginHistory(value) {
    ...
    if (Array.isArray(value)) {
      if (value.length > 0 && value[0] instanceof Anonymouse.LoginHistory) {
        this.#loginHistory = MArray.of(value);
      } else {
        this.#loginHistory = MArray.of(
          value.map((item) => new Anonymouse.LoginHistory(item)),
        );
      }
      return;
    }
    ...
    if (ok) {
      this.#loginHistory = mcastValue;
      return;
    }
    console.warn(
      "Cannot assing value to loginHistory, because it needs MArray instance or an Array.",
    );
  }
  ...
  static LoginHistory = class LoginHistory {
    ...
    static Data = class Data {
      ...
      toJSON() {
        return {
          ipAddress: this.#toPlainJSON(this.#ipAddress),
        };
      }
      /**
    ...
    toJSON() {
      return {
        time: this.#toPlainJSON(this.#time),
        data: this.#toPlainJSON(this.#data),
      };
    }
    /**
     * Resolves value into a plain, JSON-serializable value: recurses into
  ...
  toJSON() {
    return {
      ...
      loginHistory: this.#toPlainJSON(this.#loginHistory),
    };
  }
  /**
   * Resolves value into a plain, JSON-serializable value: recurses into
