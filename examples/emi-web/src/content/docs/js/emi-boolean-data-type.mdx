...
export class MyBoolClassDto {
   ...
   **/
  toJSON(): MyBoolClassDtoType {
    return {
      boolWithDefault: this.#toPlainJSON(this.#boolWithDefault),
      plainBool: this.#toPlainJSON(this.#plainBool),
    } as MyBoolClassDtoType;
  }
  /**
...
export class MyBoolClassDto {
   ...
   * @type {boolean}
   **/
  #nullableBoolWithDefault?: boolean | null | undefined = true;
  /**
   *
   * @returns {boolean}
   **/
   ...
   * @type {boolean}
   **/
  #nullableBoolWithoutDefault?: boolean | null | undefined = undefined;
  /**
   *
   * @returns {boolean}
   **/
  ...
  toJSON(): MyBoolClassDtoType {
    return {
      nullableBoolWithDefault: this.#toPlainJSON(this.#nullableBoolWithDefault),
      nullableBoolWithoutDefault: this.#toPlainJSON(
        this.#nullableBoolWithoutDefault,
      ),
    } as MyBoolClassDtoType;
  }
  /**
