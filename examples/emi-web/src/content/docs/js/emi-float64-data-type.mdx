...
export class MyFloatClassDto {
   ...
   **/
  toJSON(): MyFloatClassDtoType {
    return {
      floatWithDefault: this.#toPlainJSON(this.#floatWithDefault),
      plainFloat: this.#toPlainJSON(this.#plainFloat),
    } as MyFloatClassDtoType;
  }
  /**
...
export class MyFloatClassDto {
   ...
   * @type {number}
   **/
  #nullableFloatWithDefault?: number | null | undefined = 1.23;
  /**
   *
   * @returns {number}
   **/
   ...
   * @type {number}
   **/
  #nullableFloatWithoutDefault?: number | null | undefined = undefined;
  /**
   *
   * @returns {number}
   **/
  ...
  toJSON(): MyFloatClassDtoType {
    return {
      nullableFloatWithDefault: this.#toPlainJSON(
        this.#nullableFloatWithDefault,
      ),
      nullableFloatWithoutDefault: this.#toPlainJSON(
        this.#nullableFloatWithoutDefault,
      ),
    } as MyFloatClassDtoType;
  }
  /**
