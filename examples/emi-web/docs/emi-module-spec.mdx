...
| `vsqls` | `array` | Typed virtual SQL queries. Each entry pairs a raw SQL string with a typed parameter struct that Emi generates. |
| `templates` | `undefined` | Reusable shape definitions (dtos |