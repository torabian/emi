 ...
 */
struct Entity2CreateActionMeta {
    let name: String = "Entity2CreateAction"
    let url: String = "/entity2"
    let method: String = "POST"
}
/*
 struct Entity2CreateActionRequest {
     // reserved
 }
 */
struct Entity2CreateActionResponse {
    let statusCode: Int
...
final class Entity2CreateActionClient {
    ...
    static func compute(
        ...
        headers: [String: String] = [:],
        body: Data? = nil
    ) async throws -> Entity2CreateActionResponse {
        let meta = Entity2CreateActionMeta()
