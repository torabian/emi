 ...
 */
struct Entity1CreateActionMeta {
    let name: String = "Entity1CreateAction"
    let url: String = "/entity1"
    let method: String = "POST"
}
/*
 struct Entity1CreateActionRequest {
     // reserved
 }
 */
struct Entity1CreateActionResponse {
    let statusCode: Int
...
final class Entity1CreateActionClient {
    ...
    static func compute(
        ...
        headers: [String: String] = [:],
        body: Data? = nil
    ) async throws -> Entity1CreateActionResponse {
        let meta = Entity1CreateActionMeta()
