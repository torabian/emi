 ...
 */
struct Entity2AwareDeleteActionMeta {
    let name: String = "Entity2AwareDeleteAction"
    let url: String = "/entity2/delete"
    let method: String = "POST"
}
/*
 struct Entity2AwareDeleteActionRequest {
     // reserved
 }
 */
struct Entity2AwareDeleteActionResponse {
    let statusCode: Int
...
final class Entity2AwareDeleteActionClient {
    ...
    static func compute(
        ...
        headers: [String: String] = [:],
        body: Data? = nil
    ) async throws -> Entity2AwareDeleteActionResponse {
        let meta = Entity2AwareDeleteActionMeta()
...
struct Entity2AwareDeleteActionReq: Codable {
