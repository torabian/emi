 ...
 */
struct Entity1AwareDeleteActionMeta {
    let name: String = "Entity1AwareDeleteAction"
    let url: String = "/entity1/delete"
    let method: String = "POST"
}
/*
 struct Entity1AwareDeleteActionRequest {
     // reserved
 }
 */
struct Entity1AwareDeleteActionResponse {
    let statusCode: Int
...
final class Entity1AwareDeleteActionClient {
    ...
    static func compute(
        ...
        headers: [String: String] = [:],
        body: Data? = nil
    ) async throws -> Entity1AwareDeleteActionResponse {
        let meta = Entity1AwareDeleteActionMeta()
...
struct Entity1AwareDeleteActionReq: Codable {
