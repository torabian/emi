...
func Entity1UpdateActionCliFlags() []cli.Flag {
	...
	flags = append(flags, emigo.CastEmiFlagToUrfave(GetEntity1OptionalDtoCliFlags(""))...)
...
func Entity1UpdateActionCliHandler(
	...
	cmd.Action = func(ctx context.Context, c *cli.Command) error {
		req := Entity1UpdateActionRequest{
			...
			Body:        CastEntity1OptionalDtoFromCli(c),
...
// returns either an *Entity1UpdateActionResponse or nil. Body binding, headers, status
