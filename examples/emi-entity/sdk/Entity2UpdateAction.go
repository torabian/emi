...
func Entity2UpdateActionCliFlags() []cli.Flag {
	...
	flags = append(flags, emigo.CastEmiFlagToUrfave(GetEntity2OptionalDtoCliFlags(""))...)
...
func Entity2UpdateActionCliHandler(
	...
	cmd.Action = func(ctx context.Context, c *cli.Command) error {
		req := Entity2UpdateActionRequest{
			...
			Body:        CastEntity2OptionalDtoFromCli(c),
...
// returns either an *Entity2UpdateActionResponse or nil. Body binding, headers, status
