...
func Entity3CreateActionCliFlags() []cli.Flag {
	...
	flags = append(flags, emigo.CastEmiFlagToUrfave(GetEntity3DtoCliFlags(""))...)
	return flags
}
...
// returns either an *Entity3CreateActionResponse or nil. Body binding, headers, status
