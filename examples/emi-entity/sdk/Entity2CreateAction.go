...
func Entity2CreateActionCliFlags() []cli.Flag {
	...
	flags = append(flags, emigo.CastEmiFlagToUrfave(GetEntity2DtoCliFlags(""))...)
	return flags
}
...
// returns either an *Entity2CreateActionResponse or nil. Body binding, headers, status
