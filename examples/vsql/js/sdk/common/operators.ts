...
export class OneNullable<T, S = unknown> extends One<T, S> {}
...
export class ArrayNullable<T> extends Array<T> {}
...
export class CollectionNullable<T> extends Collection<T> {}
