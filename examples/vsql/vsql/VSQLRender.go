...
// Render parses the named file from fsys as a Go template with the SQL helpers
// registered (sqlFields, sqlFieldsExcept, sql, deref) and executes it against
// params.
func Render(fsys fs.FS, name string, params any) (string, error) {
