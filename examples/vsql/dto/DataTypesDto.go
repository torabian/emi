...
func CastDataTypesDtoFromCli(c emigo.CliCastable) DataTypesDto {
 ...
 data.ArrayFieldNullable = emigo.CapturePossibleArrayNullable(CastDataTypesDtoArrayFieldNullableFromCli, "array-field-nullable", c) 
 }
 ...
 if u, ok := any(&data.ComplexField).(encoding.TextUnmarshaler); ok { u.UnmarshalText([]byte(c.String("complex-field"))) } 
}
 ...
 data.CollectionRefNullable = emigo. CapturePossibleCollectionNullable(emigo. CastCollectionNullable[CreateUserDtoTags]FromCli, "collection-ref-nullable", c) 
 }
	return data
}
...
type DataTypesDto struct {
		...
		CollectionRefNullable emigo.Nullable[emigo.CollectionNullable[CreateUserDtoTags]] `json:"collectionRefNullable" yaml:"collectionRefNullable"`
}
