 ...
 **/
export class InsertUsersVsqlRow {
  /**
   ...
   * @type {InsertUsersVsqlRow.Profile}
   **/
  #profile!: InstanceType<typeof InsertUsersVsqlRow.Profile>;
  /**
   * Selected by default - stays the plain nested struct.
   * @returns {InsertUsersVsqlRow.Profile}
   **/
  get profile() {
    return this.#profile;
  }
   ...
   * @type {InsertUsersVsqlRow.Profile}
   **/
  set profile(value: InstanceType<typeof InsertUsersVsqlRow.Profile>) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof InsertUsersVsqlRow.Profile) {
      this.#profile = value;
    } else {
      this.#profile = new InsertUsersVsqlRow.Profile(value);
    }
  }
  setProfile(value: InstanceType<typeof InsertUsersVsqlRow.Profile>) {
    this.profile = value;
    return this;
  }
  /**
   ...
   * @type {InsertUsersVsqlRow.Preferences}
   **/
  #preferences?:
    | InstanceType<typeof InsertUsersVsqlRow.Preferences>
    | null
    | undefined = undefined;
  /**
   * Off by default - becomes emigo.Nullable[InsertUsersVsqlRowPreferences], not just a plain nested struct with zero values, so "not fetched" is distinguishable from "fetched, all fields empty".
   * @returns {InsertUsersVsqlRow.Preferences}
   **/
  get preferences() {
  ...
  set preferences(
    ...
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof InsertUsersVsqlRow.Preferences) {
      this.#preferences = value;
    } else {
      this.#preferences = new InsertUsersVsqlRow.Preferences(value);
    }
  }
  setPreferences(
    value:
  ...
  static Profile = class Profile {
     ...
     **/
    toJSON(): InsertUsersVsqlRowType.ProfileType {
      return {
        bio: this.#toPlainJSON(this.#bio),
      } as InsertUsersVsqlRowType.ProfileType;
    }
    /**
    ...
    /**
     * Creates an instance of InsertUsersVsqlRow.Profile, and possibleDtoObject
     * needs to satisfy the type requirement fully, otherwise typescript compile would
     * be complaining.
     **/
    static from(possibleDtoObject: InsertUsersVsqlRowType.ProfileType) {
      return new InsertUsersVsqlRow.Profile(possibleDtoObject);
    }
    /**
     * Creates an instance of InsertUsersVsqlRow.Profile, and partialDtoObject
     * needs to satisfy the type, but partially, and rest of the content would
     * be constructed according to data types and nullability.
     **/
    static with(
      partialDtoObject: PartialDeep<InsertUsersVsqlRowType.ProfileType>,
    ) {
      return new InsertUsersVsqlRow.Profile(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<InsertUsersVsqlRowType.ProfileType>,
    ): InstanceType<typeof InsertUsersVsqlRow.Profile> {
      return new InsertUsersVsqlRow.Profile({ ...this.toJSON(), ...partial });
    }
    clone(): InstanceType<typeof InsertUsersVsqlRow.Profile> {
      return new InsertUsersVsqlRow.Profile(this.toJSON());
    }
  };
  /**
  ...
  static Preferences = class Preferences {
     ...
     *	class gets, rather than a shallow object still holding class instances.
     **/
    toJSON(): InsertUsersVsqlRowType.PreferencesType {
      return {
        theme: this.#toPlainJSON(this.#theme),
        locale: this.#toPlainJSON(this.#locale),
      } as InsertUsersVsqlRowType.PreferencesType;
    }
    /**
     * Resolves value into a plain, JSON-serializable value: recurses into
     * arrays, and - the case JSON.stringify's own recursion would only get to
    ...
    /**
     * Creates an instance of InsertUsersVsqlRow.Preferences, and possibleDtoObject
     * needs to satisfy the type requirement fully, otherwise typescript compile would
     * be complaining.
     **/
    static from(possibleDtoObject: InsertUsersVsqlRowType.PreferencesType) {
      return new InsertUsersVsqlRow.Preferences(possibleDtoObject);
    }
    /**
     * Creates an instance of InsertUsersVsqlRow.Preferences, and partialDtoObject
     * needs to satisfy the type, but partially, and rest of the content would
     * be constructed according to data types and nullability.
     **/
    static with(
      partialDtoObject: PartialDeep<InsertUsersVsqlRowType.PreferencesType>,
    ) {
      return new InsertUsersVsqlRow.Preferences(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<InsertUsersVsqlRowType.PreferencesType>,
    ): InstanceType<typeof InsertUsersVsqlRow.Preferences> {
      return new InsertUsersVsqlRow.Preferences({
        ...this.toJSON(),
        ...partial,
      });
    }
    clone(): InstanceType<typeof InsertUsersVsqlRow.Preferences> {
      return new InsertUsersVsqlRow.Preferences(this.toJSON());
    }
  };
  constructor(data: unknown = undefined) {
    if (data === null || data === undefined) {
   ...
   **/
  applyFromObject(data = {}) {
    const d = data as Partial<InsertUsersVsqlRow>;
    if (d.id !== undefined) {
      this.id = d.id;
    }
  ...
  #lateInitFields(data = {}) {
    const d = data as Partial<InsertUsersVsqlRow>;
    if (!(d.profile instanceof InsertUsersVsqlRow.Profile)) {
      this.profile = new InsertUsersVsqlRow.Profile(d.profile || {});
    }
  }
  /**
   *	Special toJSON override, since the field are private,
  ...
  static get Fields() {
    return {
      ...
      profile$: "profile",
      get profile() {
        return withPrefix("profile", InsertUsersVsqlRow.Profile.Fields);
      },
      preferences$: "preferences",
      get preferences() {
        return withPrefix("preferences", InsertUsersVsqlRow.Preferences.Fields);
      },
      money: "money",
    };
  }
  /**
   * Creates an instance of InsertUsersVsqlRow, and possibleDtoObject
   * needs to satisfy the type requirement fully, otherwise typescript compile would
   * be complaining.
   **/
  static from(possibleDtoObject: InsertUsersVsqlRowType) {
    return new InsertUsersVsqlRow(possibleDtoObject);
  }
  /**
   * Creates an instance of InsertUsersVsqlRow, and partialDtoObject
   * needs to satisfy the type, but partially, and rest of the content would
   * be constructed according to data types and nullability.
   **/
  static with(partialDtoObject: PartialDeep<InsertUsersVsqlRowType>) {
    return new InsertUsersVsqlRow(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<InsertUsersVsqlRowType>,
  ): InstanceType<typeof InsertUsersVsqlRow> {
    return new InsertUsersVsqlRow({ ...this.toJSON(), ...partial });
  }
  clone(): InstanceType<typeof InsertUsersVsqlRow> {
    return new InsertUsersVsqlRow(this.toJSON());
  }
}
export abstract class InsertUsersVsqlRowFactory {
  abstract create(data: unknown): InsertUsersVsqlRow;
}
/**
 * The base type definition for insertUsersVsqlRow
 **/
export type InsertUsersVsqlRowType = {
  /**
   * Primary key. Selected by default - stays a plain int64.
   * @type {number}
   **/
  ...
  /**
   * Selected by default - stays the plain nested struct.
   * @type {InsertUsersVsqlRowType.ProfileType}
   **/
  profile: InsertUsersVsqlRowType.ProfileType;
  /**
   * Off by default - becomes emigo.Nullable[InsertUsersVsqlRowPreferences], not just a plain nested struct with zero values, so "not fetched" is distinguishable from "fetched, all fields empty".
   * @type {InsertUsersVsqlRowType.PreferencesType}
   **/
  preferences?: InsertUsersVsqlRowType.PreferencesType;
  /**
   * Demonstrates a complex column spanning two physical SQL columns under one projection/selection toggle - see sdkgen/money.go. `complex` has no wire-level nullability of its own (unlike a primitive or object), so being off by default only flips its type to `complex?`, a no-op for the Go backend - Money is responsible for its own optionality (see Money.SQLValue).
   * @type {PlainOf<Money>}
   **/
...
export namespace InsertUsersVsqlRowType {
  /**
