...
export class CommonVectorResponseDto {
  ...
  applyFromObject(data = {}) {
    const d = data as Partial<CommonVectorResponseDto>;
  ...
  #lateInitFields(data = {}) {
    const d = data as Partial<CommonVectorResponseDto>;
    if (!(d.request instanceof CommonVectorComputeDto)) {
      this.request = new CommonVectorComputeDto(d.request || {});
    }
  }
  /**
  ...
  static get Fields() {
    return {
      ...
      request$: "request",
      get request() {
        return withPrefix("request", CommonVectorComputeDto.Fields);
      },
    };
  }
  /**
   ...
   * be complaining.
   **/
  static from(possibleDtoObject: CommonVectorResponseDtoType) {
   ...
   **/
  static with(partialDtoObject: PartialDeep<CommonVectorResponseDtoType>) {
    return new CommonVectorResponseDto(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<CommonVectorResponseDtoType>,
  ): InstanceType<typeof CommonVectorResponseDto> {
    return new CommonVectorResponseDto({ ...this.toJSON(), ...partial });
  }
  clone(): InstanceType<typeof CommonVectorResponseDto> {
 ...
 **/
export type CommonVectorResponseDtoType = {
  /**
   *
   * @type {number[]}
   **/
...
export namespace CommonVectorResponseDtoType {}
