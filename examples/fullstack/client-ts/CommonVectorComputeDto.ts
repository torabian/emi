...
setInitialVector2 (value: number[]) {
  ...
  **/
 #fieldTypeArray : InstanceType<typeof CommonVectorComputeDto.FieldTypeArray>[]  =  []
		/**
  * 
...
/**
  ...
  * @type {CommonVectorComputeDto.FieldTypeArray}
  **/
set fieldTypeArray (value: InstanceType<typeof CommonVectorComputeDto.FieldTypeArray>[]) {
...
setFieldTypeArray (value: InstanceType<typeof CommonVectorComputeDto.FieldTypeArray>[]) {
	this.fieldTypeArray = value
	return this
}
		/**
...
setArrayField1 (value: string) {
  ...
  **/
 #arrayField2 : InstanceType<typeof CommonVectorComputeDto.FieldTypeArray.ArrayField2>[]  =  []
		/**
  * 
...
/**
  ...
  * @type {CommonVectorComputeDto.FieldTypeArray.ArrayField2}
  **/
set arrayField2 (value: InstanceType<typeof CommonVectorComputeDto.FieldTypeArray.ArrayField2>[]) {
	 	// For arrays, you only can pass arrays to the object
	 	if (!Array.isArray(value)) {
			return;
		}
...
setArrayField2 (value: InstanceType<typeof CommonVectorComputeDto.FieldTypeArray.ArrayField2>[]) {
	this.arrayField2 = value
	return this
}
/**
...
setLastItem (value: string) {
	...
	* be complaining.
	**/
	static from(possibleDtoObject: CommonVectorComputeDtoType.FieldTypeArrayType.ArrayField2Type) {
	...
	**/
	static with(partialDtoObject: PartialDeep<CommonVectorComputeDtoType.FieldTypeArrayType.ArrayField2Type>) {
		return new CommonVectorComputeDto.FieldTypeArray.ArrayField2(partialDtoObject);
	}
	copyWith(partial: PartialDeep<CommonVectorComputeDtoType.FieldTypeArrayType.ArrayField2Type>): InstanceType<typeof CommonVectorComputeDto.FieldTypeArray.ArrayField2> {
		return new CommonVectorComputeDto.FieldTypeArray.ArrayField2 ({ ...this.toJSON(), ...partial });
	}
	clone(): InstanceType<typeof CommonVectorComputeDto.FieldTypeArray.ArrayField2> {
...
get arrayField2() {
	...
	* be complaining.
	**/
	static from(possibleDtoObject: CommonVectorComputeDtoType.FieldTypeArrayType) {
	...
	* be constructed according to data types and nullability.
	**/
	static with(partialDtoObject: PartialDeep<CommonVectorComputeDtoType.FieldTypeArrayType>) {
		return new CommonVectorComputeDto.FieldTypeArray(partialDtoObject);
	}
	copyWith(partial: PartialDeep<CommonVectorComputeDtoType.FieldTypeArrayType>): InstanceType<typeof CommonVectorComputeDto.FieldTypeArray> {
...
get fieldTypeSlice() {
	...
	**/
	...
	copyWith(partial: PartialDeep<CommonVectorComputeDtoType>): InstanceType<typeof CommonVectorComputeDto> {
