...
export const useComputeApiAction = (
  ...
  const fn = (body: ComputeApiActionReq) => {
...
export class ComputeApiAction {
  ...
  static NewUrl = (qs?: ComputeApiActionQueryParams) =>
    buildUrl(ComputeApiAction.URL, undefined, qs);
  static Method = "post";
  static Fetch$ = async (
    qs?: ComputeApiActionQueryParams,
    ctx?: FetchxContext,
    ...
    return fetchx<ComputeApiActionRes, ComputeApiActionReq, unknown>(
      overrideUrl ?? ComputeApiAction.NewUrl(qs),
      {
...
export class ComputeApiActionReq {
  ...
  copyWith(
    partial: PartialDeep<ComputeApiActionReqType>,
  ): InstanceType<typeof ComputeApiActionReq> {
...
export class ComputeApiActionRes {
  ...
  copyWith(
    partial: PartialDeep<ComputeApiActionResType>,
  ): InstanceType<typeof ComputeApiActionRes> {
