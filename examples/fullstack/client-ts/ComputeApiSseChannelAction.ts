...
export const useComputeApiSseChannelActionQuery = (
	...
	const result = useQuery({
		queryKey: [
			ComputeApiSseChannelAction.NewUrl (
				options?.qs
			)
		],
		queryFn: fn,
...
export class ComputeApiSseChannelAction { //
  ...
  static NewUrl = (
	qs?: URLSearchParams
		...
		ComputeApiSseChannelAction.URL,
		 undefined,
		qs
	);
  static Method = 'get';
	static Fetch$ = async (
		...
		return fetchx<ComputeApiSseChannelActionRes, ComputeApiSseChannelActionReq, unknown>(
			overrideUrl ?? ComputeApiSseChannelAction.NewUrl(
				qs
			),
			{
	...
	static Fetch = async (
		init?: TypedRequestInit<ComputeApiSseChannelActionReq, unknown>,
		{
			...
			: {
				creatorFn?: ((item: unknown) => ComputeApiSseChannelActionRes) | undefined,
			qs?: URLSearchParams,
			ctx?: FetchxContext,
			onMessage?: (ev: MessageEvent) => void,
			overrideUrl?: string,		
		...
		creatorFn = creatorFn || ((item) => new ComputeApiSseChannelActionRes(item))
...
get initialVector2() {
	...
	**/
	static with(partialDtoObject: PartialDeep<ComputeApiSseChannelActionReqType>) {
		return new ComputeApiSseChannelActionReq(partialDtoObject);
	}
	copyWith(partial: PartialDeep<ComputeApiSseChannelActionReqType>): InstanceType<typeof ComputeApiSseChannelActionReq> {
...
get outputVector() {
	...
	* be constructed according to data types and nullability.
	**/
	static with(partialDtoObject: PartialDeep<ComputeApiSseChannelActionResType>) {
		return new ComputeApiSseChannelActionRes(partialDtoObject);
	}
	copyWith(partial: PartialDeep<ComputeApiSseChannelActionResType>): InstanceType<typeof ComputeApiSseChannelActionRes> {
