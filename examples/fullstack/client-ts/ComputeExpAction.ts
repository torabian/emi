...
setExponent (value: Int) {
	...
	**/
	...
	copyWith(partial: PartialDeep<ComputeExpActionReqType>): InstanceType<typeof ComputeExpActionReq> {
...
setResult (value: big.Int) {
	...
	**/
	...
	copyWith(partial: PartialDeep<ComputeExpActionResType>): InstanceType<typeof ComputeExpActionRes> {
