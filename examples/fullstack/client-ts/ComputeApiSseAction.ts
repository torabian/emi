...
export const useComputeApiSseAction = (
  ...
  const [isCompleted, setCompleteState] = useState(false);
  const [response, setResponse] = useState<TypedResponse<unknown>>();
  const fn = (body: ComputeApiSseActionReq) => {
    setCompleteState(false);
    return ComputeApiSseAction.Fetch(
      {
        body,
...
export class ComputeApiSseActionReq {
  ...
  copyWith(
    partial: PartialDeep<ComputeApiSseActionReqType>,
  ): InstanceType<typeof ComputeApiSseActionReq> {
...
export class ComputeApiSseActionRes {
  ...
  copyWith(
    partial: PartialDeep<ComputeApiSseActionResType>,
  ): InstanceType<typeof ComputeApiSseActionRes> {
