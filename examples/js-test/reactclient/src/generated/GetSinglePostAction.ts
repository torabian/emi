...
export type GetSinglePostActionQueryOptions = Omit<
  UseQueryOptions<unknown, unknown, GetSinglePostActionRes, unknown[]>,
  "queryKey"
> &
...
export class GetSinglePostActionRes {
  ...
  copyWith(
    partial: PartialDeep<GetSinglePostActionResType>,
  ): InstanceType<typeof GetSinglePostActionRes> {
