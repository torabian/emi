...
export class ComputeAverageAction {
  ...
  static NewUrl = (qs?: URLSearchParams) =>
    buildUrl(ComputeAverageAction.URL, undefined, qs);
  static Method = "";
  static Fetch$ = async (
    qs?: URLSearchParams,
    ctx?: FetchxContext,
    ...
    return fetchx<AverageDto, ComputeDto, ComputeAverageActionReqHeaders>(
      overrideUrl ?? ComputeAverageAction.NewUrl(qs),
      {
  ...
  static Fetch = async (
    ...
    const res = await ComputeAverageAction.Fetch$(qs, ctx, init, overrideUrl);
