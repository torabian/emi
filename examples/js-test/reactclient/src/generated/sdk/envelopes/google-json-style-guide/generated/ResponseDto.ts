...
setItems (value: any) {
  ...
  * @returns {string}
  **/
get editLink () { return this.#editLink }
/**
  * Link to edit this resource.
  * @type {string}
  **/
...
setEditLink (value: string | null | undefined) {
  ...
  * @returns {string}
  **/
get selfLink () { return this.#selfLink }
/**
  * Link to retrieve this resource.
  * @type {string}
  **/
...
setUpdated (value: string | null | undefined) {
  ...
  * @returns {number}
  **/
get currentItemCount () { return this.#currentItemCount }
/**
  * Number of items in the current response page.
  * @type {number}
  **/
...
setTotalItems (value: number | null | undefined) {
  ...
  * @returns {number}
  **/
get totalAvailableItems () { return this.#totalAvailableItems }
/**
  * Number of items available for this user/query.
  * @type {number}
  **/
...
setTotalPages (value: number | null | undefined) {
	...
	**/
	applyFromObject(data = {}) {
		const d = data as Partial<Data>;
			...
			if (d.editLink !== undefined) { this.editLink = d.editLink }
			if (d.selfLink !== undefined) { this.selfLink = d.selfLink }
			if (d.kind !== undefined) { this.kind = d.kind }
			if (d.fields !== undefined) { this.fields = d.fields }
			if (d.etag !== undefined) { this.etag = d.etag }
			if (d.cursor !== undefined) { this.cursor = d.cursor }
			if (d.id !== undefined) { this.id = d.id }
			if (d.lang !== undefined) { this.lang = d.lang }
			if (d.updated !== undefined) { this.updated = d.updated }
			if (d.currentItemCount !== undefined) { this.currentItemCount = d.currentItemCount }
			if (d.itemsPerPage !== undefined) { this.itemsPerPage = d.itemsPerPage }
			if (d.startIndex !== undefined) { this.startIndex = d.startIndex }
			if (d.totalItems !== undefined) { this.totalItems = d.totalItems }
			if (d.totalAvailableItems !== undefined) { this.totalAvailableItems = d.totalAvailableItems }
			if (d.pageIndex !== undefined) { this.pageIndex = d.pageIndex }
			if (d.totalPages !== undefined) { this.totalPages = d.totalPages }
	}
	/**
	...
	**/
	...
	copyWith(partial: PartialDeep<ResponseDtoType.DataType>): InstanceType<typeof ResponseDto.Data> {
...
setMessage (value: string) {
  ...
  * @returns {string}
  **/
get messageTranslated () { return this.#messageTranslated }
/**
  * Localized/translated version of the error message.
  * @type {string}
  **/
...
setLocationType (value: string | null | undefined) {
  ...
  * @returns {string}
  **/
get extendedHelp () { return this.#extendedHelp }
/**
  * URL linking to additional documentation about the error.
  * @type {string}
  **/
...
setExtendedHelp (value: string | null | undefined) {
  ...
  * @returns {string}
  **/
get sendReport () { return this.#sendReport }
/**
  * URL to submit a report for this error.
  * @type {string}
  **/
...
setSendReport (value: string | null | undefined) {
	...
	**/
	applyFromObject(data = {}) {
		const d = data as Partial<Errors>;
			if (d.domain !== undefined) { this.domain = d.domain }
			if (d.reason !== undefined) { this.reason = d.reason }
			if (d.message !== undefined) { this.message = d.message }
			if (d.messageTranslated !== undefined) { this.messageTranslated = d.messageTranslated }
			if (d.location !== undefined) { this.location = d.location }
			if (d.locationType !== undefined) { this.locationType = d.locationType }
			if (d.extendedHelp !== undefined) { this.extendedHelp = d.extendedHelp }
			if (d.sendReport !== undefined) { this.sendReport = d.sendReport }
	}
	/**
	*	Special toJSON override, since the field are private,
	*	Json stringify won't see them unless we mention it explicitly.
	...
	* be constructed according to data types and nullability.
	**/
	static with(partialDtoObject: PartialDeep<ResponseDtoType.ErrorType.ErrorsType>) {
		return new ResponseDto.Error.Errors(partialDtoObject);
	}
	copyWith(partial: PartialDeep<ResponseDtoType.ErrorType.ErrorsType>): InstanceType<typeof ResponseDto.Error.Errors> {
...
get errors() {
	...
	**/
	...
	copyWith(partial: PartialDeep<ResponseDtoType.ErrorType>): InstanceType<typeof ResponseDto.Error> {
	...
	**/
	applyFromObject(data = {}) {
		const d = data as Partial<ResponseDto>;
			...
			if (d.id !== undefined) { this.id = d.id }
			if (d.method !== undefined) { this.method = d.method }
...
get error() {
	...
	**/
	...
	copyWith(partial: PartialDeep<ResponseDtoType>): InstanceType<typeof ResponseDto> {
