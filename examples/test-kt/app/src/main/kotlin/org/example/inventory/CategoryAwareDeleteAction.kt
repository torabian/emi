...
/**
 * Action to communicate with the action CategoryAwareDeleteAction
 */
data class CategoryAwareDeleteActionMeta(
    val name: String = "CategoryAwareDeleteAction",
    val url: String = "/category/delete",
    val method: String = "post"
)
/*data class CategoryAwareDeleteActionRequest(val call: io.ktor.server.application.ApplicationCall)*/
data class CategoryAwareDeleteActionResponse(
    val statusCode: Int = 200,
    val headers: Map<String, String> = emptyMap(),
    val rawBody: String? = null,
    val payload: Any? = null
)
object CategoryAwareDeleteActionClient {
    ...
    // compute() actually serializes the typed CategoryAwareDeleteActionReq body
    ...
    suspend fun compute(
		...
		, body: CategoryAwareDeleteActionReq? = null
	): CategoryAwareDeleteActionResponse =
        withContext(Dispatchers.IO) {
            val meta = CategoryAwareDeleteActionMeta()
  ...
  // The base class definition for categoryAwareDeleteActionReq
@Serializable
data class CategoryAwareDeleteActionReq (
