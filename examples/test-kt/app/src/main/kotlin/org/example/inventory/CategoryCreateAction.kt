...
/**
 * Action to communicate with the action CategoryCreateAction
 */
...
/*data class CategoryCreateActionRequest(val call: io.ktor.server.application.ApplicationCall)*/
...
object CategoryCreateActionClient {
    ...
    // compute() actually serializes the typed CategoryDto body
    ...
    suspend fun compute(
        ...
        withContext(Dispatchers.IO) {
            val meta = CategoryCreateActionMeta()
