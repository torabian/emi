...
/**
 * Action to communicate with the action TeamUpdateAction
 */
data class TeamUpdateActionMeta(
    val name: String = "TeamUpdateAction",
    val url: String = "/team/:uniqueId",
    val method: String = "patch"
)
/*data class TeamUpdateActionRequest(val call: io.ktor.server.application.ApplicationCall)*/
data class TeamUpdateActionResponse(
	...
	/**
 * Path parameters for TeamUpdateAction
 */
data class TeamUpdateActionPathParameter (
	var UniqueId: String,
)
// Converts a placeholder url, and applies the parameters to it.
fun TeamUpdateActionPathParameterApply(params: TeamUpdateActionPathParameter, templateUrl: String): String {
	var url = templateUrl
		url = url.replace(":uniqueId", params.UniqueId)
	return url
}
object TeamUpdateActionClient {
    ...
    // compute() actually serializes the typed TeamOptionalDto body
    ...
    suspend fun compute(
		path: TeamUpdateActionPathParameter,
		query: Map<String, String> = emptyMap(),
		headers: Map<String, String> = emptyMap()
		, body: TeamOptionalDto? = null
	): TeamUpdateActionResponse =
        withContext(Dispatchers.IO) {
            val meta = TeamUpdateActionMeta()
            ...
            var url = buildUrl(effectiveContext.baseUrl, meta.url, query)
            	url = TeamUpdateActionPathParameterApply(path, url)
