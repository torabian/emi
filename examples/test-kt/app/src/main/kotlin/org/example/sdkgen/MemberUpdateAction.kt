...
/**
 * Action to communicate with the action MemberUpdateAction
 */
data class MemberUpdateActionMeta(
    val name: String = "MemberUpdateAction",
    val url: String = "/member/:uniqueId",
    val method: String = "patch"
)
/*data class MemberUpdateActionRequest(val call: io.ktor.server.application.ApplicationCall)*/
data class MemberUpdateActionResponse(
	...
	/**
 * Path parameters for MemberUpdateAction
 */
data class MemberUpdateActionPathParameter (
	var UniqueId: String,
)
// Converts a placeholder url, and applies the parameters to it.
fun MemberUpdateActionPathParameterApply(params: MemberUpdateActionPathParameter, templateUrl: String): String {
	var url = templateUrl
		url = url.replace(":uniqueId", params.UniqueId)
	return url
}
object MemberUpdateActionClient {
    ...
    // compute() actually serializes the typed MemberOptionalDto body
    ...
    suspend fun compute(
		path: MemberUpdateActionPathParameter,
		query: Map<String, String> = emptyMap(),
		headers: Map<String, String> = emptyMap()
		, body: MemberOptionalDto? = null
	): MemberUpdateActionResponse =
        withContext(Dispatchers.IO) {
            val meta = MemberUpdateActionMeta()
            ...
            var url = buildUrl(effectiveContext.baseUrl, meta.url, query)
            	url = MemberUpdateActionPathParameterApply(path, url)
