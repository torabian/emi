...
/**
  ...
  * @type {Anonymouse.ArrayField}
  **/
set arrayField (value: MArray<InstanceType<typeof Anonymouse.ArrayField>> |  InstanceType<typeof Anonymouse.ArrayField>[]) {
...
setArrayField (value: MArray<InstanceType<typeof Anonymouse.ArrayField>> |  InstanceType<typeof Anonymouse.ArrayField>[]) {
	this.arrayField = value
	return this
}
		/**
...
setCollectionNullableField (value: MCollection<User> |  InstanceType<typeof User>[] | null | undefined) {
	this.collectionNullableField = value
	return this
}
		/**
...
static ArrayField = class ArrayField {
	...
	**/
	...
	copyWith(partial: PartialDeep<AnonymouseType.ArrayFieldType>): InstanceType<typeof Anonymouse.ArrayField> {
