...
export class AutoInitClassDto {
  ...
  static Object1 = class Object1 {
    ...
    static Object2 = class Object2 {
      ...
      static Contacts = class Contacts {
         ...
         **/
        toJSON(): AutoInitClassDtoType.Object1Type.Object2Type.ContactsType {
          return {
            email: this.#toPlainJSON(this.#email),
            phone: this.#toPlainJSON(this.#phone),
          } as AutoInitClassDtoType.Object1Type.Object2Type.ContactsType;
        }
        /**
       ...
       *	class gets, rather than a shallow object still holding class instances.
       **/
      toJSON(): AutoInitClassDtoType.Object1Type.Object2Type {
        return {
          contacts: this.#toPlainJSON(this.#contacts),
        } as AutoInitClassDtoType.Object1Type.Object2Type;
      }
      /**
       * Resolves value into a plain, JSON-serializable value: recurses into
       * arrays, and - the case JSON.stringify's own recursion would only get to
     ...
     *	class gets, rather than a shallow object still holding class instances.
     **/
    toJSON(): AutoInitClassDtoType.Object1Type {
      return {
        object2: this.#toPlainJSON(this.#object2),
      } as AutoInitClassDtoType.Object1Type;
    }
    /**
     * Resolves value into a plain, JSON-serializable value: recurses into
     * arrays, and - the case JSON.stringify's own recursion would only get to
   ...
   *	class gets, rather than a shallow object still holding class instances.
   **/
  toJSON(): AutoInitClassDtoType {
    return {
      object1: this.#toPlainJSON(this.#object1),
    } as AutoInitClassDtoType;
  }
  /**
   * Resolves value into a plain, JSON-serializable value: recurses into
   * arrays, and - the case JSON.stringify's own recursion would only get to
