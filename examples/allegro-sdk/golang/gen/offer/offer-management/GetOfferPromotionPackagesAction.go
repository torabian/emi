...
func (x *GetOfferPromotionPackagesActionResponse) AsIdeal() (*GetOfferPromotionPackagesActionRes, error) {
	b, err := json.Marshal(x.GetPayload())
	if err != nil {
		return nil, err
	}
	var res GetOfferPromotionPackagesActionRes
...
func (x GetOfferPromotionPackagesActionRequest) GetGinCtx() interface{} {
	return x.GinCtx
}

// Returns the urfave 3 cli context. You need to manullay cast to .(*cli.Command)
func (x GetOfferPromotionPackagesActionRequest) GetCliCtx() interface{} {
	return x.GinCtx
}
