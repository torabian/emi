...
func (x *BatchOfferPublishUnpublishActionResponse) AsIdeal() (*BatchOfferPublishUnpublishActionRes, error) {
	b, err := json.Marshal(x.GetPayload())
	if err != nil {
		return nil, err
	}
	var res BatchOfferPublishUnpublishActionRes
...
func (x BatchOfferPublishUnpublishActionRequest) GetGinCtx() interface{} {
	return x.GinCtx
}

// Returns the urfave 3 cli context. You need to manullay cast to .(*cli.Command)
func (x BatchOfferPublishUnpublishActionRequest) GetCliCtx() interface{} {
	return x.GinCtx
}
