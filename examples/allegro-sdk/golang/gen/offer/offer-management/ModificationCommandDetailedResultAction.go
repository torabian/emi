...
// ModificationCommandDetailedResultActionHttpHandler returns the HTTP method, the ServeMux pattern, and a
// typed net/http handler for the ModificationCommandDetailedResultAction action. Developers implement
// their business logic as a function that receives a typed request object and
// returns either an *ModificationCommandDetailedResultActionResponse or nil. JSON marshalling, headers,
// status codes, and errors are handled automatically.
func ModificationCommandDetailedResultActionHttpHandler(
...
// ModificationCommandDetailedResultActionHttp is a high-level convenience wrapper around
// ModificationCommandDetailedResultActionHttpHandler. It registers the typed route on a standard
// *http.ServeMux using Go 1.22+ method-aware pattern syntax (e.g. "POST /").
// Use this when you don't need custom middleware.
func ModificationCommandDetailedResultActionHttp(
	mux *http.ServeMux,
	handler func(c ModificationCommandDetailedResultActionRequest) (*ModificationCommandDetailedResultActionResponse, error),
) {
	method, pattern, h := ModificationCommandDetailedResultActionHttpHandler(handler)
