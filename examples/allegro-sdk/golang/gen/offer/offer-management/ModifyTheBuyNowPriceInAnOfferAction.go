...
func (x *ModifyTheBuyNowPriceInAnOfferActionResponse) AsIdeal() (*ModifyTheBuyNowPriceInAnOfferActionRes, error) {
	b, err := json.Marshal(x.GetPayload())
	if err != nil {
		return nil, err
	}
	var res ModifyTheBuyNowPriceInAnOfferActionRes
...
func (x ModifyTheBuyNowPriceInAnOfferActionRequest) GetGinCtx() interface{} {
	return x.GinCtx
}

// Returns the urfave 3 cli context. You need to manullay cast to .(*cli.Command)
func (x ModifyTheBuyNowPriceInAnOfferActionRequest) GetCliCtx() interface{} {
	return x.GinCtx
}
