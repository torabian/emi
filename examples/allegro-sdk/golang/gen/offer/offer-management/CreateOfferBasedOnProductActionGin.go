...
// CreateOfferBasedOnProductActionGin is a high-level convenience wrapper around CreateOfferBasedOnProductActionHandler.
// It automatically constructs and registers the typed route on the Gin engine.
// Use this when you don't need custom middleware or route grouping.
func CreateOfferBasedOnProductActionGin(r gin.IRoutes, handler func(c CreateOfferBasedOnProductActionRequest) (*CreateOfferBasedOnProductActionResponse, error)) {
