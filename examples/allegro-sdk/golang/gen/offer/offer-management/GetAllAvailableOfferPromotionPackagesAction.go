...
type GetAllAvailableOfferPromotionPackagesActionRes struct {
	...
	BasePackages           emigo.Array[GetAllAvailableOfferPromotionPackagesActionResBasePackages]           `json:"basePackages" yaml:"basePackages"`
	ExtraPackages          emigo.Array[GetAllAvailableOfferPromotionPackagesActionResExtraPackages]          `json:"extraPackages" yaml:"extraPackages"`
...
type GetAllAvailableOfferPromotionPackagesActionResAdditionalMarketplaces struct {
	MarketplaceId string                                                                                         `json:"marketplaceId" yaml:"marketplaceId"`
	BasePackages  emigo.Array[GetAllAvailableOfferPromotionPackagesActionResAdditionalMarketplacesBasePackages]  `json:"basePackages" yaml:"basePackages"`
...
// typed net/http handler for the GetAllAvailableOfferPromotionPackagesAction action. Developers implement
// their business logic as a function that receives a typed request object and
// returns either an *GetAllAvailableOfferPromotionPackagesActionResponse or nil. JSON marshalling, headers,
// status codes, and errors are handled automatically.
func GetAllAvailableOfferPromotionPackagesActionHttpHandler(
...
// GetAllAvailableOfferPromotionPackagesActionHttp is a high-level convenience wrapper around
// GetAllAvailableOfferPromotionPackagesActionHttpHandler. It registers the typed route on a standard
// *http.ServeMux using Go 1.22+ method-aware pattern syntax (e.g. "POST /").
// Use this when you don't need custom middleware.
func GetAllAvailableOfferPromotionPackagesActionHttp(
	mux *http.ServeMux,
	handler func(c GetAllAvailableOfferPromotionPackagesActionRequest) (*GetAllAvailableOfferPromotionPackagesActionResponse, error),
) {
	method, pattern, h := GetAllAvailableOfferPromotionPackagesActionHttpHandler(handler)
