...
// typed net/http handler for the GetSmartClassificationReportOfTheParticularOfferAction action. Developers implement
// their business logic as a function that receives a typed request object and
// returns either an *GetSmartClassificationReportOfTheParticularOfferActionResponse or nil. JSON marshalling, headers,
// status codes, and errors are handled automatically.
func GetSmartClassificationReportOfTheParticularOfferActionHttpHandler(
...
// GetSmartClassificationReportOfTheParticularOfferActionHttp is a high-level convenience wrapper around
// GetSmartClassificationReportOfTheParticularOfferActionHttpHandler. It registers the typed route on a standard
// *http.ServeMux using Go 1.22+ method-aware pattern syntax (e.g. "POST /").
// Use this when you don't need custom middleware.
func GetSmartClassificationReportOfTheParticularOfferActionHttp(
	mux *http.ServeMux,
	handler func(c GetSmartClassificationReportOfTheParticularOfferActionRequest) (*GetSmartClassificationReportOfTheParticularOfferActionResponse, error),
) {
	method, pattern, h := GetSmartClassificationReportOfTheParticularOfferActionHttpHandler(handler)
