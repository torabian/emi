...
// typed net/http handler for the GetEventsAboutTheSellerSOffersAction action. Developers implement
// their business logic as a function that receives a typed request object and
// returns either an *GetEventsAboutTheSellerSOffersActionResponse or nil. JSON marshalling, headers,
// status codes, and errors are handled automatically.
func GetEventsAboutTheSellerSOffersActionHttpHandler(
...
// GetEventsAboutTheSellerSOffersActionHttp is a high-level convenience wrapper around
// GetEventsAboutTheSellerSOffersActionHttpHandler. It registers the typed route on a standard
// *http.ServeMux using Go 1.22+ method-aware pattern syntax (e.g. "POST /").
// Use this when you don't need custom middleware.
func GetEventsAboutTheSellerSOffersActionHttp(
	mux *http.ServeMux,
	handler func(c GetEventsAboutTheSellerSOffersActionRequest) (*GetEventsAboutTheSellerSOffersActionResponse, error),
) {
	method, pattern, h := GetEventsAboutTheSellerSOffersActionHttpHandler(handler)
