...
export class ModifyOfferPromotionPackagesAction {
  ...
  static NewUrl = (qs?: URLSearchParams) =>
    buildUrl(ModifyOfferPromotionPackagesAction.URL, undefined, qs);
  static Method = "post";
  static Fetch$ = async (
    qs?: URLSearchParams,
    ...
    return fetchx<
      ModifyOfferPromotionPackagesActionRes,
      ModifyOfferPromotionPackagesActionReq,
      unknown
    >(
      overrideUrl ?? ModifyOfferPromotionPackagesAction.NewUrl(qs),
      {
...
export class ModifyOfferPromotionPackagesActionReq {
   ...
   **/
  #modifications: MArray<
    InstanceType<typeof ModifyOfferPromotionPackagesActionReq.Modifications>
  > = MArray.of([]);
  /**
   *
  ...
  set modifications(
    ...
    if (Array.isArray(value)) {
      if (
        value.length > 0 &&
        value[0] instanceof ModifyOfferPromotionPackagesActionReq.Modifications
      ) {
        this.#modifications = MArray.of(value);
      } else {
        this.#modifications = MArray.of(
          value.map(
            (item) =>
              new ModifyOfferPromotionPackagesActionReq.Modifications(item),
          ),
        );
      }
      return;
    ...
    if (ok) {
      this.#modifications = mcastValue as any;
      return;
    }
    console.warn(
      "Cannot assing value to modifications, because it needs MArray instance or an Array.",
    );
  }
  setModifications(
    value:
  ...
  set additionalMarketplaces(
    ...
    if (Array.isArray(value)) {
      if (
        value.length > 0 &&
        value[0] instanceof
          ModifyOfferPromotionPackagesActionReq.AdditionalMarketplaces
      ) {
        ...
        this.#additionalMarketplaces = MArray.of(
          value.map(
            (item) =>
              new ModifyOfferPromotionPackagesActionReq.AdditionalMarketplaces(
                item,
              ),
          ),
        );
  ...
  static Modifications = class Modifications {
    ...
    applyFromObject(data = {}) {
      ...
      if (d.modificationType !== undefined) {
        this.modificationType = d.modificationType;
      }
      if (d.packageType !== undefined) {
        this.packageType = d.packageType;
      }
      if (d.packageId !== undefined) {
     ...
     **/
    static from(
      possibleDtoObject: ModifyOfferPromotionPackagesActionReqType.ModificationsType,
    ) {
      return new ModifyOfferPromotionPackagesActionReq.Modifications(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<ModifyOfferPromotionPackagesActionReqType.ModificationsType>,
    ) {
      return new ModifyOfferPromotionPackagesActionReq.Modifications(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<ModifyOfferPromotionPackagesActionReqType.ModificationsType>,
    ): InstanceType<
      typeof ModifyOfferPromotionPackagesActionReq.Modifications
    > {
      return new ModifyOfferPromotionPackagesActionReq.Modifications({
  ...
  static AdditionalMarketplaces = class AdditionalMarketplaces {
      ...
      if (Array.isArray(value)) {
        if (
          ...
          this.#modifications = MArray.of(
            value.map(
              (item) =>
                new ModifyOfferPromotionPackagesActionReq.AdditionalMarketplaces.Modifications(
                  item,
                ),
            ),
          );
    ...
    static Modifications = class Modifications {
       ...
       **/
      static from(
        possibleDtoObject: ModifyOfferPromotionPackagesActionReqType.AdditionalMarketplacesType.ModificationsType,
      ) {
        return new ModifyOfferPromotionPackagesActionReq.AdditionalMarketplaces.Modifications(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<ModifyOfferPromotionPackagesActionReqType.AdditionalMarketplacesType.ModificationsType>,
      ) {
        return new ModifyOfferPromotionPackagesActionReq.AdditionalMarketplaces.Modifications(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<ModifyOfferPromotionPackagesActionReqType.AdditionalMarketplacesType.ModificationsType>,
      ): InstanceType<
        typeof ModifyOfferPromotionPackagesActionReq.AdditionalMarketplaces.Modifications
      > {
        return new ModifyOfferPromotionPackagesActionReq.AdditionalMarketplaces.Modifications(
     ...
     **/
    static from(
      possibleDtoObject: ModifyOfferPromotionPackagesActionReqType.AdditionalMarketplacesType,
    ) {
      return new ModifyOfferPromotionPackagesActionReq.AdditionalMarketplaces(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<ModifyOfferPromotionPackagesActionReqType.AdditionalMarketplacesType>,
    ) {
      return new ModifyOfferPromotionPackagesActionReq.AdditionalMarketplaces(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<ModifyOfferPromotionPackagesActionReqType.AdditionalMarketplacesType>,
    ): InstanceType<
      typeof ModifyOfferPromotionPackagesActionReq.AdditionalMarketplaces
    > {
      return new ModifyOfferPromotionPackagesActionReq.AdditionalMarketplaces({
   ...
   **/
  static with(
    partialDtoObject: PartialDeep<ModifyOfferPromotionPackagesActionReqType>,
  ) {
    return new ModifyOfferPromotionPackagesActionReq(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<ModifyOfferPromotionPackagesActionReqType>,
  ): InstanceType<typeof ModifyOfferPromotionPackagesActionReq> {
    return new ModifyOfferPromotionPackagesActionReq({
      ...this.toJSON(),
      ...partial,
    });
  }
...
export class ModifyOfferPromotionPackagesActionRes {
  ...
  #basePackage!: InstanceType<
    typeof ModifyOfferPromotionPackagesActionRes.BasePackage
  >;
  /**
   *
  ...
  set basePackage(
    ...
    if (value instanceof ModifyOfferPromotionPackagesActionRes.BasePackage) {
      ...
      this.#basePackage = new ModifyOfferPromotionPackagesActionRes.BasePackage(
        value,
      );
    }
  }
  ...
  #extraPackages: MArray<
    InstanceType<typeof ModifyOfferPromotionPackagesActionRes.ExtraPackages>
  > = MArray.of([]);
  /**
   *
  ...
  set extraPackages(
    ...
    if (Array.isArray(value)) {
      if (
        value.length > 0 &&
        value[0] instanceof ModifyOfferPromotionPackagesActionRes.ExtraPackages
      ) {
        ...
        this.#extraPackages = MArray.of(
          value.map(
            (item) =>
              new ModifyOfferPromotionPackagesActionRes.ExtraPackages(item),
          ),
        );
      }
      return;
   ...
   **/
  #pendingChanges!: InstanceType<
    typeof ModifyOfferPromotionPackagesActionRes.PendingChanges
  >;
  /**
   *
  ...
  set pendingChanges(
    ...
    if (value instanceof ModifyOfferPromotionPackagesActionRes.PendingChanges) {
      ...
      this.#pendingChanges =
        new ModifyOfferPromotionPackagesActionRes.PendingChanges(value);
    }
  }
  setPendingChanges(
    value: InstanceType<
  ...
  set additionalMarketplaces(
    ...
    if (Array.isArray(value)) {
      if (
        value.length > 0 &&
        value[0] instanceof
          ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces
      ) {
        this.#additionalMarketplaces = MArray.of(value);
      } else {
        this.#additionalMarketplaces = MArray.of(
          value.map(
            (item) =>
              new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces(
                item,
              ),
          ),
        );
  ...
  static BasePackage = class BasePackage {
    ...
    applyFromObject(data = {}) {
      ...
      if (d.validFrom !== undefined) {
        this.validFrom = d.validFrom;
      }
      if (d.validTo !== undefined) {
        this.validTo = d.validTo;
      }
      if (d.nextCycleDate !== undefined) {
        this.nextCycleDate = d.nextCycleDate;
      }
    }
    /**
     *	Special toJSON override, since the field are private,
     ...
     **/
    static from(
      possibleDtoObject: ModifyOfferPromotionPackagesActionResType.BasePackageType,
    ) {
      return new ModifyOfferPromotionPackagesActionRes.BasePackage(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<ModifyOfferPromotionPackagesActionResType.BasePackageType>,
    ) {
      return new ModifyOfferPromotionPackagesActionRes.BasePackage(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<ModifyOfferPromotionPackagesActionResType.BasePackageType>,
    ): InstanceType<typeof ModifyOfferPromotionPackagesActionRes.BasePackage> {
      return new ModifyOfferPromotionPackagesActionRes.BasePackage({
        ...this.toJSON(),
        ...partial,
      });
  ...
  static ExtraPackages = class ExtraPackages {
     ...
     **/
    static from(
      possibleDtoObject: ModifyOfferPromotionPackagesActionResType.ExtraPackagesType,
    ) {
      return new ModifyOfferPromotionPackagesActionRes.ExtraPackages(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<ModifyOfferPromotionPackagesActionResType.ExtraPackagesType>,
    ) {
      return new ModifyOfferPromotionPackagesActionRes.ExtraPackages(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<ModifyOfferPromotionPackagesActionResType.ExtraPackagesType>,
    ): InstanceType<
      typeof ModifyOfferPromotionPackagesActionRes.ExtraPackages
    > {
      return new ModifyOfferPromotionPackagesActionRes.ExtraPackages({
  ...
  static PendingChanges = class PendingChanges {
     ...
     **/
    #basePackage!: InstanceType<
      typeof ModifyOfferPromotionPackagesActionRes.PendingChanges.BasePackage
    >;
    /**
     *
    ...
    set basePackage(
      ...
      if (
        value instanceof
        ModifyOfferPromotionPackagesActionRes.PendingChanges.BasePackage
      ) {
        this.#basePackage = value;
      } else {
        this.#basePackage =
          new ModifyOfferPromotionPackagesActionRes.PendingChanges.BasePackage(
            value,
          );
      }
    }
    ...
    static BasePackage = class BasePackage {
       ...
       **/
      static from(
        possibleDtoObject: ModifyOfferPromotionPackagesActionResType.PendingChangesType.BasePackageType,
      ) {
        return new ModifyOfferPromotionPackagesActionRes.PendingChanges.BasePackage(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<ModifyOfferPromotionPackagesActionResType.PendingChangesType.BasePackageType>,
      ) {
        return new ModifyOfferPromotionPackagesActionRes.PendingChanges.BasePackage(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<ModifyOfferPromotionPackagesActionResType.PendingChangesType.BasePackageType>,
      ): InstanceType<
        typeof ModifyOfferPromotionPackagesActionRes.PendingChanges.BasePackage
      > {
        return new ModifyOfferPromotionPackagesActionRes.PendingChanges.BasePackage(
     ...
     **/
    static from(
      possibleDtoObject: ModifyOfferPromotionPackagesActionResType.PendingChangesType,
    ) {
      return new ModifyOfferPromotionPackagesActionRes.PendingChanges(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<ModifyOfferPromotionPackagesActionResType.PendingChangesType>,
    ) {
      return new ModifyOfferPromotionPackagesActionRes.PendingChanges(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<ModifyOfferPromotionPackagesActionResType.PendingChangesType>,
    ): InstanceType<
      typeof ModifyOfferPromotionPackagesActionRes.PendingChanges
    > {
      return new ModifyOfferPromotionPackagesActionRes.PendingChanges({
  ...
  static AdditionalMarketplaces = class AdditionalMarketplaces {
     ...
     **/
    #basePackage!: InstanceType<
      typeof ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.BasePackage
    >;
    /**
     *
    ...
    set basePackage(
      ...
      if (
        value instanceof
        ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.BasePackage
      ) {
        this.#basePackage = value;
      } else {
        this.#basePackage =
          new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.BasePackage(
            value,
          );
      }
    }
      ...
      if (Array.isArray(value)) {
        if (
          ...
          this.#extraPackages = MArray.of(
            value.map(
              (item) =>
                new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.ExtraPackages(
                  item,
                ),
            ),
          );
     ...
     **/
    #pendingChanges!: InstanceType<
      typeof ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges
    >;
    /**
     *
    ...
    set pendingChanges(
      ...
      if (
        ...
        this.#pendingChanges =
          new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges(
            value,
          );
      }
    }
    ...
    static BasePackage = class BasePackage {
       ...
       **/
      static from(
        possibleDtoObject: ModifyOfferPromotionPackagesActionResType.AdditionalMarketplacesType.BasePackageType,
      ) {
        return new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.BasePackage(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<ModifyOfferPromotionPackagesActionResType.AdditionalMarketplacesType.BasePackageType>,
      ) {
        return new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.BasePackage(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<ModifyOfferPromotionPackagesActionResType.AdditionalMarketplacesType.BasePackageType>,
      ): InstanceType<
        typeof ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.BasePackage
      > {
        return new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.BasePackage(
    ...
    static ExtraPackages = class ExtraPackages {
       ...
       **/
      static from(
        possibleDtoObject: ModifyOfferPromotionPackagesActionResType.AdditionalMarketplacesType.ExtraPackagesType,
      ) {
        return new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.ExtraPackages(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<ModifyOfferPromotionPackagesActionResType.AdditionalMarketplacesType.ExtraPackagesType>,
      ) {
        return new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.ExtraPackages(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<ModifyOfferPromotionPackagesActionResType.AdditionalMarketplacesType.ExtraPackagesType>,
      ): InstanceType<
        typeof ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.ExtraPackages
      > {
        return new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.ExtraPackages(
    ...
    static PendingChanges = class PendingChanges {
       ...
       **/
      #basePackage!: InstanceType<
        typeof ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges.BasePackage
      >;
      /**
       *
      ...
      set basePackage(
        ...
        if (
          ...
          this.#basePackage =
            new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges.BasePackage(
              value,
            );
        }
      }
      ...
      static BasePackage = class BasePackage {
         ...
         **/
        static from(
          possibleDtoObject: ModifyOfferPromotionPackagesActionResType.AdditionalMarketplacesType.PendingChangesType.BasePackageType,
        ) {
          return new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges.BasePackage(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<ModifyOfferPromotionPackagesActionResType.AdditionalMarketplacesType.PendingChangesType.BasePackageType>,
        ) {
          return new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges.BasePackage(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<ModifyOfferPromotionPackagesActionResType.AdditionalMarketplacesType.PendingChangesType.BasePackageType>,
        ): InstanceType<
          typeof ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges.BasePackage
        > {
          return new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges.BasePackage(
        ...
        return {
          ...
          get basePackage() {
            return withPrefix(
              ...
              ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces
                .PendingChanges.BasePackage.Fields,
            );
          },
        };
      }
       ...
       **/
      static from(
        possibleDtoObject: ModifyOfferPromotionPackagesActionResType.AdditionalMarketplacesType.PendingChangesType,
      ) {
        return new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<ModifyOfferPromotionPackagesActionResType.AdditionalMarketplacesType.PendingChangesType>,
      ) {
        return new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<ModifyOfferPromotionPackagesActionResType.AdditionalMarketplacesType.PendingChangesType>,
      ): InstanceType<
        typeof ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges
      > {
        return new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces.PendingChanges(
    ...
    applyFromObject(data = {}) {
      ...
      if (d.pendingChanges !== undefined) {
        this.pendingChanges = d.pendingChanges;
      }
      this.#lateInitFields(data);
    }
    /**
     ...
     **/
    static from(
      possibleDtoObject: ModifyOfferPromotionPackagesActionResType.AdditionalMarketplacesType,
    ) {
      return new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<ModifyOfferPromotionPackagesActionResType.AdditionalMarketplacesType>,
    ) {
      return new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<ModifyOfferPromotionPackagesActionResType.AdditionalMarketplacesType>,
    ): InstanceType<
      typeof ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces
    > {
      return new ModifyOfferPromotionPackagesActionRes.AdditionalMarketplaces({
  ...
  applyFromObject(data = {}) {
    ...
    if (d.offerId !== undefined) {
      this.offerId = d.offerId;
    }
    if (d.marketplaceId !== undefined) {
      this.marketplaceId = d.marketplaceId;
    }
  ...
  #lateInitFields(data = {}) {
    ...
    if (
      !(
        d.basePackage instanceof
        ModifyOfferPromotionPackagesActionRes.BasePackage
      )
    ) {
      this.basePackage = new ModifyOfferPromotionPackagesActionRes.BasePackage(
        d.basePackage || {},
    ...
    if (
      !(
        d.pendingChanges instanceof
        ModifyOfferPromotionPackagesActionRes.PendingChanges
      )
    ) {
      this.pendingChanges =
        new ModifyOfferPromotionPackagesActionRes.PendingChanges(
          d.pendingChanges || {},
        );
    }
  }
   ...
   **/
  static with(
    partialDtoObject: PartialDeep<ModifyOfferPromotionPackagesActionResType>,
  ) {
    return new ModifyOfferPromotionPackagesActionRes(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<ModifyOfferPromotionPackagesActionResType>,
  ): InstanceType<typeof ModifyOfferPromotionPackagesActionRes> {
    return new ModifyOfferPromotionPackagesActionRes({
      ...this.toJSON(),
      ...partial,
    });
  }
