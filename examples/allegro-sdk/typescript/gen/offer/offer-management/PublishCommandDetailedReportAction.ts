...
export class PublishCommandDetailedReportAction {
  ...
  static NewUrl = (qs?: URLSearchParams) =>
    buildUrl(PublishCommandDetailedReportAction.URL, undefined, qs);
  static Method = "get";
  static Fetch$ = async (
    qs?: URLSearchParams,
    ...
    return fetchx<PublishCommandDetailedReportActionRes, unknown, unknown>(
      overrideUrl ?? PublishCommandDetailedReportAction.NewUrl(qs),
      {
...
export class PublishCommandDetailedReportActionRes {
   ...
   **/
  #tasks: MArray<
    InstanceType<typeof PublishCommandDetailedReportActionRes.Tasks>
  > = MArray.of([]);
  /**
   *
  ...
  set tasks(
    value:
      | MArray<InstanceType<typeof PublishCommandDetailedReportActionRes.Tasks>>
      | InstanceType<typeof PublishCommandDetailedReportActionRes.Tasks>[],
  ) {
  ...
  static Tasks = class Tasks {
     ...
     **/
    #offer!: InstanceType<
      typeof PublishCommandDetailedReportActionRes.Tasks.Offer
    >;
    /**
     *
    ...
    set offer(
      ...
      if (value instanceof PublishCommandDetailedReportActionRes.Tasks.Offer) {
        ...
        this.#offer = new PublishCommandDetailedReportActionRes.Tasks.Offer(
          value,
        );
      }
    }
     ...
     **/
    #errors: MArray<
      InstanceType<typeof PublishCommandDetailedReportActionRes.Tasks.Errors>
    > = MArray.of([]);
    /**
     *
    ...
    static Offer = class Offer {
       ...
       **/
      static from(
        possibleDtoObject: PublishCommandDetailedReportActionResType.TasksType.OfferType,
      ) {
        return new PublishCommandDetailedReportActionRes.Tasks.Offer(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<PublishCommandDetailedReportActionResType.TasksType.OfferType>,
      ) {
        return new PublishCommandDetailedReportActionRes.Tasks.Offer(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<PublishCommandDetailedReportActionResType.TasksType.OfferType>,
      ): InstanceType<
        typeof PublishCommandDetailedReportActionRes.Tasks.Offer
      > {
        return new PublishCommandDetailedReportActionRes.Tasks.Offer({
    ...
    static Errors = class Errors {
      ...
      #metadata!: InstanceType<
        typeof PublishCommandDetailedReportActionRes.Tasks.Errors.Metadata
      >;
      /**
       *
      ...
      set metadata(
        ...
        if (
          value instanceof
          PublishCommandDetailedReportActionRes.Tasks.Errors.Metadata
        ) {
          this.#metadata = value;
        } else {
          this.#metadata =
            new PublishCommandDetailedReportActionRes.Tasks.Errors.Metadata(
              value,
            );
        }
      }
      ...
      static Metadata = class Metadata {
         ...
         **/
        static from(
          possibleDtoObject: PublishCommandDetailedReportActionResType.TasksType.ErrorsType.MetadataType,
        ) {
          return new PublishCommandDetailedReportActionRes.Tasks.Errors.Metadata(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<PublishCommandDetailedReportActionResType.TasksType.ErrorsType.MetadataType>,
        ) {
          return new PublishCommandDetailedReportActionRes.Tasks.Errors.Metadata(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<PublishCommandDetailedReportActionResType.TasksType.ErrorsType.MetadataType>,
        ): InstanceType<
          typeof PublishCommandDetailedReportActionRes.Tasks.Errors.Metadata
        > {
          return new PublishCommandDetailedReportActionRes.Tasks.Errors.Metadata(
       ...
       **/
      static from(
        possibleDtoObject: PublishCommandDetailedReportActionResType.TasksType.ErrorsType,
      ) {
        return new PublishCommandDetailedReportActionRes.Tasks.Errors(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<PublishCommandDetailedReportActionResType.TasksType.ErrorsType>,
      ) {
        return new PublishCommandDetailedReportActionRes.Tasks.Errors(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<PublishCommandDetailedReportActionResType.TasksType.ErrorsType>,
      ): InstanceType<
        typeof PublishCommandDetailedReportActionRes.Tasks.Errors
      > {
        return new PublishCommandDetailedReportActionRes.Tasks.Errors({
    ...
    #lateInitFields(data = {}) {
      const d = data as Partial<Tasks>;
      if (
        !(d.offer instanceof PublishCommandDetailedReportActionRes.Tasks.Offer)
      ) {
        this.offer = new PublishCommandDetailedReportActionRes.Tasks.Offer(
          d.offer || {},
        );
     ...
     **/
    static from(
      possibleDtoObject: PublishCommandDetailedReportActionResType.TasksType,
    ) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<PublishCommandDetailedReportActionResType.TasksType>,
    ) {
      return new PublishCommandDetailedReportActionRes.Tasks(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<PublishCommandDetailedReportActionResType.TasksType>,
    ): InstanceType<typeof PublishCommandDetailedReportActionRes.Tasks> {
      return new PublishCommandDetailedReportActionRes.Tasks({
        ...this.toJSON(),
        ...partial,
      });
    }
   ...
   **/
  static with(
    partialDtoObject: PartialDeep<PublishCommandDetailedReportActionResType>,
  ) {
    return new PublishCommandDetailedReportActionRes(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<PublishCommandDetailedReportActionResType>,
  ): InstanceType<typeof PublishCommandDetailedReportActionRes> {
    return new PublishCommandDetailedReportActionRes({
      ...this.toJSON(),
      ...partial,
    });
  }
