...
export class ModifyTheBuyNowPriceInAnOfferAction {
  ...
  static NewUrl = (qs?: URLSearchParams) =>
    buildUrl(ModifyTheBuyNowPriceInAnOfferAction.URL, undefined, qs);
  static Method = "put";
  static Fetch$ = async (
    qs?: URLSearchParams,
    ...
    return fetchx<
      ModifyTheBuyNowPriceInAnOfferActionRes,
      ModifyTheBuyNowPriceInAnOfferActionReq,
      unknown
    >(
      overrideUrl ?? ModifyTheBuyNowPriceInAnOfferAction.NewUrl(qs),
      {
...
export class ModifyTheBuyNowPriceInAnOfferActionReq {
   ...
   **/
  set input(
    value: InstanceType<typeof ModifyTheBuyNowPriceInAnOfferActionReq.Input>,
  ) {
  ...
  static Input = class Input {
     ...
     **/
    #buyNowPrice!: InstanceType<
      typeof ModifyTheBuyNowPriceInAnOfferActionReq.Input.BuyNowPrice
    >;
    /**
     *
    ...
    set buyNowPrice(
      ...
      if (
        value instanceof
        ModifyTheBuyNowPriceInAnOfferActionReq.Input.BuyNowPrice
      ) {
        this.#buyNowPrice = value;
      } else {
        this.#buyNowPrice =
          new ModifyTheBuyNowPriceInAnOfferActionReq.Input.BuyNowPrice(value);
      }
    }
    setBuyNowPrice(
      value: InstanceType<
    ...
    static BuyNowPrice = class BuyNowPrice {
       ...
       **/
      static from(
        possibleDtoObject: ModifyTheBuyNowPriceInAnOfferActionReqType.InputType.BuyNowPriceType,
      ) {
        return new ModifyTheBuyNowPriceInAnOfferActionReq.Input.BuyNowPrice(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<ModifyTheBuyNowPriceInAnOfferActionReqType.InputType.BuyNowPriceType>,
      ) {
        return new ModifyTheBuyNowPriceInAnOfferActionReq.Input.BuyNowPrice(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<ModifyTheBuyNowPriceInAnOfferActionReqType.InputType.BuyNowPriceType>,
      ): InstanceType<
        typeof ModifyTheBuyNowPriceInAnOfferActionReq.Input.BuyNowPrice
      > {
        return new ModifyTheBuyNowPriceInAnOfferActionReq.Input.BuyNowPrice({
    ...
    applyFromObject(data = {}) {
      ...
      if (d.buyNowPrice !== undefined) {
        this.buyNowPrice = d.buyNowPrice;
      }
    ...
    #lateInitFields(data = {}) {
      ...
      if (
        !(
          d.buyNowPrice instanceof
          ModifyTheBuyNowPriceInAnOfferActionReq.Input.BuyNowPrice
        )
      ) {
        this.buyNowPrice =
          new ModifyTheBuyNowPriceInAnOfferActionReq.Input.BuyNowPrice(
            d.buyNowPrice || {},
          );
      }
    }
     ...
     **/
    static from(
      possibleDtoObject: ModifyTheBuyNowPriceInAnOfferActionReqType.InputType,
    ) {
      return new ModifyTheBuyNowPriceInAnOfferActionReq.Input(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<ModifyTheBuyNowPriceInAnOfferActionReqType.InputType>,
    ) {
      return new ModifyTheBuyNowPriceInAnOfferActionReq.Input(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<ModifyTheBuyNowPriceInAnOfferActionReqType.InputType>,
    ): InstanceType<typeof ModifyTheBuyNowPriceInAnOfferActionReq.Input> {
      return new ModifyTheBuyNowPriceInAnOfferActionReq.Input({
        ...this.toJSON(),
        ...partial,
      });
  ...
  #lateInitFields(data = {}) {
    const d = data as Partial<ModifyTheBuyNowPriceInAnOfferActionReq>;
    if (!(d.input instanceof ModifyTheBuyNowPriceInAnOfferActionReq.Input)) {
      this.input = new ModifyTheBuyNowPriceInAnOfferActionReq.Input(
        d.input || {},
      );
    }
  }
   ...
   **/
  static with(
    partialDtoObject: PartialDeep<ModifyTheBuyNowPriceInAnOfferActionReqType>,
  ) {
    return new ModifyTheBuyNowPriceInAnOfferActionReq(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<ModifyTheBuyNowPriceInAnOfferActionReqType>,
  ): InstanceType<typeof ModifyTheBuyNowPriceInAnOfferActionReq> {
    return new ModifyTheBuyNowPriceInAnOfferActionReq({
      ...this.toJSON(),
      ...partial,
    });
  }
...
export class ModifyTheBuyNowPriceInAnOfferActionRes {
   ...
   **/
  set input(
    value: InstanceType<typeof ModifyTheBuyNowPriceInAnOfferActionRes.Input>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
   ...
   **/
  set output(
    value: InstanceType<typeof ModifyTheBuyNowPriceInAnOfferActionRes.Output>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
  ...
  static Input = class Input {
     ...
     **/
    #buyNowPrice!: InstanceType<
      typeof ModifyTheBuyNowPriceInAnOfferActionRes.Input.BuyNowPrice
    >;
    /**
     *
    ...
    set buyNowPrice(
      ...
      if (
        value instanceof
        ModifyTheBuyNowPriceInAnOfferActionRes.Input.BuyNowPrice
      ) {
        this.#buyNowPrice = value;
      } else {
        this.#buyNowPrice =
          new ModifyTheBuyNowPriceInAnOfferActionRes.Input.BuyNowPrice(value);
      }
    }
    setBuyNowPrice(
      value: InstanceType<
    ...
    static BuyNowPrice = class BuyNowPrice {
       ...
       **/
      static from(
        possibleDtoObject: ModifyTheBuyNowPriceInAnOfferActionResType.InputType.BuyNowPriceType,
      ) {
        return new ModifyTheBuyNowPriceInAnOfferActionRes.Input.BuyNowPrice(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<ModifyTheBuyNowPriceInAnOfferActionResType.InputType.BuyNowPriceType>,
      ) {
        return new ModifyTheBuyNowPriceInAnOfferActionRes.Input.BuyNowPrice(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<ModifyTheBuyNowPriceInAnOfferActionResType.InputType.BuyNowPriceType>,
      ): InstanceType<
        typeof ModifyTheBuyNowPriceInAnOfferActionRes.Input.BuyNowPrice
      > {
        return new ModifyTheBuyNowPriceInAnOfferActionRes.Input.BuyNowPrice({
    ...
    #lateInitFields(data = {}) {
      ...
      if (
        ...
        this.buyNowPrice =
          new ModifyTheBuyNowPriceInAnOfferActionRes.Input.BuyNowPrice(
            d.buyNowPrice || {},
          );
      }
    }
     ...
     **/
    static from(
      possibleDtoObject: ModifyTheBuyNowPriceInAnOfferActionResType.InputType,
    ) {
      return new ModifyTheBuyNowPriceInAnOfferActionRes.Input(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<ModifyTheBuyNowPriceInAnOfferActionResType.InputType>,
    ) {
      return new ModifyTheBuyNowPriceInAnOfferActionRes.Input(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<ModifyTheBuyNowPriceInAnOfferActionResType.InputType>,
    ): InstanceType<typeof ModifyTheBuyNowPriceInAnOfferActionRes.Input> {
      return new ModifyTheBuyNowPriceInAnOfferActionRes.Input({
        ...this.toJSON(),
        ...partial,
      });
  ...
  static Output = class Output {
     ...
     **/
    #errors: MArray<
      InstanceType<typeof ModifyTheBuyNowPriceInAnOfferActionRes.Output.Errors>
    > = MArray.of([]);
    /**
     *
    ...
    set errors(
      value:
        | MArray<
            InstanceType<
              typeof ModifyTheBuyNowPriceInAnOfferActionRes.Output.Errors
            >
          >
        | InstanceType<
            typeof ModifyTheBuyNowPriceInAnOfferActionRes.Output.Errors
    ...
    static Errors = class Errors {
      ...
      #metadata!: InstanceType<
        typeof ModifyTheBuyNowPriceInAnOfferActionRes.Output.Errors.Metadata
      >;
      /**
       *
      ...
      set metadata(
        ...
        if (
          value instanceof
          ModifyTheBuyNowPriceInAnOfferActionRes.Output.Errors.Metadata
        ) {
          this.#metadata = value;
        } else {
          this.#metadata =
            new ModifyTheBuyNowPriceInAnOfferActionRes.Output.Errors.Metadata(
              value,
            );
        }
      }
      ...
      static Metadata = class Metadata {
         ...
         **/
        static from(
          possibleDtoObject: ModifyTheBuyNowPriceInAnOfferActionResType.OutputType.ErrorsType.MetadataType,
        ) {
          return new ModifyTheBuyNowPriceInAnOfferActionRes.Output.Errors.Metadata(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<ModifyTheBuyNowPriceInAnOfferActionResType.OutputType.ErrorsType.MetadataType>,
        ) {
          return new ModifyTheBuyNowPriceInAnOfferActionRes.Output.Errors.Metadata(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<ModifyTheBuyNowPriceInAnOfferActionResType.OutputType.ErrorsType.MetadataType>,
        ): InstanceType<
          typeof ModifyTheBuyNowPriceInAnOfferActionRes.Output.Errors.Metadata
        > {
          return new ModifyTheBuyNowPriceInAnOfferActionRes.Output.Errors.Metadata(
       ...
       **/
      static from(
        possibleDtoObject: ModifyTheBuyNowPriceInAnOfferActionResType.OutputType.ErrorsType,
      ) {
        return new ModifyTheBuyNowPriceInAnOfferActionRes.Output.Errors(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<ModifyTheBuyNowPriceInAnOfferActionResType.OutputType.ErrorsType>,
      ) {
        return new ModifyTheBuyNowPriceInAnOfferActionRes.Output.Errors(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<ModifyTheBuyNowPriceInAnOfferActionResType.OutputType.ErrorsType>,
      ): InstanceType<
        typeof ModifyTheBuyNowPriceInAnOfferActionRes.Output.Errors
      > {
        return new ModifyTheBuyNowPriceInAnOfferActionRes.Output.Errors({
     ...
     **/
    static from(
      possibleDtoObject: ModifyTheBuyNowPriceInAnOfferActionResType.OutputType,
    ) {
      return new ModifyTheBuyNowPriceInAnOfferActionRes.Output(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<ModifyTheBuyNowPriceInAnOfferActionResType.OutputType>,
    ) {
      return new ModifyTheBuyNowPriceInAnOfferActionRes.Output(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<ModifyTheBuyNowPriceInAnOfferActionResType.OutputType>,
    ): InstanceType<typeof ModifyTheBuyNowPriceInAnOfferActionRes.Output> {
      return new ModifyTheBuyNowPriceInAnOfferActionRes.Output({
        ...this.toJSON(),
        ...partial,
      });
    ...
    clone(): InstanceType<
      typeof ModifyTheBuyNowPriceInAnOfferActionRes.Output
    > {
  ...
  #lateInitFields(data = {}) {
    const d = data as Partial<ModifyTheBuyNowPriceInAnOfferActionRes>;
    if (!(d.input instanceof ModifyTheBuyNowPriceInAnOfferActionRes.Input)) {
      this.input = new ModifyTheBuyNowPriceInAnOfferActionRes.Input(
        d.input || {},
      );
    }
    if (!(d.output instanceof ModifyTheBuyNowPriceInAnOfferActionRes.Output)) {
      this.output = new ModifyTheBuyNowPriceInAnOfferActionRes.Output(
        d.output || {},
      );
    }
  }
   ...
   **/
  static with(
    partialDtoObject: PartialDeep<ModifyTheBuyNowPriceInAnOfferActionResType>,
  ) {
    return new ModifyTheBuyNowPriceInAnOfferActionRes(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<ModifyTheBuyNowPriceInAnOfferActionResType>,
  ): InstanceType<typeof ModifyTheBuyNowPriceInAnOfferActionRes> {
    return new ModifyTheBuyNowPriceInAnOfferActionRes({
      ...this.toJSON(),
      ...partial,
    });
  }
