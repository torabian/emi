...
export class BatchOfferPublishUnpublishAction {
  ...
  static NewUrl = (qs?: URLSearchParams) =>
    buildUrl(BatchOfferPublishUnpublishAction.URL, undefined, qs);
  static Method = "put";
  static Fetch$ = async (
    qs?: URLSearchParams,
    ...
    return fetchx<
      BatchOfferPublishUnpublishActionRes,
      BatchOfferPublishUnpublishActionReq,
      unknown
    >(
      overrideUrl ?? BatchOfferPublishUnpublishAction.NewUrl(qs),
      {
...
export class BatchOfferPublishUnpublishActionReq {
  ...
  #offerCriteria: MArray<
    InstanceType<typeof BatchOfferPublishUnpublishActionReq.OfferCriteria>
  > = MArray.of([]);
  /**
   *
  ...
  set offerCriteria(
    value:
      | MArray<
        ...
        >
      | InstanceType<
          typeof BatchOfferPublishUnpublishActionReq.OfferCriteria
        >[],
  ) {
  ...
  #publication!: InstanceType<
    typeof BatchOfferPublishUnpublishActionReq.Publication
  >;
  /**
   *
   ...
   **/
  set publication(
    value: InstanceType<typeof BatchOfferPublishUnpublishActionReq.Publication>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof BatchOfferPublishUnpublishActionReq.Publication) {
      this.#publication = value;
    } else {
      this.#publication = new BatchOfferPublishUnpublishActionReq.Publication(
        value,
      );
    }
  }
  ...
  static OfferCriteria = class OfferCriteria {
    ...
    #offers: MArray<
      InstanceType<
        typeof BatchOfferPublishUnpublishActionReq.OfferCriteria.Offers
      >
    > = MArray.of([]);
    /**
     *
    ...
    static Offers = class Offers {
       ...
       **/
      static from(
        possibleDtoObject: BatchOfferPublishUnpublishActionReqType.OfferCriteriaType.OffersType,
      ) {
        return new BatchOfferPublishUnpublishActionReq.OfferCriteria.Offers(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<BatchOfferPublishUnpublishActionReqType.OfferCriteriaType.OffersType>,
      ) {
        return new BatchOfferPublishUnpublishActionReq.OfferCriteria.Offers(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<BatchOfferPublishUnpublishActionReqType.OfferCriteriaType.OffersType>,
      ): InstanceType<
        typeof BatchOfferPublishUnpublishActionReq.OfferCriteria.Offers
      > {
        return new BatchOfferPublishUnpublishActionReq.OfferCriteria.Offers({
     ...
     **/
    static from(
      possibleDtoObject: BatchOfferPublishUnpublishActionReqType.OfferCriteriaType,
    ) {
      return new BatchOfferPublishUnpublishActionReq.OfferCriteria(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<BatchOfferPublishUnpublishActionReqType.OfferCriteriaType>,
    ) {
      return new BatchOfferPublishUnpublishActionReq.OfferCriteria(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<BatchOfferPublishUnpublishActionReqType.OfferCriteriaType>,
    ): InstanceType<typeof BatchOfferPublishUnpublishActionReq.OfferCriteria> {
      return new BatchOfferPublishUnpublishActionReq.OfferCriteria({
        ...this.toJSON(),
        ...partial,
  ...
  static Publication = class Publication {
    ...
    applyFromObject(data = {}) {
      ...
      if (d.scheduledFor !== undefined) {
        this.scheduledFor = d.scheduledFor;
      }
    }
    /**
     *	Special toJSON override, since the field are private,
     ...
     **/
    static from(
      possibleDtoObject: BatchOfferPublishUnpublishActionReqType.PublicationType,
    ) {
      return new BatchOfferPublishUnpublishActionReq.Publication(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<BatchOfferPublishUnpublishActionReqType.PublicationType>,
    ) {
      return new BatchOfferPublishUnpublishActionReq.Publication(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<BatchOfferPublishUnpublishActionReqType.PublicationType>,
    ): InstanceType<typeof BatchOfferPublishUnpublishActionReq.Publication> {
      return new BatchOfferPublishUnpublishActionReq.Publication({
        ...this.toJSON(),
        ...partial,
      });
  ...
  #lateInitFields(data = {}) {
    ...
    if (
      !(
        d.publication instanceof BatchOfferPublishUnpublishActionReq.Publication
      )
    ) {
      this.publication = new BatchOfferPublishUnpublishActionReq.Publication(
        d.publication || {},
   ...
   **/
  static with(
    partialDtoObject: PartialDeep<BatchOfferPublishUnpublishActionReqType>,
  ) {
    return new BatchOfferPublishUnpublishActionReq(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<BatchOfferPublishUnpublishActionReqType>,
  ): InstanceType<typeof BatchOfferPublishUnpublishActionReq> {
    return new BatchOfferPublishUnpublishActionReq({
      ...this.toJSON(),
      ...partial,
    });
  }
...
export class BatchOfferPublishUnpublishActionRes {
  ...
  #taskCount!: InstanceType<
    typeof BatchOfferPublishUnpublishActionRes.TaskCount
  >;
  /**
   *
   ...
   **/
  set taskCount(
    value: InstanceType<typeof BatchOfferPublishUnpublishActionRes.TaskCount>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof BatchOfferPublishUnpublishActionRes.TaskCount) {
      this.#taskCount = value;
    } else {
      this.#taskCount = new BatchOfferPublishUnpublishActionRes.TaskCount(
        value,
      );
    }
  }
  ...
  static TaskCount = class TaskCount {
     ...
     **/
    static from(
      possibleDtoObject: BatchOfferPublishUnpublishActionResType.TaskCountType,
    ) {
      return new BatchOfferPublishUnpublishActionRes.TaskCount(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<BatchOfferPublishUnpublishActionResType.TaskCountType>,
    ) {
      return new BatchOfferPublishUnpublishActionRes.TaskCount(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<BatchOfferPublishUnpublishActionResType.TaskCountType>,
    ): InstanceType<typeof BatchOfferPublishUnpublishActionRes.TaskCount> {
      return new BatchOfferPublishUnpublishActionRes.TaskCount({
        ...this.toJSON(),
        ...partial,
      });
  ...
  #lateInitFields(data = {}) {
    const d = data as Partial<BatchOfferPublishUnpublishActionRes>;
    if (
      !(d.taskCount instanceof BatchOfferPublishUnpublishActionRes.TaskCount)
    ) {
      this.taskCount = new BatchOfferPublishUnpublishActionRes.TaskCount(
        d.taskCount || {},
      );
   ...
   **/
  static with(
    partialDtoObject: PartialDeep<BatchOfferPublishUnpublishActionResType>,
  ) {
    return new BatchOfferPublishUnpublishActionRes(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<BatchOfferPublishUnpublishActionResType>,
  ): InstanceType<typeof BatchOfferPublishUnpublishActionRes> {
    return new BatchOfferPublishUnpublishActionRes({
      ...this.toJSON(),
      ...partial,
    });
  }
