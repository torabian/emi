...
export class GetAllDataOfTheParticularProductOfferAction {
  ...
  static NewUrl = (qs?: URLSearchParams) =>
    buildUrl(GetAllDataOfTheParticularProductOfferAction.URL, undefined, qs);
  static Method = "get";
  static Fetch$ = async (
    qs?: URLSearchParams,
    ...
    return fetchx<
      GetAllDataOfTheParticularProductOfferActionRes,
      unknown,
      unknown
    >(
      overrideUrl ?? GetAllDataOfTheParticularProductOfferAction.NewUrl(qs),
      {
  ...
  static Fetch = async (
    init?: TypedRequestInit<unknown, unknown>,
    {
      ...
      creatorFn?:
        | ((item: unknown) => GetAllDataOfTheParticularProductOfferActionRes)
        | undefined;
      qs?: URLSearchParams;
      ctx?: FetchxContext | null;
      ...
      creatorFn: (item) =>
        new GetAllDataOfTheParticularProductOfferActionRes(item),
    },
  ) => {
    creatorFn =
      creatorFn ||
      ((item) => new GetAllDataOfTheParticularProductOfferActionRes(item));
  ...
  static Definition = {
    ...
    method: "get",
    description:
      "Full response model returned by GET /sale/product-offers/{offerId}",
    out: {
      fields: [
        {
          name: "id",
...
export class GetAllDataOfTheParticularProductOfferActionRes {
  ...
  #category!: InstanceType<
    typeof GetAllDataOfTheParticularProductOfferActionRes.Category
  >;
  /**
   *
  ...
  set category(
    ...
    if (
      value instanceof GetAllDataOfTheParticularProductOfferActionRes.Category
    ) {
      this.#category = value;
    } else {
      this.#category =
        new GetAllDataOfTheParticularProductOfferActionRes.Category(value);
    }
  }
  setCategory(
    value: InstanceType<
   ...
   **/
  #stock!: InstanceType<
    typeof GetAllDataOfTheParticularProductOfferActionRes.Stock
  >;
  /**
   *
  ...
  set stock(
    ...
    if (value instanceof GetAllDataOfTheParticularProductOfferActionRes.Stock) {
      ...
      this.#stock = new GetAllDataOfTheParticularProductOfferActionRes.Stock(
        value,
      );
    }
  }
   ...
   **/
  #contact!: InstanceType<
    typeof GetAllDataOfTheParticularProductOfferActionRes.Contact
  >;
  /**
   *
  ...
  set contact(
    ...
    // For objects, the sub type needs to always be instance of the sub class.
    if (
      value instanceof GetAllDataOfTheParticularProductOfferActionRes.Contact
    ) {
      this.#contact = value;
    } else {
      this.#contact =
        new GetAllDataOfTheParticularProductOfferActionRes.Contact(value);
    }
  }
  setContact(
    value: InstanceType<
  ...
  #publication!: InstanceType<
    typeof GetAllDataOfTheParticularProductOfferActionRes.Publication
  >;
  /**
   *
  ...
  set publication(
    ...
    if (
      value instanceof
      GetAllDataOfTheParticularProductOfferActionRes.Publication
    ) {
      this.#publication = value;
    } else {
      this.#publication =
        new GetAllDataOfTheParticularProductOfferActionRes.Publication(value);
    }
  }
  setPublication(
    value: InstanceType<
  ...
  #sellingMode!: InstanceType<
    typeof GetAllDataOfTheParticularProductOfferActionRes.SellingMode
  >;
  /**
   *
  ...
  set sellingMode(
    ...
    if (
      value instanceof
      GetAllDataOfTheParticularProductOfferActionRes.SellingMode
    ) {
      this.#sellingMode = value;
    } else {
      this.#sellingMode =
        new GetAllDataOfTheParticularProductOfferActionRes.SellingMode(value);
    }
  }
  setSellingMode(
    value: InstanceType<
   ...
   **/
  #payments!: InstanceType<
    typeof GetAllDataOfTheParticularProductOfferActionRes.Payments
  >;
  /**
   *
  ...
  set payments(
    ...
    // For objects, the sub type needs to always be instance of the sub class.
    if (
      value instanceof GetAllDataOfTheParticularProductOfferActionRes.Payments
    ) {
      this.#payments = value;
    } else {
      this.#payments =
        new GetAllDataOfTheParticularProductOfferActionRes.Payments(value);
    }
  }
  setPayments(
    value: InstanceType<
   ...
   **/
  #delivery!: InstanceType<
    typeof GetAllDataOfTheParticularProductOfferActionRes.Delivery
  >;
  /**
   *
  ...
  set delivery(
    ...
    // For objects, the sub type needs to always be instance of the sub class.
    if (
      value instanceof GetAllDataOfTheParticularProductOfferActionRes.Delivery
    ) {
      this.#delivery = value;
    } else {
      this.#delivery =
        new GetAllDataOfTheParticularProductOfferActionRes.Delivery(value);
    }
  }
  setDelivery(
    value: InstanceType<
  ...
  #afterSalesServices!: InstanceType<
    typeof GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices
  >;
  /**
   *
  ...
  set afterSalesServices(
    ...
    if (
      value instanceof
      GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices
    ) {
      this.#afterSalesServices = value;
    } else {
      this.#afterSalesServices =
        new GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices(
          value,
        );
    }
  }
   ...
   **/
  #discounts!: InstanceType<
    typeof GetAllDataOfTheParticularProductOfferActionRes.Discounts
  >;
  /**
   *
  ...
  set discounts(
    ...
    // For objects, the sub type needs to always be instance of the sub class.
    if (
      value instanceof GetAllDataOfTheParticularProductOfferActionRes.Discounts
    ) {
      this.#discounts = value;
    } else {
      this.#discounts =
        new GetAllDataOfTheParticularProductOfferActionRes.Discounts(value);
    }
  }
  setDiscounts(
    value: InstanceType<
  ...
  #description!: InstanceType<
    typeof GetAllDataOfTheParticularProductOfferActionRes.Description
  >;
  /**
   *
  ...
  set description(
    ...
    if (
      value instanceof
      GetAllDataOfTheParticularProductOfferActionRes.Description
    ) {
      this.#description = value;
    } else {
      this.#description =
        new GetAllDataOfTheParticularProductOfferActionRes.Description(value);
    }
  }
  setDescription(
    value: InstanceType<
  ...
  set productSet(
    ...
    if (Array.isArray(value)) {
      if (
        value.length > 0 &&
        value[0] instanceof
          GetAllDataOfTheParticularProductOfferActionRes.ProductSet
      ) {
        ...
        this.#productSet = MArray.of(
          value.map(
            (item) =>
              new GetAllDataOfTheParticularProductOfferActionRes.ProductSet(
                item,
              ),
          ),
        );
  ...
  set attachments(
    ...
    if (Array.isArray(value)) {
      if (
        value.length > 0 &&
        value[0] instanceof
          GetAllDataOfTheParticularProductOfferActionRes.Attachments
      ) {
        ...
        this.#attachments = MArray.of(
          value.map(
            (item) =>
              new GetAllDataOfTheParticularProductOfferActionRes.Attachments(
                item,
              ),
          ),
        );
  ...
  #fundraisingCampaign!: InstanceType<
    typeof GetAllDataOfTheParticularProductOfferActionRes.FundraisingCampaign
  >;
  /**
   *
  ...
  set fundraisingCampaign(
    ...
    if (
      value instanceof
      GetAllDataOfTheParticularProductOfferActionRes.FundraisingCampaign
    ) {
      this.#fundraisingCampaign = value;
    } else {
      this.#fundraisingCampaign =
        new GetAllDataOfTheParticularProductOfferActionRes.FundraisingCampaign(
          value,
        );
    }
  }
  ...
  #additionalServices!: InstanceType<
    typeof GetAllDataOfTheParticularProductOfferActionRes.AdditionalServices
  >;
  /**
   *
  ...
  set additionalServices(
    ...
    if (
      value instanceof
      GetAllDataOfTheParticularProductOfferActionRes.AdditionalServices
    ) {
      this.#additionalServices = value;
    } else {
      this.#additionalServices =
        new GetAllDataOfTheParticularProductOfferActionRes.AdditionalServices(
          value,
        );
    }
  }
   ...
   **/
  #b2b!: InstanceType<
    typeof GetAllDataOfTheParticularProductOfferActionRes.B2b
  >;
  /**
   *
  ...
  #compatibilityList!: InstanceType<
    typeof GetAllDataOfTheParticularProductOfferActionRes.CompatibilityList
  >;
  /**
   *
  ...
  set compatibilityList(
    ...
    if (
      value instanceof
      GetAllDataOfTheParticularProductOfferActionRes.CompatibilityList
    ) {
      this.#compatibilityList = value;
    } else {
      this.#compatibilityList =
        new GetAllDataOfTheParticularProductOfferActionRes.CompatibilityList(
          value,
        );
    }
  }
  ...
  #validation!: InstanceType<
    typeof GetAllDataOfTheParticularProductOfferActionRes.Validation
  >;
  /**
   *
  ...
  set validation(
    ...
    // For objects, the sub type needs to always be instance of the sub class.
    if (
      value instanceof GetAllDataOfTheParticularProductOfferActionRes.Validation
    ) {
      this.#validation = value;
    } else {
      this.#validation =
        new GetAllDataOfTheParticularProductOfferActionRes.Validation(value);
    }
  }
  setValidation(
    value: InstanceType<
  ...
  #external!: InstanceType<
    typeof GetAllDataOfTheParticularProductOfferActionRes.External
  >;
  /**
   *
  ...
  set external(
    ...
    // For objects, the sub type needs to always be instance of the sub class.
    if (
      value instanceof GetAllDataOfTheParticularProductOfferActionRes.External
    ) {
      this.#external = value;
    } else {
      this.#external =
        new GetAllDataOfTheParticularProductOfferActionRes.External(value);
    }
  }
  setExternal(
    value: InstanceType<
   ...
   **/
  #sizeTable!: InstanceType<
    typeof GetAllDataOfTheParticularProductOfferActionRes.SizeTable
  >;
  /**
   *
  ...
  set sizeTable(
    ...
    // For objects, the sub type needs to always be instance of the sub class.
    if (
      value instanceof GetAllDataOfTheParticularProductOfferActionRes.SizeTable
    ) {
      this.#sizeTable = value;
    } else {
      this.#sizeTable =
        new GetAllDataOfTheParticularProductOfferActionRes.SizeTable(value);
    }
  }
  setSizeTable(
    value: InstanceType<
   ...
   **/
  #taxSettings!: InstanceType<
    typeof GetAllDataOfTheParticularProductOfferActionRes.TaxSettings
  >;
  /**
   *
  ...
  set taxSettings(
    ...
    if (
      value instanceof
      GetAllDataOfTheParticularProductOfferActionRes.TaxSettings
    ) {
      this.#taxSettings = value;
    } else {
      this.#taxSettings =
        new GetAllDataOfTheParticularProductOfferActionRes.TaxSettings(value);
    }
  }
  setTaxSettings(
    value: InstanceType<
  ...
  #messageToSellerSettings!: InstanceType<
    typeof GetAllDataOfTheParticularProductOfferActionRes.MessageToSellerSettings
  >;
  /**
   *
  ...
  set messageToSellerSettings(
    ...
    if (
      value instanceof
      GetAllDataOfTheParticularProductOfferActionRes.MessageToSellerSettings
    ) {
      this.#messageToSellerSettings = value;
    } else {
      this.#messageToSellerSettings =
        new GetAllDataOfTheParticularProductOfferActionRes.MessageToSellerSettings(
          value,
        );
    }
  }
  ...
  static Category = class Category {
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.CategoryType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Category(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.CategoryType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Category(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.CategoryType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.Category
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.Category({
  ...
  static Stock = class Stock {
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.StockType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Stock(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.StockType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Stock(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.StockType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.Stock
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.Stock({
  ...
  static Contact = class Contact {
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.ContactType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Contact(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ContactType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Contact(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ContactType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.Contact
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.Contact({
  ...
  static Publication = class Publication {
    ...
    #marketplaces!: InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.Publication.Marketplaces
    >;
    /**
     *
    ...
    set marketplaces(
      ...
      if (
        value instanceof
        GetAllDataOfTheParticularProductOfferActionRes.Publication.Marketplaces
      ) {
        this.#marketplaces = value;
      } else {
        this.#marketplaces =
          new GetAllDataOfTheParticularProductOfferActionRes.Publication.Marketplaces(
            value,
          );
      }
    }
    ...
    static Marketplaces = class Marketplaces {
       ...
       **/
      #base!: InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.Publication.Marketplaces.Base
      >;
      /**
       *
      ...
      set base(
        ...
        if (
          ...
          this.#base =
            new GetAllDataOfTheParticularProductOfferActionRes.Publication.Marketplaces.Base(
              value,
            );
        }
      }
        ...
        if (Array.isArray(value)) {
          if (
            ...
            this.#additional = MArray.of(
              value.map(
                (item) =>
                  new GetAllDataOfTheParticularProductOfferActionRes.Publication.Marketplaces.Additional(
                    item,
                  ),
              ),
            );
      ...
      static Base = class Base {
         ...
         **/
        static from(
          possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.PublicationType.MarketplacesType.BaseType,
        ) {
          return new GetAllDataOfTheParticularProductOfferActionRes.Publication.Marketplaces.Base(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.PublicationType.MarketplacesType.BaseType>,
        ) {
          return new GetAllDataOfTheParticularProductOfferActionRes.Publication.Marketplaces.Base(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.PublicationType.MarketplacesType.BaseType>,
        ): InstanceType<
          typeof GetAllDataOfTheParticularProductOfferActionRes.Publication.Marketplaces.Base
        > {
          return new GetAllDataOfTheParticularProductOfferActionRes.Publication.Marketplaces.Base(
      ...
      static Additional = class Additional {
         ...
         **/
        static from(
          possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.PublicationType.MarketplacesType.AdditionalType,
        ) {
          return new GetAllDataOfTheParticularProductOfferActionRes.Publication.Marketplaces.Additional(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.PublicationType.MarketplacesType.AdditionalType>,
        ) {
          return new GetAllDataOfTheParticularProductOfferActionRes.Publication.Marketplaces.Additional(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.PublicationType.MarketplacesType.AdditionalType>,
        ): InstanceType<
          typeof GetAllDataOfTheParticularProductOfferActionRes.Publication.Marketplaces.Additional
        > {
          return new GetAllDataOfTheParticularProductOfferActionRes.Publication.Marketplaces.Additional(
        ...
        return {
          ...
          get additional() {
            return withPrefix(
              ...
              GetAllDataOfTheParticularProductOfferActionRes.Publication
                .Marketplaces.Additional.Fields,
            );
          },
        };
      }
       ...
       **/
      static from(
        possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.PublicationType.MarketplacesType,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.Publication.Marketplaces(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.PublicationType.MarketplacesType>,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.Publication.Marketplaces(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.PublicationType.MarketplacesType>,
      ): InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.Publication.Marketplaces
      > {
        return new GetAllDataOfTheParticularProductOfferActionRes.Publication.Marketplaces(
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.PublicationType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Publication(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.PublicationType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Publication(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.PublicationType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.Publication
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.Publication({
  ...
  static SellingMode = class SellingMode {
     ...
     **/
    #price!: InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.SellingMode.Price
    >;
    /**
     *
    ...
    set price(
      ...
      if (
        value instanceof
        GetAllDataOfTheParticularProductOfferActionRes.SellingMode.Price
      ) {
        this.#price = value;
      } else {
        this.#price =
          new GetAllDataOfTheParticularProductOfferActionRes.SellingMode.Price(
            value,
          );
      }
    }
    ...
    #minimalPrice!: InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.SellingMode.MinimalPrice
    >;
    /**
     *
    ...
    set minimalPrice(
      ...
      if (
        value instanceof
        GetAllDataOfTheParticularProductOfferActionRes.SellingMode.MinimalPrice
      ) {
        this.#minimalPrice = value;
      } else {
        this.#minimalPrice =
          new GetAllDataOfTheParticularProductOfferActionRes.SellingMode.MinimalPrice(
            value,
          );
      }
    }
    ...
    #startingPrice!: InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.SellingMode.StartingPrice
    >;
    /**
     *
    ...
    set startingPrice(
      ...
      if (
        value instanceof
        GetAllDataOfTheParticularProductOfferActionRes.SellingMode.StartingPrice
      ) {
        this.#startingPrice = value;
      } else {
        this.#startingPrice =
          new GetAllDataOfTheParticularProductOfferActionRes.SellingMode.StartingPrice(
            value,
          );
      }
    }
    ...
    static Price = class Price {
       ...
       **/
      static from(
        possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.SellingModeType.PriceType,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.SellingMode.Price(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.SellingModeType.PriceType>,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.SellingMode.Price(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.SellingModeType.PriceType>,
      ): InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.SellingMode.Price
      > {
        return new GetAllDataOfTheParticularProductOfferActionRes.SellingMode.Price(
    ...
    static MinimalPrice = class MinimalPrice {
       ...
       **/
      static from(
        possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.SellingModeType.MinimalPriceType,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.SellingMode.MinimalPrice(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.SellingModeType.MinimalPriceType>,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.SellingMode.MinimalPrice(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.SellingModeType.MinimalPriceType>,
      ): InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.SellingMode.MinimalPrice
      > {
        return new GetAllDataOfTheParticularProductOfferActionRes.SellingMode.MinimalPrice(
    ...
    static StartingPrice = class StartingPrice {
       ...
       **/
      static from(
        possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.SellingModeType.StartingPriceType,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.SellingMode.StartingPrice(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.SellingModeType.StartingPriceType>,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.SellingMode.StartingPrice(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.SellingModeType.StartingPriceType>,
      ): InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.SellingMode.StartingPrice
      > {
        return new GetAllDataOfTheParticularProductOfferActionRes.SellingMode.StartingPrice(
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.SellingModeType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.SellingMode(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.SellingModeType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.SellingMode(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.SellingModeType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.SellingMode
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.SellingMode({
  ...
  static Payments = class Payments {
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.PaymentsType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Payments(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.PaymentsType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Payments(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.PaymentsType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.Payments
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.Payments({
  ...
  static Delivery = class Delivery {
    ...
    #shippingRates!: InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.Delivery.ShippingRates
    >;
    /**
     *
    ...
    set shippingRates(
      ...
      if (
        value instanceof
        GetAllDataOfTheParticularProductOfferActionRes.Delivery.ShippingRates
      ) {
        this.#shippingRates = value;
      } else {
        this.#shippingRates =
          new GetAllDataOfTheParticularProductOfferActionRes.Delivery.ShippingRates(
            value,
          );
      }
    }
    ...
    static ShippingRates = class ShippingRates {
       ...
       **/
      static from(
        possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.DeliveryType.ShippingRatesType,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.Delivery.ShippingRates(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.DeliveryType.ShippingRatesType>,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.Delivery.ShippingRates(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.DeliveryType.ShippingRatesType>,
      ): InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.Delivery.ShippingRates
      > {
        return new GetAllDataOfTheParticularProductOfferActionRes.Delivery.ShippingRates(
      ...
      return {
        ...
        get shippingRates() {
          return withPrefix(
            ...
            GetAllDataOfTheParticularProductOfferActionRes.Delivery
              .ShippingRates.Fields,
          );
        },
      };
    }
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.DeliveryType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Delivery(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.DeliveryType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Delivery(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.DeliveryType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.Delivery
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.Delivery({
  ...
  static AfterSalesServices = class AfterSalesServices {
    ...
    #impliedWarranty!: InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices.ImpliedWarranty
    >;
    /**
     *
    ...
    set impliedWarranty(
      ...
      if (
        ...
        this.#impliedWarranty =
          new GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices.ImpliedWarranty(
            value,
          );
      }
    }
    ...
    #returnPolicy!: InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices.ReturnPolicy
    >;
    /**
     *
    ...
    set returnPolicy(
      ...
      if (
        ...
        this.#returnPolicy =
          new GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices.ReturnPolicy(
            value,
          );
      }
    }
    ...
    #warranty!: InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices.Warranty
    >;
    /**
     *
    ...
    set warranty(
      ...
      if (
        ...
        this.#warranty =
          new GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices.Warranty(
            value,
          );
      }
    }
    ...
    static ImpliedWarranty = class ImpliedWarranty {
       ...
       **/
      static from(
        possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.AfterSalesServicesType.ImpliedWarrantyType,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices.ImpliedWarranty(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.AfterSalesServicesType.ImpliedWarrantyType>,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices.ImpliedWarranty(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.AfterSalesServicesType.ImpliedWarrantyType>,
      ): InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices.ImpliedWarranty
      > {
        return new GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices.ImpliedWarranty(
    ...
    static ReturnPolicy = class ReturnPolicy {
       ...
       **/
      static from(
        possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.AfterSalesServicesType.ReturnPolicyType,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices.ReturnPolicy(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.AfterSalesServicesType.ReturnPolicyType>,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices.ReturnPolicy(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.AfterSalesServicesType.ReturnPolicyType>,
      ): InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices.ReturnPolicy
      > {
        return new GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices.ReturnPolicy(
    ...
    static Warranty = class Warranty {
       ...
       **/
      static from(
        possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.AfterSalesServicesType.WarrantyType,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices.Warranty(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.AfterSalesServicesType.WarrantyType>,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices.Warranty(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.AfterSalesServicesType.WarrantyType>,
      ): InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices.Warranty
      > {
        return new GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices.Warranty(
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.AfterSalesServicesType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.AfterSalesServicesType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.AfterSalesServicesType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices(
  ...
  static Discounts = class Discounts {
    ...
    #wholesalePriceList!: InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.Discounts.WholesalePriceList
    >;
    /**
     *
    ...
    set wholesalePriceList(
      ...
      if (
        value instanceof
        GetAllDataOfTheParticularProductOfferActionRes.Discounts
          .WholesalePriceList
      ) {
        this.#wholesalePriceList = value;
      } else {
        this.#wholesalePriceList =
          new GetAllDataOfTheParticularProductOfferActionRes.Discounts.WholesalePriceList(
            value,
          );
      }
    }
    ...
    static WholesalePriceList = class WholesalePriceList {
       ...
       **/
      static from(
        possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.DiscountsType.WholesalePriceListType,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.Discounts.WholesalePriceList(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.DiscountsType.WholesalePriceListType>,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.Discounts.WholesalePriceList(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.DiscountsType.WholesalePriceListType>,
      ): InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.Discounts.WholesalePriceList
      > {
        return new GetAllDataOfTheParticularProductOfferActionRes.Discounts.WholesalePriceList(
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.DiscountsType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Discounts(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.DiscountsType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Discounts(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.DiscountsType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.Discounts
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.Discounts({
  ...
  static Description = class Description {
    ...
    set sections(
      ...
      if (Array.isArray(value)) {
        if (
          value.length > 0 &&
          value[0] instanceof
            GetAllDataOfTheParticularProductOfferActionRes.Description.Sections
        ) {
          ...
          this.#sections = MArray.of(
            value.map(
              (item) =>
                new GetAllDataOfTheParticularProductOfferActionRes.Description.Sections(
                  item,
                ),
            ),
          );
    ...
    static Sections = class Sections {
        ...
        if (Array.isArray(value)) {
          if (
            ...
            this.#items = MArray.of(
              value.map(
                (item) =>
                  new GetAllDataOfTheParticularProductOfferActionRes.Description.Sections.Items(
                    item,
                  ),
              ),
            );
      ...
      static Items = class Items {
         ...
         **/
        static from(
          possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.DescriptionType.SectionsType.ItemsType,
        ) {
          return new GetAllDataOfTheParticularProductOfferActionRes.Description.Sections.Items(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.DescriptionType.SectionsType.ItemsType>,
        ) {
          return new GetAllDataOfTheParticularProductOfferActionRes.Description.Sections.Items(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.DescriptionType.SectionsType.ItemsType>,
        ): InstanceType<
          typeof GetAllDataOfTheParticularProductOfferActionRes.Description.Sections.Items
        > {
          return new GetAllDataOfTheParticularProductOfferActionRes.Description.Sections.Items(
       ...
       **/
      static from(
        possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.DescriptionType.SectionsType,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.Description.Sections(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.DescriptionType.SectionsType>,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.Description.Sections(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.DescriptionType.SectionsType>,
      ): InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.Description.Sections
      > {
        return new GetAllDataOfTheParticularProductOfferActionRes.Description.Sections(
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.DescriptionType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Description(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.DescriptionType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Description(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.DescriptionType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.Description
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.Description({
  ...
  static ProductSet = class ProductSet {
     ...
     **/
    #quantity!: InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Quantity
    >;
    /**
     *
    ...
    set quantity(
      ...
      if (
        value instanceof
        GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Quantity
      ) {
        this.#quantity = value;
      } else {
        this.#quantity =
          new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Quantity(
            value,
          );
      }
    }
    ...
    #product!: InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product
    >;
    /**
     *
    ...
    set product(
      ...
      if (
        value instanceof
        GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product
      ) {
        this.#product = value;
      } else {
        this.#product =
          new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product(
            value,
          );
      }
    }
    ...
    #responsiblePerson!: InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.ProductSet.ResponsiblePerson
    >;
    /**
     *
    ...
    set responsiblePerson(
      ...
      if (
        ...
        this.#responsiblePerson =
          new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.ResponsiblePerson(
            value,
          );
      }
    }
    ...
    #responsibleProducer!: InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.ProductSet.ResponsibleProducer
    >;
    /**
     *
    ...
    set responsibleProducer(
      ...
      if (
        ...
        this.#responsibleProducer =
          new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.ResponsibleProducer(
            value,
          );
      }
    }
    ...
    #safetyInformation!: InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.ProductSet.SafetyInformation
    >;
    /**
     *
    ...
    set safetyInformation(
      ...
      if (
        ...
        this.#safetyInformation =
          new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.SafetyInformation(
            value,
          );
      }
    }
    ...
    set deposits(
      ...
      if (Array.isArray(value)) {
        if (
          value.length > 0 &&
          value[0] instanceof
            GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Deposits
        ) {
          ...
          this.#deposits = MArray.of(
            value.map(
              (item) =>
                new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Deposits(
                  item,
                ),
            ),
          );
    ...
    static Quantity = class Quantity {
       ...
       **/
      static from(
        possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.QuantityType,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Quantity(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.QuantityType>,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Quantity(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.QuantityType>,
      ): InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Quantity
      > {
        return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Quantity(
    ...
    static Product = class Product {
       ...
       **/
      #publication!: InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Publication
      >;
      /**
       *
      ...
      set publication(
        ...
        if (
          ...
          this.#publication =
            new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Publication(
              value,
            );
        }
      }
        ...
        if (Array.isArray(value)) {
          if (
            ...
            this.#parameters = MArray.of(
              value.map(
                (item) =>
                  new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters(
                    item,
                  ),
              ),
            );
      ...
      static Publication = class Publication {
         ...
         **/
        static from(
          possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ProductType.PublicationType,
        ) {
          return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Publication(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ProductType.PublicationType>,
        ) {
          return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Publication(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ProductType.PublicationType>,
        ): InstanceType<
          typeof GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Publication
        > {
          return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Publication(
      ...
      static Parameters = class Parameters {
        ...
        #rangeValue!: InstanceType<
          typeof GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.RangeValue
        >;
        /**
         *
        ...
        set rangeValue(
          ...
          if (
            ...
            this.#rangeValue =
              new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.RangeValue(
                value,
              );
          }
        }
        ...
        set values(
          ...
          if (Array.isArray(value)) {
            if (
              ...
              value[0] instanceof
                GetAllDataOfTheParticularProductOfferActionRes.ProductSet
                  .Product.Parameters.Values
            ) {
              this.#values = MArray.of(value);
            } else {
              this.#values = MArray.of(
                value.map(
                  (item) =>
                    new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.Values(
                      item,
                    ),
                ),
              );
          ...
          const { ok, value: mcastValue } = MArray.cast<unknown>(value);
          if (ok) {
            this.#values = mcastValue as any;
            return;
          }
          console.warn(
            "Cannot assing value to values, because it needs MArray instance or an Array.",
          );
        }
        setValues(
          value:
        ...
        set valuesIds(
          ...
          if (Array.isArray(value)) {
            if (
              ...
              value[0] instanceof
                GetAllDataOfTheParticularProductOfferActionRes.ProductSet
                  .Product.Parameters.ValuesIds
            ) {
              this.#valuesIds = MArray.of(value);
            } else {
              this.#valuesIds = MArray.of(
                value.map(
                  (item) =>
                    new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.ValuesIds(
                      item,
                    ),
                ),
              );
          ...
          const { ok, value: mcastValue } = MArray.cast<unknown>(value);
          if (ok) {
            this.#valuesIds = mcastValue as any;
            return;
          }
          console.warn(
            "Cannot assing value to valuesIds, because it needs MArray instance or an Array.",
          );
        }
        setValuesIds(
          value:
        ...
        static RangeValue = class RangeValue {
           ...
           **/
          static from(
            possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ProductType.ParametersType.RangeValueType,
          ) {
            return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.RangeValue(
              possibleDtoObject,
            );
          }
          /**
           ...
           **/
          static with(
            partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ProductType.ParametersType.RangeValueType>,
          ) {
            return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.RangeValue(
              partialDtoObject,
            );
          ...
          copyWith(
            partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ProductType.ParametersType.RangeValueType>,
          ): InstanceType<
            typeof GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.RangeValue
          > {
            return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.RangeValue(
        ...
        static Values = class Values {
           ...
           **/
          applyFromObject(data = {}) {
            const d = data as Partial<Values>;
          }
          /**
           *	Special toJSON override, since the field are private,
           *	Json stringify won't see them unless we mention it explicitly.
          ...
          /**
           * Creates an instance of GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.Values, and possibleDtoObject
           * needs to satisfy the type requirement fully, otherwise typescript compile would
           * be complaining.
           **/
          static from(
            possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ProductType.ParametersType.ValuesType,
          ) {
            return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.Values(
              possibleDtoObject,
            );
          }
          /**
           * Creates an instance of GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.Values, and partialDtoObject
           * needs to satisfy the type, but partially, and rest of the content would
           * be constructed according to data types and nullability.
           **/
          static with(
            partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ProductType.ParametersType.ValuesType>,
          ) {
            return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.Values(
              partialDtoObject,
            );
          ...
          copyWith(
            partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ProductType.ParametersType.ValuesType>,
          ): InstanceType<
            typeof GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.Values
          > {
            return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.Values(
         ...
         **/
        static ValuesIds = class ValuesIds {
          constructor(data: unknown = undefined) {
            if (data === null || data === undefined) {
              return;
            }
           ...
           **/
          applyFromObject(data = {}) {
            const d = data as Partial<ValuesIds>;
          }
          /**
           *	Special toJSON override, since the field are private,
           *	Json stringify won't see them unless we mention it explicitly.
          ...
          /**
           * Creates an instance of GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.ValuesIds, and possibleDtoObject
           * needs to satisfy the type requirement fully, otherwise typescript compile would
           * be complaining.
           **/
          static from(
            possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ProductType.ParametersType.ValuesIdsType,
          ) {
            return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.ValuesIds(
              possibleDtoObject,
            );
          }
          /**
           * Creates an instance of GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.ValuesIds, and partialDtoObject
           * needs to satisfy the type, but partially, and rest of the content would
           * be constructed according to data types and nullability.
           **/
          static with(
            partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ProductType.ParametersType.ValuesIdsType>,
          ) {
            return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.ValuesIds(
              partialDtoObject,
            );
          ...
          copyWith(
            partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ProductType.ParametersType.ValuesIdsType>,
          ): InstanceType<
            typeof GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.ValuesIds
          > {
            return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters.ValuesIds(
          ...
          return {
            ...
            get rangeValue() {
              return withPrefix(
                ...
                GetAllDataOfTheParticularProductOfferActionRes.ProductSet
                  .Product.Parameters.RangeValue.Fields,
              );
            },
            values$: "values",
            get values() {
              return withPrefix(
                ...
                GetAllDataOfTheParticularProductOfferActionRes.ProductSet
                  .Product.Parameters.Values.Fields,
              );
            },
            valuesIds$: "valuesIds",
            get valuesIds() {
              return withPrefix(
                ...
                GetAllDataOfTheParticularProductOfferActionRes.ProductSet
                  .Product.Parameters.ValuesIds.Fields,
              );
            },
          };
        }
         ...
         **/
        static from(
          possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ProductType.ParametersType,
        ) {
          return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ProductType.ParametersType>,
        ) {
          return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ProductType.ParametersType>,
        ): InstanceType<
          typeof GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters
        > {
          return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product.Parameters(
       ...
       **/
      static from(
        possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ProductType,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ProductType>,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ProductType>,
      ): InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product
      > {
        return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Product(
    ...
    static ResponsiblePerson = class ResponsiblePerson {
       ...
       **/
      static from(
        possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ResponsiblePersonType,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.ResponsiblePerson(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ResponsiblePersonType>,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.ResponsiblePerson(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ResponsiblePersonType>,
      ): InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.ProductSet.ResponsiblePerson
      > {
        return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.ResponsiblePerson(
    ...
    static ResponsibleProducer = class ResponsibleProducer {
       ...
       **/
      static from(
        possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ResponsibleProducerType,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.ResponsibleProducer(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ResponsibleProducerType>,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.ResponsibleProducer(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.ResponsibleProducerType>,
      ): InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.ProductSet.ResponsibleProducer
      > {
        return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.ResponsibleProducer(
    ...
    static SafetyInformation = class SafetyInformation {
       ...
       **/
      static from(
        possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.SafetyInformationType,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.SafetyInformation(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.SafetyInformationType>,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.SafetyInformation(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.SafetyInformationType>,
      ): InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.ProductSet.SafetyInformation
      > {
        return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.SafetyInformation(
    ...
    static Deposits = class Deposits {
       ...
       **/
      static from(
        possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.DepositsType,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Deposits(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.DepositsType>,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Deposits(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType.DepositsType>,
      ): InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Deposits
      > {
        return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet.Deposits(
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.ProductSetType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ProductSetType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.ProductSet
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.ProductSet({
  ...
  static Attachments = class Attachments {
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.AttachmentsType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Attachments(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.AttachmentsType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Attachments(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.AttachmentsType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.Attachments
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.Attachments({
  ...
  static FundraisingCampaign = class FundraisingCampaign {
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.FundraisingCampaignType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.FundraisingCampaign(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.FundraisingCampaignType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.FundraisingCampaign(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.FundraisingCampaignType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.FundraisingCampaign
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.FundraisingCampaign(
  ...
  static AdditionalServices = class AdditionalServices {
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.AdditionalServicesType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.AdditionalServices(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.AdditionalServicesType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.AdditionalServices(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.AdditionalServicesType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.AdditionalServices
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.AdditionalServices(
  ...
  static B2b = class B2b {
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.B2bType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.B2b(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.B2bType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.B2b(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.B2bType>,
    ): InstanceType<typeof GetAllDataOfTheParticularProductOfferActionRes.B2b> {
      return new GetAllDataOfTheParticularProductOfferActionRes.B2b({
        ...this.toJSON(),
        ...partial,
      });
  ...
  static CompatibilityList = class CompatibilityList {
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.CompatibilityListType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.CompatibilityList(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.CompatibilityListType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.CompatibilityList(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.CompatibilityListType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.CompatibilityList
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.CompatibilityList(
  ...
  static Validation = class Validation {
    ...
    set errors(
      ...
      if (Array.isArray(value)) {
        if (
          value.length > 0 &&
          value[0] instanceof
            GetAllDataOfTheParticularProductOfferActionRes.Validation.Errors
        ) {
          ...
          this.#errors = MArray.of(
            value.map(
              (item) =>
                new GetAllDataOfTheParticularProductOfferActionRes.Validation.Errors(
                  item,
                ),
            ),
          );
    ...
    set warnings(
      ...
      if (Array.isArray(value)) {
        if (
          value.length > 0 &&
          value[0] instanceof
            GetAllDataOfTheParticularProductOfferActionRes.Validation.Warnings
        ) {
          ...
          this.#warnings = MArray.of(
            value.map(
              (item) =>
                new GetAllDataOfTheParticularProductOfferActionRes.Validation.Warnings(
                  item,
                ),
            ),
          );
    ...
    static Errors = class Errors {
      ...
      #metadata!: InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.Validation.Errors.Metadata
      >;
      /**
       *
      ...
      set metadata(
        ...
        if (
          ...
          this.#metadata =
            new GetAllDataOfTheParticularProductOfferActionRes.Validation.Errors.Metadata(
              value,
            );
        }
      }
      ...
      static Metadata = class Metadata {
         ...
         **/
        static from(
          possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.ValidationType.ErrorsType.MetadataType,
        ) {
          return new GetAllDataOfTheParticularProductOfferActionRes.Validation.Errors.Metadata(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ValidationType.ErrorsType.MetadataType>,
        ) {
          return new GetAllDataOfTheParticularProductOfferActionRes.Validation.Errors.Metadata(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ValidationType.ErrorsType.MetadataType>,
        ): InstanceType<
          typeof GetAllDataOfTheParticularProductOfferActionRes.Validation.Errors.Metadata
        > {
          return new GetAllDataOfTheParticularProductOfferActionRes.Validation.Errors.Metadata(
       ...
       **/
      static from(
        possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.ValidationType.ErrorsType,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.Validation.Errors(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ValidationType.ErrorsType>,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.Validation.Errors(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ValidationType.ErrorsType>,
      ): InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.Validation.Errors
      > {
        return new GetAllDataOfTheParticularProductOfferActionRes.Validation.Errors(
    ...
    static Warnings = class Warnings {
       ...
       **/
      #metadata!: InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.Validation.Warnings.Metadata
      >;
      /**
       *
      ...
      set metadata(
        ...
        if (
          ...
          this.#metadata =
            new GetAllDataOfTheParticularProductOfferActionRes.Validation.Warnings.Metadata(
              value,
            );
        }
      }
      ...
      static Metadata = class Metadata {
         ...
         **/
        static from(
          possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.ValidationType.WarningsType.MetadataType,
        ) {
          return new GetAllDataOfTheParticularProductOfferActionRes.Validation.Warnings.Metadata(
            possibleDtoObject,
          );
        }
        /**
         ...
         **/
        static with(
          partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ValidationType.WarningsType.MetadataType>,
        ) {
          return new GetAllDataOfTheParticularProductOfferActionRes.Validation.Warnings.Metadata(
            partialDtoObject,
          );
        ...
        copyWith(
          partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ValidationType.WarningsType.MetadataType>,
        ): InstanceType<
          typeof GetAllDataOfTheParticularProductOfferActionRes.Validation.Warnings.Metadata
        > {
          return new GetAllDataOfTheParticularProductOfferActionRes.Validation.Warnings.Metadata(
       ...
       **/
      static from(
        possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.ValidationType.WarningsType,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.Validation.Warnings(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ValidationType.WarningsType>,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.Validation.Warnings(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ValidationType.WarningsType>,
      ): InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.Validation.Warnings
      > {
        return new GetAllDataOfTheParticularProductOfferActionRes.Validation.Warnings(
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.ValidationType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Validation(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ValidationType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.Validation(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ValidationType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.Validation
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.Validation({
  ...
  static External = class External {
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.ExternalType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.External(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ExternalType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.External(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.ExternalType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.External
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.External({
  ...
  static SizeTable = class SizeTable {
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.SizeTableType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.SizeTable(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.SizeTableType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.SizeTable(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.SizeTableType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.SizeTable
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.SizeTable({
  ...
  static TaxSettings = class TaxSettings {
    ...
    set rates(
      ...
      if (Array.isArray(value)) {
        if (
          value.length > 0 &&
          value[0] instanceof
            GetAllDataOfTheParticularProductOfferActionRes.TaxSettings.Rates
        ) {
          ...
          this.#rates = MArray.of(
            value.map(
              (item) =>
                new GetAllDataOfTheParticularProductOfferActionRes.TaxSettings.Rates(
                  item,
                ),
            ),
          );
    ...
    static Rates = class Rates {
       ...
       **/
      static from(
        possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.TaxSettingsType.RatesType,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.TaxSettings.Rates(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.TaxSettingsType.RatesType>,
      ) {
        return new GetAllDataOfTheParticularProductOfferActionRes.TaxSettings.Rates(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.TaxSettingsType.RatesType>,
      ): InstanceType<
        typeof GetAllDataOfTheParticularProductOfferActionRes.TaxSettings.Rates
      > {
        return new GetAllDataOfTheParticularProductOfferActionRes.TaxSettings.Rates(
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.TaxSettingsType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.TaxSettings(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.TaxSettingsType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.TaxSettings(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.TaxSettingsType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.TaxSettings
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.TaxSettings({
  ...
  static MessageToSellerSettings = class MessageToSellerSettings {
     ...
     **/
    static from(
      possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType.MessageToSellerSettingsType,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.MessageToSellerSettings(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.MessageToSellerSettingsType>,
    ) {
      return new GetAllDataOfTheParticularProductOfferActionRes.MessageToSellerSettings(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType.MessageToSellerSettingsType>,
    ): InstanceType<
      typeof GetAllDataOfTheParticularProductOfferActionRes.MessageToSellerSettings
    > {
      return new GetAllDataOfTheParticularProductOfferActionRes.MessageToSellerSettings(
  ...
  #lateInitFields(data = {}) {
    ...
    if (
      !(
        ...
        GetAllDataOfTheParticularProductOfferActionRes.Category
      )
    ) {
      this.category =
        new GetAllDataOfTheParticularProductOfferActionRes.Category(
          d.category || {},
        );
    }
    if (
      !(d.stock instanceof GetAllDataOfTheParticularProductOfferActionRes.Stock)
    ) {
      this.stock = new GetAllDataOfTheParticularProductOfferActionRes.Stock(
        d.stock || {},
      );
    ...
    if (
      !(
        d.contact instanceof
        GetAllDataOfTheParticularProductOfferActionRes.Contact
      )
    ) {
      this.contact = new GetAllDataOfTheParticularProductOfferActionRes.Contact(
        d.contact || {},
      );
    }
    if (
      ...
      this.publication =
        new GetAllDataOfTheParticularProductOfferActionRes.Publication(
          d.publication || {},
        );
    }
    if (
      ...
      this.sellingMode =
        new GetAllDataOfTheParticularProductOfferActionRes.SellingMode(
          d.sellingMode || {},
        );
    }
    if (
      !(
        d.payments instanceof
        GetAllDataOfTheParticularProductOfferActionRes.Payments
      )
    ) {
      this.payments =
        new GetAllDataOfTheParticularProductOfferActionRes.Payments(
          d.payments || {},
        );
    }
    if (
      !(
        d.delivery instanceof
        GetAllDataOfTheParticularProductOfferActionRes.Delivery
      )
    ) {
      this.delivery =
        new GetAllDataOfTheParticularProductOfferActionRes.Delivery(
          d.delivery || {},
        );
    }
    if (
      !(
        d.afterSalesServices instanceof
        GetAllDataOfTheParticularProductOfferActionRes.AfterSalesServices
      )
    ) {
      this.afterSalesServices =
    ...
    if (
      !(
        d.discounts instanceof
        GetAllDataOfTheParticularProductOfferActionRes.Discounts
      )
    ) {
      this.discounts =
        new GetAllDataOfTheParticularProductOfferActionRes.Discounts(
          d.discounts || {},
        );
    }
    if (
      !(
        d.description instanceof
        GetAllDataOfTheParticularProductOfferActionRes.Description
      )
    ) {
      this.description =
        new GetAllDataOfTheParticularProductOfferActionRes.Description(
          d.description || {},
        );
    }
    if (
    ...
    if (
      !(
        d.additionalServices instanceof
        GetAllDataOfTheParticularProductOfferActionRes.AdditionalServices
      )
    ) {
      this.additionalServices =
    ...
    if (
      !(d.b2b instanceof GetAllDataOfTheParticularProductOfferActionRes.B2b)
    ) {
      this.b2b = new GetAllDataOfTheParticularProductOfferActionRes.B2b(
        d.b2b || {},
      );
    }
    if (
      !(
        d.compatibilityList instanceof
        GetAllDataOfTheParticularProductOfferActionRes.CompatibilityList
      )
    ) {
      this.compatibilityList =
    ...
    if (
      !(
        d.validation instanceof
        GetAllDataOfTheParticularProductOfferActionRes.Validation
      )
    ) {
      this.validation =
        new GetAllDataOfTheParticularProductOfferActionRes.Validation(
          d.validation || {},
        );
    }
    if (
      !(
        d.external instanceof
        GetAllDataOfTheParticularProductOfferActionRes.External
      )
    ) {
      this.external =
        new GetAllDataOfTheParticularProductOfferActionRes.External(
          d.external || {},
        );
    }
    if (
      !(
        d.sizeTable instanceof
        GetAllDataOfTheParticularProductOfferActionRes.SizeTable
      )
    ) {
      this.sizeTable =
        new GetAllDataOfTheParticularProductOfferActionRes.SizeTable(
          d.sizeTable || {},
        );
    }
    if (
      !(
        d.taxSettings instanceof
        GetAllDataOfTheParticularProductOfferActionRes.TaxSettings
      )
    ) {
      this.taxSettings =
        new GetAllDataOfTheParticularProductOfferActionRes.TaxSettings(
          d.taxSettings || {},
        );
    }
    if (
   ...
   **/
  static from(
    possibleDtoObject: GetAllDataOfTheParticularProductOfferActionResType,
  ) {
    return new GetAllDataOfTheParticularProductOfferActionRes(
      possibleDtoObject,
    );
  }
  /**
   ...
   **/
  static with(
    partialDtoObject: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType>,
  ) {
    return new GetAllDataOfTheParticularProductOfferActionRes(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<GetAllDataOfTheParticularProductOfferActionResType>,
  ): InstanceType<typeof GetAllDataOfTheParticularProductOfferActionRes> {
    return new GetAllDataOfTheParticularProductOfferActionRes({
      ...this.toJSON(),
      ...partial,
    });
  ...
  export namespace ProductSetType {
    ...
    export namespace ProductType {
      ...
      export namespace ParametersType {
        ...
        /**
         * The base type definition for valuesType
         **/
        export type ValuesType = {};
        // eslint-disable-next-line @typescript-eslint/no-namespace
        export namespace ValuesType {}
        /**
         * The base type definition for valuesIdsType
         **/
        export type ValuesIdsType = {};
        // eslint-disable-next-line @typescript-eslint/no-namespace
        export namespace ValuesIdsType {}
      }
    }
    /**
