...
export class GetSmartClassificationReportOfTheParticularOfferAction {
  ...
  static Fetch$ = async (
    ...
    >(
      overrideUrl ??
        GetSmartClassificationReportOfTheParticularOfferAction.NewUrl(qs),
      {
  ...
  static Fetch = async (
    init?: TypedRequestInit<unknown, unknown>,
    {
      ...
      creatorFn: (item) =>
        new GetSmartClassificationReportOfTheParticularOfferActionRes(item),
    },
  ) => {
    creatorFn =
      creatorFn ||
      ((item) =>
        new GetSmartClassificationReportOfTheParticularOfferActionRes(item));
    const res =
      await GetSmartClassificationReportOfTheParticularOfferAction.Fetch$(
        qs,
        ctx,
        init,
        overrideUrl,
...
export class GetSmartClassificationReportOfTheParticularOfferActionRes {
   ...
   * @returns {boolean}
   **/
  get scheduledForReclassification() {
   ...
   **/
  #classification!: InstanceType<
    typeof GetSmartClassificationReportOfTheParticularOfferActionRes.Classification
  >;
  /**
   * Offer classification status and last change date
  ...
  set classification(
    ...
    if (
      value instanceof
      GetSmartClassificationReportOfTheParticularOfferActionRes.Classification
    ) {
      this.#classification = value;
    } else {
      this.#classification =
        new GetSmartClassificationReportOfTheParticularOfferActionRes.Classification(
          value,
        );
    }
  }
  ...
  set smartDeliveryMethods(
    ...
    if (ok) {
      this.#smartDeliveryMethods = mcastValue as any;
      return;
    }
    console.warn(
  ...
  set conditions(
    ...
    const { ok, value: mcastValue } = MArray.cast<unknown>(value);
    if (ok) {
      this.#conditions = mcastValue as any;
      return;
    }
    console.warn(
  ...
  static Classification = class Classification {
    ...
    applyFromObject(data = {}) {
      ...
      if (d.fulfilled !== undefined) {
        this.fulfilled = d.fulfilled;
      }
      if (d.lastChanged !== undefined) {
        this.lastChanged = d.lastChanged;
      }
    }
    /**
     ...
     **/
    static from(
      possibleDtoObject: GetSmartClassificationReportOfTheParticularOfferActionResType.ClassificationType,
    ) {
      return new GetSmartClassificationReportOfTheParticularOfferActionRes.Classification(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetSmartClassificationReportOfTheParticularOfferActionResType.ClassificationType>,
    ) {
      return new GetSmartClassificationReportOfTheParticularOfferActionRes.Classification(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetSmartClassificationReportOfTheParticularOfferActionResType.ClassificationType>,
    ): InstanceType<
      typeof GetSmartClassificationReportOfTheParticularOfferActionRes.Classification
    > {
      return new GetSmartClassificationReportOfTheParticularOfferActionRes.Classification(
  ...
  static SmartDeliveryMethods = class SmartDeliveryMethods {
     ...
     **/
    static from(
      possibleDtoObject: GetSmartClassificationReportOfTheParticularOfferActionResType.SmartDeliveryMethodsType,
    ) {
      return new GetSmartClassificationReportOfTheParticularOfferActionRes.SmartDeliveryMethods(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetSmartClassificationReportOfTheParticularOfferActionResType.SmartDeliveryMethodsType>,
    ) {
      return new GetSmartClassificationReportOfTheParticularOfferActionRes.SmartDeliveryMethods(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetSmartClassificationReportOfTheParticularOfferActionResType.SmartDeliveryMethodsType>,
    ): InstanceType<
      typeof GetSmartClassificationReportOfTheParticularOfferActionRes.SmartDeliveryMethods
    > {
      return new GetSmartClassificationReportOfTheParticularOfferActionRes.SmartDeliveryMethods(
  ...
  static Conditions = class Conditions {
    ...
    set passedDeliveryMethods(
      ...
      const { ok, value: mcastValue } = MArray.cast<unknown>(value);
      if (ok) {
        this.#passedDeliveryMethods = mcastValue as any;
        return;
      }
      console.warn(
    ...
    set failedDeliveryMethods(
      ...
      const { ok, value: mcastValue } = MArray.cast<unknown>(value);
      if (ok) {
        this.#failedDeliveryMethods = mcastValue as any;
        return;
      }
      console.warn(
    ...
    static PassedDeliveryMethods = class PassedDeliveryMethods {
       ...
       **/
      static from(
        possibleDtoObject: GetSmartClassificationReportOfTheParticularOfferActionResType.ConditionsType.PassedDeliveryMethodsType,
      ) {
        return new GetSmartClassificationReportOfTheParticularOfferActionRes.Conditions.PassedDeliveryMethods(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetSmartClassificationReportOfTheParticularOfferActionResType.ConditionsType.PassedDeliveryMethodsType>,
      ) {
        return new GetSmartClassificationReportOfTheParticularOfferActionRes.Conditions.PassedDeliveryMethods(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetSmartClassificationReportOfTheParticularOfferActionResType.ConditionsType.PassedDeliveryMethodsType>,
      ): InstanceType<
        typeof GetSmartClassificationReportOfTheParticularOfferActionRes.Conditions.PassedDeliveryMethods
      > {
        return new GetSmartClassificationReportOfTheParticularOfferActionRes.Conditions.PassedDeliveryMethods(
    ...
    static FailedDeliveryMethods = class FailedDeliveryMethods {
       ...
       **/
      static from(
        possibleDtoObject: GetSmartClassificationReportOfTheParticularOfferActionResType.ConditionsType.FailedDeliveryMethodsType,
      ) {
        return new GetSmartClassificationReportOfTheParticularOfferActionRes.Conditions.FailedDeliveryMethods(
          possibleDtoObject,
        );
      }
      /**
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<GetSmartClassificationReportOfTheParticularOfferActionResType.ConditionsType.FailedDeliveryMethodsType>,
      ) {
        return new GetSmartClassificationReportOfTheParticularOfferActionRes.Conditions.FailedDeliveryMethods(
          partialDtoObject,
        );
      ...
      copyWith(
        partial: PartialDeep<GetSmartClassificationReportOfTheParticularOfferActionResType.ConditionsType.FailedDeliveryMethodsType>,
      ): InstanceType<
        typeof GetSmartClassificationReportOfTheParticularOfferActionRes.Conditions.FailedDeliveryMethods
      > {
        return new GetSmartClassificationReportOfTheParticularOfferActionRes.Conditions.FailedDeliveryMethods(
    ...
    applyFromObject(data = {}) {
      ...
      if (d.passedDeliveryMethods !== undefined) {
        this.passedDeliveryMethods = d.passedDeliveryMethods;
      }
      if (d.failedDeliveryMethods !== undefined) {
        this.failedDeliveryMethods = d.failedDeliveryMethods;
      }
    }
    /**
     *	Special toJSON override, since the field are private,
     ...
     **/
    static from(
      possibleDtoObject: GetSmartClassificationReportOfTheParticularOfferActionResType.ConditionsType,
    ) {
      return new GetSmartClassificationReportOfTheParticularOfferActionRes.Conditions(
        possibleDtoObject,
      );
    }
    /**
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<GetSmartClassificationReportOfTheParticularOfferActionResType.ConditionsType>,
    ) {
      return new GetSmartClassificationReportOfTheParticularOfferActionRes.Conditions(
        partialDtoObject,
      );
    ...
    copyWith(
      partial: PartialDeep<GetSmartClassificationReportOfTheParticularOfferActionResType.ConditionsType>,
    ): InstanceType<
      typeof GetSmartClassificationReportOfTheParticularOfferActionRes.Conditions
    > {
      return new GetSmartClassificationReportOfTheParticularOfferActionRes.Conditions(
  ...
  applyFromObject(data = {}) {
    const d =
      data as Partial<GetSmartClassificationReportOfTheParticularOfferActionRes>;
    if (d.scheduledForReclassification !== undefined) {
      this.scheduledForReclassification = d.scheduledForReclassification;
    }
    if (d.classification !== undefined) {
      this.classification = d.classification;
    }
    if (d.smartDeliveryMethods !== undefined) {
      this.smartDeliveryMethods = d.smartDeliveryMethods;
    }
   ...
   **/
  static from(
    possibleDtoObject: GetSmartClassificationReportOfTheParticularOfferActionResType,
  ) {
    return new GetSmartClassificationReportOfTheParticularOfferActionRes(
      possibleDtoObject,
    );
  }
  /**
   ...
   **/
  static with(
    partialDtoObject: PartialDeep<GetSmartClassificationReportOfTheParticularOfferActionResType>,
  ) {
    return new GetSmartClassificationReportOfTheParticularOfferActionRes(
      partialDtoObject,
    );
  ...
  copyWith(
    partial: PartialDeep<GetSmartClassificationReportOfTheParticularOfferActionResType>,
  ): InstanceType<
    typeof GetSmartClassificationReportOfTheParticularOfferActionRes
  > {
    return new GetSmartClassificationReportOfTheParticularOfferActionRes({
      ...this.toJSON(),
      ...partial,
