...
export class EditAnOfferAction {
  ...
  static NewUrl = (qs) => buildUrl(EditAnOfferAction.URL, undefined, qs);
  static Method = "patch";
  ...
  static AdditionalMarketplaces = class AdditionalMarketplaces {
    ...
    static Publication = class Publication {
      ...
      set refusalReasons(value) {
        ...
        const { ok, value: mcastValue } = MArray.cast(value);
        if (ok) {
          this.#refusalReasons = mcastValue;
          return;
        }
        console.warn(
