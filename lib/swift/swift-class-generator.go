...
func SwiftCommonStructGenerator(fields []*core.EmiField, ctx core.MicroGenContext, goctx commonClassContext) (*core.CodeChunkCompiled, error) {
...
`
	...
	res.SuggestedFileName = goctx.RootClassName + ".swift"
