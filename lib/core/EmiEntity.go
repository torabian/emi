...
// GetClassName returns the golang struct name generated for this entity: PascalCase
// name plus the "Entity" suffix, matching the target naming convention used by
