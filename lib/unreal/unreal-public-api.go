	...
	textActions := []core.ActionText{
		{
			BaseAction: core.BaseAction{
				Name:             "unreal:dto",
				Description:      "Generates cpp dto compatible with Unreal engine.",
				WasmFunctionName: "cppGenUnrealDto",
				Flags:            []core.FlagDef{},
			},
			...
			BaseAction: core.BaseAction{
				Name:             "unreal:headers",
				Description:      "Generates headers, for cpp unreal, both as client and server",
				WasmFunctionName: "cppGenUnrealheader",
				Flags:            []core.FlagDef{},
			},
			Run: func(ctx core.MicroGenContext) (string, error) {
