...
export class WebSocketX extends WebSocket {
    constructor(url, protocols, options) {
        ...
        if (options === null || options === void 0 ? void 0 : options.MessageFactoryClass) {
            __classPrivateFieldSet(this, _WebSocketX_factoryCls, options.MessageFactoryClass, "f");
        }
    }
    set onmessage(fn) {
        if (fn) {
        ...
        if (type === "message") {
            const wrapped = ((ev) => {
                ...
                if (__classPrivateFieldGet(this, _WebSocketX_factoryCls, "f")) {
                    try {
                        parsed = new (__classPrivateFieldGet(this, _WebSocketX_factoryCls, "f"))(ev.data);
                    }
                    catch {
