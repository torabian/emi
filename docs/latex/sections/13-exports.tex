\section{Public Notices: Markdown, OpenAPI, Postman}
\label{sec:exports}
...
result prints to stdout so it can be piped or inspected) --- plus
\texttt{--tags} to add or remove compile features, same as every other
Emi sub-compiler.
\end{pullquote}
