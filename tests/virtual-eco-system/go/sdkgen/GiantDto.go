...
type GiantDto struct {
		...
		CollectionItemsNullable interface{} `json:"collectionItemsNullable" yaml:"collectionItemsNullable"`
		DateObject interface{} `json:"dateObject" yaml:"dateObject"`
		SingleRef GiantDto `json:"singleRef" yaml:"singleRef"`
		SingleRefNullable interface{} `json:"singleRefNullable" yaml:"singleRefNullable"`
		...
		MapValueNullable interface{} `json:"mapValueNullable" yaml:"mapValueNullable"`
		SliceValue [] `json:"sliceValue" yaml:"sliceValue"`
		SliceValueNullable interface{} `json:"sliceValueNullable" yaml:"sliceValueNullable"`
...
type GiantDtoObjectValue struct {
		InnerObject emi.Nullable[GiantDto.ObjectValueInnerObject] `json:"innerObject" yaml:"innerObject"`
}
