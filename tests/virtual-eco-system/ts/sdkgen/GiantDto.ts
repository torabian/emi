...
static ObjectValue = class ObjectValue {
  ...
  **/
 #innerObject ? : InstanceType<typeof GiantDto.ObjectValue.InnerObject> | null | undefined  | null  =  undefined
		/**
  * 
...
/**
  ...
  * @type {GiantDto.ObjectValue.InnerObject}
  **/
set innerObject (value: InstanceType<typeof GiantDto.ObjectValue.InnerObject> | null | undefined | null | undefined) {
	 	// For objects, the sub type needs to always be instance of the sub class.
...
setInnerObject (value: InstanceType<typeof GiantDto.ObjectValue.InnerObject> | null | undefined | null | undefined) {
	this.innerObject = value
	return this
}
/**
...
setInnerObjText (value: string) {
	...
	* be complaining.
	**/
	static from(possibleDtoObject: GiantDtoType.ObjectValueType.InnerObjectType) {
	...
	* be constructed according to data types and nullability.
	**/
	static with(partialDtoObject: PartialDeep<GiantDtoType.ObjectValueType.InnerObjectType>) {
		return new GiantDto.ObjectValue.InnerObject(partialDtoObject);
	}
	copyWith(partial: PartialDeep<GiantDtoType.ObjectValueType.InnerObjectType>): InstanceType<typeof GiantDto.ObjectValue.InnerObject> {
...
get innerObject() {
	...
	**/
	...
	copyWith(partial: PartialDeep<GiantDtoType.ObjectValueType>): InstanceType<typeof GiantDto.ObjectValue> {
