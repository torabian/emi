...
func (d *NullableDuration) UnmarshalJSON(data []byte) error {
	d.Present = true
	if string(data) == "null" {
		d.Valid = false
		return nil
...
func (d NullableDuration) MarshalJSON() ([]byte, error) {
	if !d.Valid {
...
func (d *NullableDuration) UnmarshalYAML(unmarshal func(interface{}) error) error {
	d.Present = true
...
func (d NullableDuration) MarshalYAML() (interface{}, error) {
	if !d.Valid {
		return nil, nil
	}
...
func (NullableDuration) GormDataType() string {
	return "bigint"
}

// NewDuration creates a new Duration instance with a value
func NewDuration(value int64) NullableDuration {
...
func NewDurationAutoNull(value string) NullableDuration {
	if value == "null" {
...
func NewDurationNull() NullableDuration {
	return NullableDuration{
...
func parseStringToSeconds(input string) int64 {
	...
	if dur, err := Parse(input); err == nil {
...
func formatISODuration(seconds int64) string {
	return FromTimeDuration(time.Duration(seconds)).String()
}
