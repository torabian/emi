...
export class Anonymouse {
  ...
  static LoginHistory = class LoginHistory {
    ...
    static Data = class Data {
       ...
       * be complaining.
       **/
      static from(possibleDtoObject: AnonymouseType.LoginHistoryType.DataType) {
       ...
       **/
      static with(
        partialDtoObject: PartialDeep<AnonymouseType.LoginHistoryType.DataType>,
      ) {
        return new Anonymouse.LoginHistory.Data(partialDtoObject);
      }
      copyWith(
        partial: PartialDeep<AnonymouseType.LoginHistoryType.DataType>,
      ): InstanceType<typeof Anonymouse.LoginHistory.Data> {
        return new Anonymouse.LoginHistory.Data({
          ...this.toJSON(),
          ...partial,
        });
      }
      clone(): InstanceType<typeof Anonymouse.LoginHistory.Data> {
     ...
     * be complaining.
     **/
    static from(possibleDtoObject: AnonymouseType.LoginHistoryType) {
     ...
     **/
    static with(
      partialDtoObject: PartialDeep<AnonymouseType.LoginHistoryType>,
    ) {
      return new Anonymouse.LoginHistory(partialDtoObject);
    }
    copyWith(
      partial: PartialDeep<AnonymouseType.LoginHistoryType>,
    ): InstanceType<typeof Anonymouse.LoginHistory> {
      return new Anonymouse.LoginHistory({ ...this.toJSON(), ...partial });
    }
    clone(): InstanceType<typeof Anonymouse.LoginHistory> {
