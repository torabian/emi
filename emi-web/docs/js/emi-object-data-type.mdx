...
export class MyObjectClassDto {
  ...
  static Profile = class Profile {
     ...
     **/
    static with(partialDtoObject: Partial<MyObjectClassDtoType.ProfileType>) {
      return new MyObjectClassDto.Profile(partialDtoObject);
    }
    copyWith(
      partial: Partial<MyObjectClassDtoType.ProfileType>,
   ...
   * be constructed according to data types and nullability.
   **/
  static with(partialDtoObject: Partial<MyObjectClassDtoType>) {
    return new MyObjectClassDto(partialDtoObject);
  }
  copyWith(
    partial: Partial<MyObjectClassDtoType>,
...
export class MyObjectClassDto {
  ...
  static OptionalProfile = class OptionalProfile {
     ...
     **/
    static with(
      partialDtoObject: Partial<MyObjectClassDtoType.OptionalProfileType>,
    ) {
      return new MyObjectClassDto.OptionalProfile(partialDtoObject);
    }
    copyWith(
      partial: Partial<MyObjectClassDtoType.OptionalProfileType>,
    ): InstanceType<typeof MyObjectClassDto.OptionalProfile> {
