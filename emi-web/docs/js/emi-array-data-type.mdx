...
export class MyArrayClassDto {
  ...
  static Contacts = class Contacts {
     ...
     **/
    static with(partialDtoObject: Partial<MyArrayClassDtoType.ContactsType>) {
      return new MyArrayClassDto.Contacts(partialDtoObject);
    }
    copyWith(
      partial: Partial<MyArrayClassDtoType.ContactsType>,
   ...
   * be constructed according to data types and nullability.
   **/
  static with(partialDtoObject: Partial<MyArrayClassDtoType>) {
    return new MyArrayClassDto(partialDtoObject);
  }
  copyWith(
    partial: Partial<MyArrayClassDtoType>,
